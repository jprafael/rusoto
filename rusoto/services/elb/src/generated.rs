        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "EmitInterval" => {
                obj.emit_interval = Some(try!(AccessLogIntervalDeserializer::deserialize("EmitInterval", stack)));
            }
"Enabled" => {
                obj.enabled = try!(AccessLogEnabledDeserializer::deserialize("Enabled", stack));
            }
"S3BucketName" => {
                obj.s3_bucket_name = Some(try!(S3BucketNameDeserializer::deserialize("S3BucketName", stack)));
            }
"S3BucketPrefix" => {
                obj.s3_bucket_prefix = Some(try!(AccessLogPrefixDeserializer::deserialize("S3BucketPrefix", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        if let Some(ref field_value) = obj.emit_interval {
                params.put(&format!("{}{}", prefix, "EmitInterval"), &field_value.to_string());
            }
...
params.put(&format!("{}{}", prefix, "LoadBalancerName"), &obj.load_balancer_name);
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Key" => {
                obj.key = Some(try!(AdditionalAttributeKeyDeserializer::deserialize("Key", stack)));
            }
"Value" => {
...
struct AdditionalAttributesDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(AdditionalAttributeDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
...
struct AppCookieStickinessPoliciesDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(AppCookieStickinessPolicyDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "CookieName" => {
                obj.cookie_name = Some(try!(CookieNameDeserializer::deserialize("CookieName", stack)));
            }
"PolicyName" => {
                obj.policy_name = Some(try!(PolicyNameDeserializer::deserialize("PolicyName", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Subnets" => {
                obj.subnets = Some(try!(SubnetsDeserializer::deserialize("Subnets", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "InstancePort" => {
                obj.instance_port = Some(try!(InstancePortDeserializer::deserialize("InstancePort", stack)));
            }
"PolicyNames" => {
                obj.policy_names = Some(try!(PolicyNamesDeserializer::deserialize("PolicyNames", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct BackendServerDescriptionsDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(BackendServerDescriptionDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "HealthCheck" => {
                obj.health_check = Some(try!(HealthCheckDeserializer::deserialize("HealthCheck", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Enabled" => {
                obj.enabled = try!(ConnectionDrainingEnabledDeserializer::deserialize("Enabled", stack));
            }
"Timeout" => {
...
if let Some(ref field_value) = obj.timeout {
                params.put(&format!("{}{}", prefix, "Timeout"), &field_value.to_string());
            }
...
struct ConnectionSettingsDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "IdleTimeout" => {
                obj.idle_timeout = try!(IdleTimeoutDeserializer::deserialize("IdleTimeout", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        params.put(&format!("{}{}", prefix, "IdleTimeout"), &obj.idle_timeout.to_string());
...
pub availability_zones: Option<AvailabilityZones>,
#[doc="<p>The listeners.</p> <p>For more information, see <a href=\"http://docs.aws.amazon.com/elasticloadbalancing/latest/classic/elb-listener-config.html\">Listeners for Your Classic Load Balancer</a> in the <i>Classic Load Balancers Guide</i>.</p>"]
...
pub subnets: Option<Subnets>,
#[doc="<p>A list of tags to assign to the load balancer.</p> <p>For more information about tagging your load balancer, see <a href=\"http://docs.aws.amazon.com/elasticloadbalancing/latest/classic/add-remove-tags.html\">Tag Your Classic Load Balancer</a> in the <i>Classic Load Balancers Guide</i>.</p>"]
...
pub policy_name: PolicyName,
        ...
        if let Some(ref field_value) = obj.cookie_expiration_period {
                params.put(&format!("{}{}", prefix, "CookieExpirationPeriod"), &field_value.to_string());
            }
params.put(&format!("{}{}", prefix, "LoadBalancerName"), &obj.load_balancer_name);
params.put(&format!("{}{}", prefix, "PolicyName"), &obj.policy_name);
...
params.put(&format!("{}{}", prefix, "PolicyName"), &obj.policy_name);
params.put(&format!("{}{}", prefix, "PolicyTypeName"), &obj.policy_type_name);
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Enabled" => {
                obj.enabled = try!(CrossZoneLoadBalancingEnabledDeserializer::deserialize("Enabled", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "InstanceStates" => {
                obj.instance_states = Some(try!(InstanceStatesDeserializer::deserialize("InstanceStates", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct DescribeLoadBalancerAttributesOutputDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.load_balancer_attributes = Some(try!(LoadBalancerAttributesDeserializer::deserialize("LoadBalancerAttributes", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "PolicyDescriptions" => {
                obj.policy_descriptions = Some(try!(PolicyDescriptionsDeserializer::deserialize("PolicyDescriptions", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct DescribeLoadBalancerPolicyTypesOutputDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.policy_type_descriptions = Some(try!(PolicyTypeDescriptionsDeserializer::deserialize("PolicyTypeDescriptions", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "HealthyThreshold" => {
                obj.healthy_threshold = try!(HealthyThresholdDeserializer::deserialize("HealthyThreshold", stack));
            }
"Interval" => {
                obj.interval = try!(HealthCheckIntervalDeserializer::deserialize("Interval", stack));
            }
"Target" => {
                obj.target = try!(HealthCheckTargetDeserializer::deserialize("Target", stack));
            }
"Timeout" => {
                obj.timeout = try!(HealthCheckTimeoutDeserializer::deserialize("Timeout", stack));
            }
"UnhealthyThreshold" => {
                obj.unhealthy_threshold = try!(UnhealthyThresholdDeserializer::deserialize("UnhealthyThreshold", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        params.put(&format!("{}{}", prefix, "HealthyThreshold"), &obj.healthy_threshold.to_string());
params.put(&format!("{}{}", prefix, "Interval"), &obj.interval.to_string());
params.put(&format!("{}{}", prefix, "Target"), &obj.target);
params.put(&format!("{}{}", prefix, "Timeout"), &obj.timeout.to_string());
params.put(&format!("{}{}", prefix, "UnhealthyThreshold"), &obj.unhealthy_threshold.to_string());
...
"ReasonCode" => {
                obj.reason_code = Some(try!(ReasonCodeDeserializer::deserialize("ReasonCode", stack)));
            }
"State" => {
...
struct LBCookieStickinessPoliciesDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(LBCookieStickinessPolicyDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
...
struct LBCookieStickinessPolicyDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.cookie_expiration_period = Some(try!(CookieExpirationPeriodDeserializer::deserialize("CookieExpirationPeriod", stack)));
            }
"PolicyName" => {
                obj.policy_name = Some(try!(PolicyNameDeserializer::deserialize("PolicyName", stack)));
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "InstancePort" => {
                obj.instance_port = try!(InstancePortDeserializer::deserialize("InstancePort", stack));
            }
"InstanceProtocol" => {
                obj.instance_protocol = Some(try!(ProtocolDeserializer::deserialize("InstanceProtocol", stack)));
            }
"LoadBalancerPort" => {
                obj.load_balancer_port = try!(AccessPointPortDeserializer::deserialize("LoadBalancerPort", stack));
            }
"Protocol" => {
                obj.protocol = try!(ProtocolDeserializer::deserialize("Protocol", stack));
            }
"SSLCertificateId" => {
                obj.ssl_certificate_id = Some(try!(SSLCertificateIdDeserializer::deserialize("SSLCertificateId", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        params.put(&format!("{}{}", prefix, "InstancePort"), &obj.instance_port.to_string());
if let Some(ref field_value) = obj.instance_protocol {
                params.put(&format!("{}{}", prefix, "InstanceProtocol"), &field_value);
            }
params.put(&format!("{}{}", prefix, "LoadBalancerPort"), &obj.load_balancer_port.to_string());
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Listener" => {
                obj.listener = Some(try!(ListenerDeserializer::deserialize("Listener", stack)));
            }
"PolicyNames" => {
                obj.policy_names = Some(try!(PolicyNamesDeserializer::deserialize("PolicyNames", stack)));
            }
...
struct ListenerDescriptionsDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(ListenerDescriptionDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AccessLog" => {
                obj.access_log = Some(try!(AccessLogDeserializer::deserialize("AccessLog", stack)));
            }
"AdditionalAttributes" => {
                obj.additional_attributes = Some(try!(AdditionalAttributesDeserializer::deserialize("AdditionalAttributes", stack)));
            }
"ConnectionDraining" => {
                obj.connection_draining = Some(try!(ConnectionDrainingDeserializer::deserialize("ConnectionDraining", stack)));
            }
"ConnectionSettings" => {
                obj.connection_settings = Some(try!(ConnectionSettingsDeserializer::deserialize("ConnectionSettings", stack)));
            }
"CrossZoneLoadBalancing" => {
                obj.cross_zone_load_balancing = Some(try!(CrossZoneLoadBalancingDeserializer::deserialize("CrossZoneLoadBalancing", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
#[doc="<p>The DNS name of the load balancer.</p> <p>For more information, see <a href=\"http://docs.aws.amazon.com/elasticloadbalancing/latest/classic/using-domain-names-with-elb.html\">Configure a Custom Domain Name</a> in the <i>Classic Load Balancers Guide</i>.</p>"]
...
"CanonicalHostedZoneName" => {
                obj.canonical_hosted_zone_name = Some(try!(DNSNameDeserializer::deserialize("CanonicalHostedZoneName", stack)));
            }
"CanonicalHostedZoneNameID" => {
                obj.canonical_hosted_zone_name_id = Some(try!(DNSNameDeserializer::deserialize("CanonicalHostedZoneNameID", stack)));
            }
"CreatedTime" => {
...
"ListenerDescriptions" => {
                obj.listener_descriptions = Some(try!(ListenerDescriptionsDeserializer::deserialize("ListenerDescriptions", stack)));
            }
"LoadBalancerName" => {
                obj.load_balancer_name = Some(try!(AccessPointNameDeserializer::deserialize("LoadBalancerName", stack)));
            }
"Policies" => {
                obj.policies = Some(try!(PoliciesDeserializer::deserialize("Policies", stack)));
            }
"Scheme" => {
                obj.scheme = Some(try!(LoadBalancerSchemeDeserializer::deserialize("Scheme", stack)));
            }
"SecurityGroups" => {
                obj.security_groups = Some(try!(SecurityGroupsDeserializer::deserialize("SecurityGroups", stack)));
            }
"SourceSecurityGroup" => {
                obj.source_security_group = Some(try!(SourceSecurityGroupDeserializer::deserialize("SourceSecurityGroup", stack)));
            }
"Subnets" => {
                obj.subnets = Some(try!(SubnetsDeserializer::deserialize("Subnets", stack)));
            }
...
struct LoadBalancerDescriptionsDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(LoadBalancerDescriptionDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
...
#[derive(Default,Debug,Clone)]
            pub struct ModifyLoadBalancerAttributesInput {
                #[doc="<p>The attributes of the load balancer.</p>"]
...
"OtherPolicies" => {
                obj.other_policies = Some(try!(PolicyNamesDeserializer::deserialize("OtherPolicies", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AttributeName" => {
                obj.attribute_name = Some(try!(AttributeNameDeserializer::deserialize("AttributeName", stack)));
            }
"AttributeValue" => {
                obj.attribute_value = Some(try!(AttributeValueDeserializer::deserialize("AttributeValue", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct PolicyAttributeDescriptionsDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(PolicyAttributeDescriptionDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
...
"AttributeType" => {
                obj.attribute_type = Some(try!(AttributeTypeDeserializer::deserialize("AttributeType", stack)));
            }
"Cardinality" => {
                obj.cardinality = Some(try!(CardinalityDeserializer::deserialize("Cardinality", stack)));
            }
"DefaultValue" => {
                obj.default_value = Some(try!(DefaultValueDeserializer::deserialize("DefaultValue", stack)));
            }
"Description" => {
                obj.description = Some(try!(DescriptionDeserializer::deserialize("Description", stack)));
            }
...
"PolicyTypeName" => {
                obj.policy_type_name = Some(try!(PolicyTypeNameDeserializer::deserialize("PolicyTypeName", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct PolicyTypeDescriptionsDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(PolicyTypeDescriptionDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
...
pub ssl_certificate_id: SSLCertificateId,
            ...
            impl SetLoadBalancerListenerSSLCertificateInputSerializer {
                fn serialize(params: &mut Params, name: &str, obj: &SetLoadBalancerListenerSSLCertificateInput) {
                    let mut prefix = name.to_string();
        if prefix != "" {
            prefix.push_str(".");
        }
        ...
        params.put(&format!("{}{}", prefix, "LoadBalancerName"), &obj.load_balancer_name);
params.put(&format!("{}{}", prefix, "LoadBalancerPort"), &obj.load_balancer_port.to_string());
params.put(&format!("{}{}", prefix, "SSLCertificateId"), &obj.ssl_certificate_id);
...
pub policy_names: PolicyNames,
            ...
            impl SetLoadBalancerPoliciesForBackendServerInputSerializer {
                fn serialize(params: &mut Params, name: &str, obj: &SetLoadBalancerPoliciesForBackendServerInput) {
                    let mut prefix = name.to_string();
        if prefix != "" {
            prefix.push_str(".");
        }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "GroupName" => {
                obj.group_name = Some(try!(SecurityGroupNameDeserializer::deserialize("GroupName", stack)));
            }
"OwnerAlias" => {
                obj.owner_alias = Some(try!(SecurityGroupOwnerAliasDeserializer::deserialize("OwnerAlias", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "AccessPointNotFoundException" => AddTagsError::AccessPointNotFound(String::from(parsed_error.message)),"DuplicateTagKeysException" => AddTagsError::DuplicateTagKeys(String::from(parsed_error.message)),"TooManyTagsException" => AddTagsError::TooManyTags(String::from(parsed_error.message)),_ => AddTagsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl AttachLoadBalancerToSubnetsError {
                    pub fn from_body(body: &str) -> AttachLoadBalancerToSubnetsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "AccessPointNotFoundException" => AttachLoadBalancerToSubnetsError::AccessPointNotFound(String::from(parsed_error.message)),"InvalidConfigurationRequestException" => AttachLoadBalancerToSubnetsError::InvalidConfigurationRequest(String::from(parsed_error.message)),"InvalidSubnetException" => AttachLoadBalancerToSubnetsError::InvalidSubnet(String::from(parsed_error.message)),"SubnetNotFoundException" => AttachLoadBalancerToSubnetsError::SubnetNotFound(String::from(parsed_error.message)),_ => AttachLoadBalancerToSubnetsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl ConfigureHealthCheckError {
                    pub fn from_body(body: &str) -> ConfigureHealthCheckError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "AccessPointNotFoundException" => ConfigureHealthCheckError::AccessPointNotFound(String::from(parsed_error.message)),_ => ConfigureHealthCheckError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DeleteLoadBalancerListenersError {
                    pub fn from_body(body: &str) -> DeleteLoadBalancerListenersError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "AccessPointNotFoundException" => DeleteLoadBalancerListenersError::AccessPointNotFound(String::from(parsed_error.message)),_ => DeleteLoadBalancerListenersError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DeleteLoadBalancerPolicyError {
                    pub fn from_body(body: &str) -> DeleteLoadBalancerPolicyError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "AccessPointNotFoundException" => DeleteLoadBalancerPolicyError::AccessPointNotFound(String::from(parsed_error.message)),"InvalidConfigurationRequestException" => DeleteLoadBalancerPolicyError::InvalidConfigurationRequest(String::from(parsed_error.message)),_ => DeleteLoadBalancerPolicyError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DeregisterInstancesFromLoadBalancerError {
                    pub fn from_body(body: &str) -> DeregisterInstancesFromLoadBalancerError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "AccessPointNotFoundException" => DeregisterInstancesFromLoadBalancerError::AccessPointNotFound(String::from(parsed_error.message)),"InvalidEndPointException" => DeregisterInstancesFromLoadBalancerError::InvalidEndPoint(String::from(parsed_error.message)),_ => DeregisterInstancesFromLoadBalancerError::Unknown(String::from(body))
                                }
                           },
...
///<p>One or more of the specified policy types do not exist.</p>
PolicyTypeNotFound(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl DescribeLoadBalancerPolicyTypesError {
                    pub fn from_body(body: &str) -> DescribeLoadBalancerPolicyTypesError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "PolicyTypeNotFoundException" => DescribeLoadBalancerPolicyTypesError::PolicyTypeNotFound(String::from(parsed_error.message)),_ => DescribeLoadBalancerPolicyTypesError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeLoadBalancersError {
                    pub fn from_body(body: &str) -> DescribeLoadBalancersError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "AccessPointNotFoundException" => DescribeLoadBalancersError::AccessPointNotFound(String::from(parsed_error.message)),"DependencyThrottleException" => DescribeLoadBalancersError::DependencyThrottle(String::from(parsed_error.message)),_ => DescribeLoadBalancersError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeTagsError {
                    pub fn from_body(body: &str) -> DescribeTagsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "AccessPointNotFoundException" => DescribeTagsError::AccessPointNotFound(String::from(parsed_error.message)),_ => DescribeTagsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl EnableAvailabilityZonesForLoadBalancerError {
                    pub fn from_body(body: &str) -> EnableAvailabilityZonesForLoadBalancerError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "AccessPointNotFoundException" => EnableAvailabilityZonesForLoadBalancerError::AccessPointNotFound(String::from(parsed_error.message)),_ => EnableAvailabilityZonesForLoadBalancerError::Unknown(String::from(body))
                                }
                           },
                ...
                impl RemoveTagsError {
                    pub fn from_body(body: &str) -> RemoveTagsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "AccessPointNotFoundException" => RemoveTagsError::AccessPointNotFound(String::from(parsed_error.message)),_ => RemoveTagsError::Unknown(String::from(body))
                                }
                           },
...
/// Trait representing the capabilities of the Elastic Load Balancing API. Elastic Load Balancing clients implement this trait.
        pub trait Elb {
                ...
                fn apply_security_groups_to_load_balancer(&self, input: &ApplySecurityGroupsToLoadBalancerInput) -> Box<Future<Item = ApplySecurityGroupsToLoadBalancerOutput, Error = ApplySecurityGroupsToLoadBalancerError>>;
                ...
                fn attach_load_balancer_to_subnets(&self, input: &AttachLoadBalancerToSubnetsInput) -> Box<Future<Item = AttachLoadBalancerToSubnetsOutput, Error = AttachLoadBalancerToSubnetsError>>;
                ...
                fn configure_health_check(&self, input: &ConfigureHealthCheckInput) -> Box<Future<Item = ConfigureHealthCheckOutput, Error = ConfigureHealthCheckError>>;
                ...
                fn create_app_cookie_stickiness_policy(&self, input: &CreateAppCookieStickinessPolicyInput) -> Box<Future<Item = CreateAppCookieStickinessPolicyOutput, Error = CreateAppCookieStickinessPolicyError>>;
                ...
                fn create_lb_cookie_stickiness_policy(&self, input: &CreateLBCookieStickinessPolicyInput) -> Box<Future<Item = CreateLBCookieStickinessPolicyOutput, Error = CreateLBCookieStickinessPolicyError>>;
                ...
                fn create_load_balancer(&self, input: &CreateAccessPointInput) -> Box<Future<Item = CreateAccessPointOutput, Error = CreateLoadBalancerError>>;
                

                #[doc="<p>Creates one or more listeners for the specified load balancer. If a listener with the specified port does not already exist, it is created; otherwise, the properties of the new listener must match the properties of the existing listener.</p> <p>For more information, see <a href=\"http://docs.aws.amazon.com/elasticloadbalancing/latest/classic/elb-listener-config.html\">Listeners for Your Classic Load Balancer</a> in the <i>Classic Load Balancers Guide</i>.</p>"]
                fn create_load_balancer_listeners(&self, input: &CreateLoadBalancerListenerInput) -> Box<Future<Item = CreateLoadBalancerListenerOutput, Error = CreateLoadBalancerListenersError>>;
                ...
                fn create_load_balancer_policy(&self, input: &CreateLoadBalancerPolicyInput) -> Box<Future<Item = CreateLoadBalancerPolicyOutput, Error = CreateLoadBalancerPolicyError>>;
                ...
                fn delete_load_balancer(&self, input: &DeleteAccessPointInput) -> Box<Future<Item = DeleteAccessPointOutput, Error = DeleteLoadBalancerError>>;
                

                #[doc="<p>Deletes the specified listeners from the specified load balancer.</p>"]
                fn delete_load_balancer_listeners(&self, input: &DeleteLoadBalancerListenerInput) -> Box<Future<Item = DeleteLoadBalancerListenerOutput, Error = DeleteLoadBalancerListenersError>>;
                

                #[doc="<p>Deletes the specified policy from the specified load balancer. This policy must not be enabled for any listeners.</p>"]
                fn delete_load_balancer_policy(&self, input: &DeleteLoadBalancerPolicyInput) -> Box<Future<Item = DeleteLoadBalancerPolicyOutput, Error = DeleteLoadBalancerPolicyError>>;
                ...
                fn deregister_instances_from_load_balancer(&self, input: &DeregisterEndPointsInput) -> Box<Future<Item = DeregisterEndPointsOutput, Error = DeregisterInstancesFromLoadBalancerError>>;
                

                #[doc="<p>Describes the state of the specified instances with respect to the specified load balancer. If no instances are specified, the call describes the state of all instances that are currently registered with the load balancer. If instances are specified, their state is returned even if they are no longer registered with the load balancer. The state of terminated instances is not returned.</p>"]
                fn describe_instance_health(&self, input: &DescribeEndPointStateInput) -> Box<Future<Item = DescribeEndPointStateOutput, Error = DescribeInstanceHealthError>>;
                ...
                fn describe_load_balancer_policies(&self, input: &DescribeLoadBalancerPoliciesInput) -> Box<Future<Item = DescribeLoadBalancerPoliciesOutput, Error = DescribeLoadBalancerPoliciesError>>;
                

                #[doc="<p>Describes the specified load balancer policy types or all load balancer policy types.</p> <p>The description of each type indicates how it can be used. For example, some policies can be used only with layer 7 listeners, some policies can be used only with layer 4 listeners, and some policies can be used only with your EC2 instances.</p> <p>You can use <a>CreateLoadBalancerPolicy</a> to create a policy configuration for any of these policy types. Then, depending on the policy type, use either <a>SetLoadBalancerPoliciesOfListener</a> or <a>SetLoadBalancerPoliciesForBackendServer</a> to set the policy.</p>"]
                fn describe_load_balancer_policy_types(&self, input: &DescribeLoadBalancerPolicyTypesInput) -> Box<Future<Item = DescribeLoadBalancerPolicyTypesOutput, Error = DescribeLoadBalancerPolicyTypesError>>;
                ...
                fn describe_load_balancers(&self, input: &DescribeAccessPointsInput) -> Box<Future<Item = DescribeAccessPointsOutput, Error = DescribeLoadBalancersError>>;
                ...
                fn detach_load_balancer_from_subnets(&self, input: &DetachLoadBalancerFromSubnetsInput) -> Box<Future<Item = DetachLoadBalancerFromSubnetsOutput, Error = DetachLoadBalancerFromSubnetsError>>;
                ...
                fn disable_availability_zones_for_load_balancer(&self, input: &RemoveAvailabilityZonesInput) -> Box<Future<Item = RemoveAvailabilityZonesOutput, Error = DisableAvailabilityZonesForLoadBalancerError>>;
                ...
                fn enable_availability_zones_for_load_balancer(&self, input: &AddAvailabilityZonesInput) -> Box<Future<Item = AddAvailabilityZonesOutput, Error = EnableAvailabilityZonesForLoadBalancerError>>;
                ...
                fn register_instances_with_load_balancer(&self, input: &RegisterEndPointsInput) -> Box<Future<Item = RegisterEndPointsOutput, Error = RegisterInstancesWithLoadBalancerError>>;
                ...
                fn set_load_balancer_listener_ssl_certificate(&self, input: &SetLoadBalancerListenerSSLCertificateInput) -> Box<Future<Item = SetLoadBalancerListenerSSLCertificateOutput, Error = SetLoadBalancerListenerSSLCertificateError>>;
                ...
                fn set_load_balancer_policies_for_backend_server(&self, input: &SetLoadBalancerPoliciesForBackendServerInput) -> Box<Future<Item = SetLoadBalancerPoliciesForBackendServerOutput, Error = SetLoadBalancerPoliciesForBackendServerError>>;
                ...
                fn set_load_balancer_policies_of_listener(&self, input: &SetLoadBalancerPoliciesOfListenerInput) -> Box<Future<Item = SetLoadBalancerPoliciesOfListenerOutput, Error = SetLoadBalancerPoliciesOfListenerError>>;
...
/// A client for the Elastic Load Balancing API.
        ...
        impl<P, D> Elb for ElbClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
        ...
        if response.body.is_empty() {
            ...
            try_future!(start_element(&actual_tag_name, &mut stack));
                ...
                fn apply_security_groups_to_load_balancer(&self, input: &ApplySecurityGroupsToLoadBalancerInput) -> Box<Future<Item = ApplySecurityGroupsToLoadBalancerOutput, Error = ApplySecurityGroupsToLoadBalancerError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(ApplySecurityGroupsToLoadBalancerError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| ApplySecurityGroupsToLoadBalancerError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(ApplySecurityGroupsToLoadBalancerOutputDeserializer::deserialize("ApplySecurityGroupsToLoadBalancerResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(ApplySecurityGroupsToLoadBalancerError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn attach_load_balancer_to_subnets(&self, input: &AttachLoadBalancerToSubnetsInput) -> Box<Future<Item = AttachLoadBalancerToSubnetsOutput, Error = AttachLoadBalancerToSubnetsError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(AttachLoadBalancerToSubnetsError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| AttachLoadBalancerToSubnetsError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(AttachLoadBalancerToSubnetsOutputDeserializer::deserialize("AttachLoadBalancerToSubnetsResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(AttachLoadBalancerToSubnetsError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn configure_health_check(&self, input: &ConfigureHealthCheckInput) -> Box<Future<Item = ConfigureHealthCheckOutput, Error = ConfigureHealthCheckError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(ConfigureHealthCheckError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| ConfigureHealthCheckError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(ConfigureHealthCheckOutputDeserializer::deserialize("ConfigureHealthCheckResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(ConfigureHealthCheckError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn create_app_cookie_stickiness_policy(&self, input: &CreateAppCookieStickinessPolicyInput) -> Box<Future<Item = CreateAppCookieStickinessPolicyOutput, Error = CreateAppCookieStickinessPolicyError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(CreateAppCookieStickinessPolicyError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| CreateAppCookieStickinessPolicyError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(CreateAppCookieStickinessPolicyOutputDeserializer::deserialize("CreateAppCookieStickinessPolicyResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(CreateAppCookieStickinessPolicyError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn create_lb_cookie_stickiness_policy(&self, input: &CreateLBCookieStickinessPolicyInput) -> Box<Future<Item = CreateLBCookieStickinessPolicyOutput, Error = CreateLBCookieStickinessPolicyError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(CreateLBCookieStickinessPolicyError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| CreateLBCookieStickinessPolicyError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(CreateLBCookieStickinessPolicyOutputDeserializer::deserialize("CreateLBCookieStickinessPolicyResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(CreateLBCookieStickinessPolicyError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(CreateAccessPointOutputDeserializer::deserialize("CreateLoadBalancerResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                ...
                fn create_load_balancer_listeners(&self, input: &CreateLoadBalancerListenerInput) -> Box<Future<Item = CreateLoadBalancerListenerOutput, Error = CreateLoadBalancerListenersError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(CreateLoadBalancerListenersError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| CreateLoadBalancerListenersError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(CreateLoadBalancerListenerOutputDeserializer::deserialize("CreateLoadBalancerListenersResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(CreateLoadBalancerListenersError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn create_load_balancer_policy(&self, input: &CreateLoadBalancerPolicyInput) -> Box<Future<Item = CreateLoadBalancerPolicyOutput, Error = CreateLoadBalancerPolicyError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(CreateLoadBalancerPolicyError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| CreateLoadBalancerPolicyError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(CreateLoadBalancerPolicyOutputDeserializer::deserialize("CreateLoadBalancerPolicyResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(CreateLoadBalancerPolicyError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(DeleteAccessPointOutputDeserializer::deserialize("DeleteLoadBalancerResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                ...
                fn delete_load_balancer_listeners(&self, input: &DeleteLoadBalancerListenerInput) -> Box<Future<Item = DeleteLoadBalancerListenerOutput, Error = DeleteLoadBalancerListenersError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DeleteLoadBalancerListenersError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DeleteLoadBalancerListenersError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(DeleteLoadBalancerListenerOutputDeserializer::deserialize("DeleteLoadBalancerListenersResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(DeleteLoadBalancerListenersError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn delete_load_balancer_policy(&self, input: &DeleteLoadBalancerPolicyInput) -> Box<Future<Item = DeleteLoadBalancerPolicyOutput, Error = DeleteLoadBalancerPolicyError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DeleteLoadBalancerPolicyError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DeleteLoadBalancerPolicyError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(DeleteLoadBalancerPolicyOutputDeserializer::deserialize("DeleteLoadBalancerPolicyResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(DeleteLoadBalancerPolicyError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn deregister_instances_from_load_balancer(&self, input: &DeregisterEndPointsInput) -> Box<Future<Item = DeregisterEndPointsOutput, Error = DeregisterInstancesFromLoadBalancerError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DeregisterInstancesFromLoadBalancerError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DeregisterInstancesFromLoadBalancerError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(DeregisterEndPointsOutputDeserializer::deserialize("DeregisterInstancesFromLoadBalancerResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(DeregisterInstancesFromLoadBalancerError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn describe_instance_health(&self, input: &DescribeEndPointStateInput) -> Box<Future<Item = DescribeEndPointStateOutput, Error = DescribeInstanceHealthError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DescribeInstanceHealthError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DescribeInstanceHealthError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(DescribeEndPointStateOutputDeserializer::deserialize("DescribeInstanceHealthResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(DescribeInstanceHealthError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
        ...
        if response.body.is_empty() {
            ...
            try_future!(start_element(&actual_tag_name, &mut stack));
                ...
                fn describe_load_balancer_policies(&self, input: &DescribeLoadBalancerPoliciesInput) -> Box<Future<Item = DescribeLoadBalancerPoliciesOutput, Error = DescribeLoadBalancerPoliciesError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DescribeLoadBalancerPoliciesError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DescribeLoadBalancerPoliciesError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(DescribeLoadBalancerPoliciesOutputDeserializer::deserialize("DescribeLoadBalancerPoliciesResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(DescribeLoadBalancerPoliciesError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn describe_load_balancer_policy_types(&self, input: &DescribeLoadBalancerPolicyTypesInput) -> Box<Future<Item = DescribeLoadBalancerPolicyTypesOutput, Error = DescribeLoadBalancerPolicyTypesError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DescribeLoadBalancerPolicyTypesError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DescribeLoadBalancerPolicyTypesError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(DescribeLoadBalancerPolicyTypesOutputDeserializer::deserialize("DescribeLoadBalancerPolicyTypesResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(DescribeLoadBalancerPolicyTypesError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(DescribeAccessPointsOutputDeserializer::deserialize("DescribeLoadBalancersResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
        ...
        if response.body.is_empty() {
            ...
            try_future!(start_element(&actual_tag_name, &mut stack));
                ...
                fn detach_load_balancer_from_subnets(&self, input: &DetachLoadBalancerFromSubnetsInput) -> Box<Future<Item = DetachLoadBalancerFromSubnetsOutput, Error = DetachLoadBalancerFromSubnetsError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DetachLoadBalancerFromSubnetsError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DetachLoadBalancerFromSubnetsError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(DetachLoadBalancerFromSubnetsOutputDeserializer::deserialize("DetachLoadBalancerFromSubnetsResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(DetachLoadBalancerFromSubnetsError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn disable_availability_zones_for_load_balancer(&self, input: &RemoveAvailabilityZonesInput) -> Box<Future<Item = RemoveAvailabilityZonesOutput, Error = DisableAvailabilityZonesForLoadBalancerError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DisableAvailabilityZonesForLoadBalancerError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DisableAvailabilityZonesForLoadBalancerError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(RemoveAvailabilityZonesOutputDeserializer::deserialize("DisableAvailabilityZonesForLoadBalancerResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(DisableAvailabilityZonesForLoadBalancerError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn enable_availability_zones_for_load_balancer(&self, input: &AddAvailabilityZonesInput) -> Box<Future<Item = AddAvailabilityZonesOutput, Error = EnableAvailabilityZonesForLoadBalancerError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(EnableAvailabilityZonesForLoadBalancerError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| EnableAvailabilityZonesForLoadBalancerError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(AddAvailabilityZonesOutputDeserializer::deserialize("EnableAvailabilityZonesForLoadBalancerResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(EnableAvailabilityZonesForLoadBalancerError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
        ...
        if response.body.is_empty() {
            ...
            try_future!(start_element(&actual_tag_name, &mut stack));
                ...
                fn register_instances_with_load_balancer(&self, input: &RegisterEndPointsInput) -> Box<Future<Item = RegisterEndPointsOutput, Error = RegisterInstancesWithLoadBalancerError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(RegisterInstancesWithLoadBalancerError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| RegisterInstancesWithLoadBalancerError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(RegisterEndPointsOutputDeserializer::deserialize("RegisterInstancesWithLoadBalancerResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(RegisterInstancesWithLoadBalancerError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
        ...
        if response.body.is_empty() {
            ...
            try_future!(start_element(&actual_tag_name, &mut stack));
                ...
                fn set_load_balancer_listener_ssl_certificate(&self, input: &SetLoadBalancerListenerSSLCertificateInput) -> Box<Future<Item = SetLoadBalancerListenerSSLCertificateOutput, Error = SetLoadBalancerListenerSSLCertificateError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(SetLoadBalancerListenerSSLCertificateError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| SetLoadBalancerListenerSSLCertificateError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(SetLoadBalancerListenerSSLCertificateOutputDeserializer::deserialize("SetLoadBalancerListenerSSLCertificateResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(SetLoadBalancerListenerSSLCertificateError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn set_load_balancer_policies_for_backend_server(&self, input: &SetLoadBalancerPoliciesForBackendServerInput) -> Box<Future<Item = SetLoadBalancerPoliciesForBackendServerOutput, Error = SetLoadBalancerPoliciesForBackendServerError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(SetLoadBalancerPoliciesForBackendServerError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| SetLoadBalancerPoliciesForBackendServerError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(SetLoadBalancerPoliciesForBackendServerOutputDeserializer::deserialize("SetLoadBalancerPoliciesForBackendServerResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(SetLoadBalancerPoliciesForBackendServerError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn set_load_balancer_policies_of_listener(&self, input: &SetLoadBalancerPoliciesOfListenerInput) -> Box<Future<Item = SetLoadBalancerPoliciesOfListenerOutput, Error = SetLoadBalancerPoliciesOfListenerError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(SetLoadBalancerPoliciesOfListenerError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| SetLoadBalancerPoliciesOfListenerError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(SetLoadBalancerPoliciesOfListenerOutputDeserializer::deserialize("SetLoadBalancerPoliciesOfListenerResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(SetLoadBalancerPoliciesOfListenerError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
        ...
        fn test_parse_error_elb_describe_load_balancers() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/error", "elb-describe-load-balancers.xml");
        ...
        fn test_parse_valid_elb_describe_load_balancer_policy_types() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/valid", "elb-describe-load-balancer-policy-types.xml");
        ...
        fn test_parse_valid_elb_describe_load_balancer_policies() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/valid", "elb-describe-load-balancer-policies.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = ElbClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_valid_elb_describe_load_balancers() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/valid", "elb-describe-load-balancers.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = ElbClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
            let request = DescribeAccessPointsInput::default();
            let result = client.describe_load_balancers(&request);
