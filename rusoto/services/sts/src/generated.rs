...
struct AccountTypeDeserializer;
            impl AccountTypeDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<AccountType, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
pub role_session_name: RoleSessionNameType,
...
pub token_code: Option<TokenCodeType>,
        ...
        if let Some(ref field_value) = obj.duration_seconds {
                params.put(&format!("{}{}", prefix, "DurationSeconds"), &field_value.to_string());
            }
...
params.put(&format!("{}{}", prefix, "RoleSessionName"), &obj.role_session_name);
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AssumedRoleUser" => {
                obj.assumed_role_user = Some(try!(AssumedRoleUserDeserializer::deserialize("AssumedRoleUser", stack)));
            }
"Credentials" => {
                obj.credentials = Some(try!(CredentialsDeserializer::deserialize("Credentials", stack)));
            }
"PackedPolicySize" => {
                obj.packed_policy_size = Some(try!(NonNegativeIntegerTypeDeserializer::deserialize("PackedPolicySize", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub saml_assertion: SAMLAssertionType,
            }
...
params.put(&format!("{}{}", prefix, "RoleArn"), &obj.role_arn);
params.put(&format!("{}{}", prefix, "SAMLAssertion"), &obj.saml_assertion);
...
"Audience" => {
                obj.audience = Some(try!(AudienceDeserializer::deserialize("Audience", stack)));
            }
"Credentials" => {
                obj.credentials = Some(try!(CredentialsDeserializer::deserialize("Credentials", stack)));
            }
...
"NameQualifier" => {
                obj.name_qualifier = Some(try!(NameQualifierDeserializer::deserialize("NameQualifier", stack)));
            }
"PackedPolicySize" => {
                obj.packed_policy_size = Some(try!(NonNegativeIntegerTypeDeserializer::deserialize("PackedPolicySize", stack)));
            }
"Subject" => {
                obj.subject = Some(try!(SubjectDeserializer::deserialize("Subject", stack)));
            }
"SubjectType" => {
                obj.subject_type = Some(try!(SubjectTypeDeserializer::deserialize("SubjectType", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub web_identity_token: ClientTokenType,
            }
...
params.put(&format!("{}{}", prefix, "RoleArn"), &obj.role_arn);
params.put(&format!("{}{}", prefix, "RoleSessionName"), &obj.role_session_name);
params.put(&format!("{}{}", prefix, "WebIdentityToken"), &obj.web_identity_token);
...
"Provider" => {
                obj.provider = Some(try!(IssuerDeserializer::deserialize("Provider", stack)));
            }
"SubjectFromWebIdentityToken" => {
                obj.subject_from_web_identity_token = Some(try!(WebIdentitySubjectTypeDeserializer::deserialize("SubjectFromWebIdentityToken", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct AssumedRoleIdTypeDeserializer;
            impl AssumedRoleIdTypeDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<AssumedRoleIdType, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
"AssumedRoleId" => {
                obj.assumed_role_id = try!(AssumedRoleIdTypeDeserializer::deserialize("AssumedRoleId", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AccessKeyId" => {
                obj.access_key_id = try!(AccessKeyIdTypeDeserializer::deserialize("AccessKeyId", stack));
            }
"Expiration" => {
                obj.expiration = try!(DateTypeDeserializer::deserialize("Expiration", stack));
            }
"SecretAccessKey" => {
                obj.secret_access_key = try!(AccessKeySecretTypeDeserializer::deserialize("SecretAccessKey", stack));
            }
"SessionToken" => {
                obj.session_token = try!(TokenTypeDeserializer::deserialize("SessionToken", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub encoded_message: EncodedMessageType,
            }
        ...
        params.put(&format!("{}{}", prefix, "EncodedMessage"), &obj.encoded_message);
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "DecodedMessage" => {
                obj.decoded_message = Some(try!(DecodedMessageTypeDeserializer::deserialize("DecodedMessage", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct DecodedMessageTypeDeserializer;
            impl DecodedMessageTypeDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<DecodedMessageType, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
pub type DurationSecondsType = i64;
...
struct FederatedIdTypeDeserializer;
            impl FederatedIdTypeDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<FederatedIdType, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
"FederatedUserId" => {
                obj.federated_user_id = try!(FederatedIdTypeDeserializer::deserialize("FederatedUserId", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Account" => {
                obj.account = Some(try!(AccountTypeDeserializer::deserialize("Account", stack)));
            }
"Arn" => {
                obj.arn = Some(try!(ArnTypeDeserializer::deserialize("Arn", stack)));
            }
"UserId" => {
                obj.user_id = Some(try!(UserIdTypeDeserializer::deserialize("UserId", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"FederatedUser" => {
                obj.federated_user = Some(try!(FederatedUserDeserializer::deserialize("FederatedUser", stack)));
            }
"PackedPolicySize" => {
                obj.packed_policy_size = Some(try!(NonNegativeIntegerTypeDeserializer::deserialize("PackedPolicySize", stack)));
            }
...
struct NameQualifierDeserializer;
            impl NameQualifierDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<NameQualifier, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
pub type RoleDurationSecondsType = i64;
...
struct SubjectTypeDeserializer;
            impl SubjectTypeDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<SubjectType, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
struct TokenTypeDeserializer;
            impl TokenTypeDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<TokenType, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
struct UserIdTypeDeserializer;
            impl UserIdTypeDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<UserIdType, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
struct WebIdentitySubjectTypeDeserializer;
            impl WebIdentitySubjectTypeDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<WebIdentitySubjectType, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
InvalidAuthorizationMessage(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl DecodeAuthorizationMessageError {
                    pub fn from_body(body: &str) -> DecodeAuthorizationMessageError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidAuthorizationMessageException" => DecodeAuthorizationMessageError::InvalidAuthorizationMessage(String::from(parsed_error.message)),_ => DecodeAuthorizationMessageError::Unknown(String::from(body))
                                }
                           },
                ...
                impl GetSessionTokenError {
                    pub fn from_body(body: &str) -> GetSessionTokenError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "RegionDisabledException" => GetSessionTokenError::RegionDisabled(String::from(parsed_error.message)),_ => GetSessionTokenError::Unknown(String::from(body))
                                }
                           },
...
/// Trait representing the capabilities of the AWS STS API. AWS STS clients implement this trait.
        pub trait Sts {
                ...
                fn assume_role(&self, input: &AssumeRoleRequest) -> Box<Future<Item = AssumeRoleResponse, Error = AssumeRoleError>>;
                ...
                fn assume_role_with_saml(&self, input: &AssumeRoleWithSAMLRequest) -> Box<Future<Item = AssumeRoleWithSAMLResponse, Error = AssumeRoleWithSAMLError>>;
                ...
                fn assume_role_with_web_identity(&self, input: &AssumeRoleWithWebIdentityRequest) -> Box<Future<Item = AssumeRoleWithWebIdentityResponse, Error = AssumeRoleWithWebIdentityError>>;
                ...
                fn decode_authorization_message(&self, input: &DecodeAuthorizationMessageRequest) -> Box<Future<Item = DecodeAuthorizationMessageResponse, Error = DecodeAuthorizationMessageError>>;
                

                #[doc="<p>Returns details about the IAM identity whose credentials are used to call the API.</p>"]
                fn get_caller_identity(&self, input: &GetCallerIdentityRequest) -> Box<Future<Item = GetCallerIdentityResponse, Error = GetCallerIdentityError>>;
                ...
                fn get_federation_token(&self, input: &GetFederationTokenRequest) -> Box<Future<Item = GetFederationTokenResponse, Error = GetFederationTokenError>>;
                ...
                fn get_session_token(&self, input: &GetSessionTokenRequest) -> Box<Future<Item = GetSessionTokenResponse, Error = GetSessionTokenError>>;
                
}
/// A client for the AWS STS API.
        pub struct StsClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            credentials_provider: P,
            region: region::Region,
            dispatcher: D,
        }

        impl<P, D> StsClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
        ...
        impl<P, D> Sts for StsClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
                ...
                fn assume_role(&self, input: &AssumeRoleRequest) -> Box<Future<Item = AssumeRoleResponse, Error = AssumeRoleError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(AssumeRoleError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| AssumeRoleError::from(dispatch_err))
                        .and_then(
        ...
        if response.body.is_empty() {
            ...
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(AssumeRoleResponseDeserializer::deserialize("AssumeRoleResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(AssumeRoleError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn assume_role_with_saml(&self, input: &AssumeRoleWithSAMLRequest) -> Box<Future<Item = AssumeRoleWithSAMLResponse, Error = AssumeRoleWithSAMLError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(AssumeRoleWithSAMLError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| AssumeRoleWithSAMLError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(AssumeRoleWithSAMLResponseDeserializer::deserialize("AssumeRoleWithSAMLResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(AssumeRoleWithSAMLError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn assume_role_with_web_identity(&self, input: &AssumeRoleWithWebIdentityRequest) -> Box<Future<Item = AssumeRoleWithWebIdentityResponse, Error = AssumeRoleWithWebIdentityError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(AssumeRoleWithWebIdentityError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| AssumeRoleWithWebIdentityError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(AssumeRoleWithWebIdentityResponseDeserializer::deserialize("AssumeRoleWithWebIdentityResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(AssumeRoleWithWebIdentityError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn decode_authorization_message(&self, input: &DecodeAuthorizationMessageRequest) -> Box<Future<Item = DecodeAuthorizationMessageResponse, Error = DecodeAuthorizationMessageError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DecodeAuthorizationMessageError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DecodeAuthorizationMessageError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(DecodeAuthorizationMessageResponseDeserializer::deserialize("DecodeAuthorizationMessageResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(DecodeAuthorizationMessageError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn get_caller_identity(&self, input: &GetCallerIdentityRequest) -> Box<Future<Item = GetCallerIdentityResponse, Error = GetCallerIdentityError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(GetCallerIdentityError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| GetCallerIdentityError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(GetCallerIdentityResponseDeserializer::deserialize("GetCallerIdentityResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(GetCallerIdentityError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn get_federation_token(&self, input: &GetFederationTokenRequest) -> Box<Future<Item = GetFederationTokenResponse, Error = GetFederationTokenError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(GetFederationTokenError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| GetFederationTokenError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(GetFederationTokenResponseDeserializer::deserialize("GetFederationTokenResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(GetFederationTokenError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn get_session_token(&self, input: &GetSessionTokenRequest) -> Box<Future<Item = GetSessionTokenResponse, Error = GetSessionTokenError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(GetSessionTokenError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| GetSessionTokenError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(GetSessionTokenResponseDeserializer::deserialize("GetSessionTokenResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(GetSessionTokenError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
        ...
        fn test_parse_error_sts_get_session_token() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/error", "sts-get-session-token.xml");
        ...
        fn test_parse_valid_sts_get_session_token() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/valid", "sts-get-session-token.xml");
