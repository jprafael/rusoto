                    ...
                    pub fn from_body(body: &str) -> CreateDeliveryStreamError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidArgumentException" => CreateDeliveryStreamError::InvalidArgument(String::from(error_message)),
"LimitExceededException" => CreateDeliveryStreamError::LimitExceeded(String::from(error_message)),
"ResourceInUseException" => CreateDeliveryStreamError::ResourceInUse(String::from(error_message)),
"ValidationException" => CreateDeliveryStreamError::Validation(error_message.to_string()),
...
CreateDeliveryStreamError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> DeleteDeliveryStreamError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "ResourceInUseException" => DeleteDeliveryStreamError::ResourceInUse(String::from(error_message)),
"ResourceNotFoundException" => DeleteDeliveryStreamError::ResourceNotFound(String::from(error_message)),
"ValidationException" => DeleteDeliveryStreamError::Validation(error_message.to_string()),
...
DeleteDeliveryStreamError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> DescribeDeliveryStreamError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "ResourceNotFoundException" => DescribeDeliveryStreamError::ResourceNotFound(String::from(error_message)),
"ValidationException" => DescribeDeliveryStreamError::Validation(error_message.to_string()),
...
DescribeDeliveryStreamError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> ListDeliveryStreamsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "ValidationException" => ListDeliveryStreamsError::Validation(error_message.to_string()),
...
ListDeliveryStreamsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
"ServiceUnavailableException" => PutRecordError::ServiceUnavailable(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> PutRecordBatchError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InvalidArgumentException" => PutRecordBatchError::InvalidArgument(String::from(error_message)),
"ResourceNotFoundException" => PutRecordBatchError::ResourceNotFound(String::from(error_message)),
"ServiceUnavailableException" => PutRecordBatchError::ServiceUnavailable(String::from(error_message)),
"ValidationException" => PutRecordBatchError::Validation(error_message.to_string()),
                    ...
                    pub fn from_body(body: &str) -> UpdateDestinationError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "ConcurrentModificationException" => UpdateDestinationError::ConcurrentModification(String::from(error_message)),
"InvalidArgumentException" => UpdateDestinationError::InvalidArgument(String::from(error_message)),
"ResourceInUseException" => UpdateDestinationError::ResourceInUse(String::from(error_message)),
"ResourceNotFoundException" => UpdateDestinationError::ResourceNotFound(String::from(error_message)),
"ValidationException" => UpdateDestinationError::Validation(error_message.to_string()),
...
UpdateDestinationError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
/// Trait representing the capabilities of the Firehose API. Firehose clients implement this trait.
        pub trait KinesisFirehose {
                ...
                fn create_delivery_stream(&self, input: &CreateDeliveryStreamInput)  -> Box<Future<Item = CreateDeliveryStreamOutput, Error = CreateDeliveryStreamError>>;
                ...
                fn delete_delivery_stream(&self, input: &DeleteDeliveryStreamInput)  -> Box<Future<Item = DeleteDeliveryStreamOutput, Error = DeleteDeliveryStreamError>>;
                ...
                fn describe_delivery_stream(&self, input: &DescribeDeliveryStreamInput)  -> Box<Future<Item = DescribeDeliveryStreamOutput, Error = DescribeDeliveryStreamError>>;
                ...
                fn list_delivery_streams(&self, input: &ListDeliveryStreamsInput)  -> Box<Future<Item = ListDeliveryStreamsOutput, Error = ListDeliveryStreamsError>>;
                ...
                fn put_record_batch(&self, input: &PutRecordBatchInput)  -> Box<Future<Item = PutRecordBatchOutput, Error = PutRecordBatchError>>;
                ...
                fn update_destination(&self, input: &UpdateDestinationInput)  -> Box<Future<Item = UpdateDestinationOutput, Error = UpdateDestinationError>>;
        ...
        impl<P, D> KinesisFirehose for KinesisFirehoseClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(CreateDeliveryStreamError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| CreateDeliveryStreamError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<CreateDeliveryStreamOutput>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(CreateDeliveryStreamError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DeleteDeliveryStreamError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DeleteDeliveryStreamError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<DeleteDeliveryStreamOutput>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(DeleteDeliveryStreamError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DescribeDeliveryStreamError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DescribeDeliveryStreamError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<DescribeDeliveryStreamOutput>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(DescribeDeliveryStreamError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(ListDeliveryStreamsError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| ListDeliveryStreamsError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<ListDeliveryStreamsOutput>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(ListDeliveryStreamsError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(PutRecordBatchError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| PutRecordBatchError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<PutRecordBatchOutput>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(PutRecordBatchError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(UpdateDestinationError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| UpdateDestinationError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<UpdateDestinationOutput>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(UpdateDestinationError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
