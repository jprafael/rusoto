                    ...
                    pub fn from_body(body: &str) -> AddTagsToResourceError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "CloudHsmInternalException" => AddTagsToResourceError::CloudHsmInternal(String::from(error_message)),
"CloudHsmServiceException" => AddTagsToResourceError::CloudHsmService(String::from(error_message)),
"InvalidRequestException" => AddTagsToResourceError::InvalidRequest(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> CreateHapgError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "CloudHsmInternalException" => CreateHapgError::CloudHsmInternal(String::from(error_message)),
"CloudHsmServiceException" => CreateHapgError::CloudHsmService(String::from(error_message)),
"InvalidRequestException" => CreateHapgError::InvalidRequest(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> CreateHsmError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "CloudHsmInternalException" => CreateHsmError::CloudHsmInternal(String::from(error_message)),
"CloudHsmServiceException" => CreateHsmError::CloudHsmService(String::from(error_message)),
"InvalidRequestException" => CreateHsmError::InvalidRequest(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> CreateLunaClientError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "CloudHsmInternalException" => CreateLunaClientError::CloudHsmInternal(String::from(error_message)),
"CloudHsmServiceException" => CreateLunaClientError::CloudHsmService(String::from(error_message)),
"InvalidRequestException" => CreateLunaClientError::InvalidRequest(String::from(error_message)),
"ValidationException" => CreateLunaClientError::Validation(error_message.to_string()),
                    ...
                    pub fn from_body(body: &str) -> DeleteHapgError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "CloudHsmInternalException" => DeleteHapgError::CloudHsmInternal(String::from(error_message)),
"CloudHsmServiceException" => DeleteHapgError::CloudHsmService(String::from(error_message)),
"InvalidRequestException" => DeleteHapgError::InvalidRequest(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> DeleteHsmError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "CloudHsmInternalException" => DeleteHsmError::CloudHsmInternal(String::from(error_message)),
"CloudHsmServiceException" => DeleteHsmError::CloudHsmService(String::from(error_message)),
"InvalidRequestException" => DeleteHsmError::InvalidRequest(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> DeleteLunaClientError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "CloudHsmInternalException" => DeleteLunaClientError::CloudHsmInternal(String::from(error_message)),
"CloudHsmServiceException" => DeleteLunaClientError::CloudHsmService(String::from(error_message)),
"InvalidRequestException" => DeleteLunaClientError::InvalidRequest(String::from(error_message)),
"ValidationException" => DeleteLunaClientError::Validation(error_message.to_string()),
                    ...
                    pub fn from_body(body: &str) -> DescribeHapgError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "CloudHsmInternalException" => DescribeHapgError::CloudHsmInternal(String::from(error_message)),
"CloudHsmServiceException" => DescribeHapgError::CloudHsmService(String::from(error_message)),
"InvalidRequestException" => DescribeHapgError::InvalidRequest(String::from(error_message)),
"ValidationException" => DescribeHapgError::Validation(error_message.to_string()),
                    ...
                    pub fn from_body(body: &str) -> DescribeHsmError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "CloudHsmInternalException" => DescribeHsmError::CloudHsmInternal(String::from(error_message)),
"CloudHsmServiceException" => DescribeHsmError::CloudHsmService(String::from(error_message)),
"InvalidRequestException" => DescribeHsmError::InvalidRequest(String::from(error_message)),
"ValidationException" => DescribeHsmError::Validation(error_message.to_string()),
                    ...
                    pub fn from_body(body: &str) -> DescribeLunaClientError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "CloudHsmInternalException" => DescribeLunaClientError::CloudHsmInternal(String::from(error_message)),
"CloudHsmServiceException" => DescribeLunaClientError::CloudHsmService(String::from(error_message)),
"InvalidRequestException" => DescribeLunaClientError::InvalidRequest(String::from(error_message)),
"ValidationException" => DescribeLunaClientError::Validation(error_message.to_string()),
...
DescribeLunaClientError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> GetConfigError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "CloudHsmInternalException" => GetConfigError::CloudHsmInternal(String::from(error_message)),
"CloudHsmServiceException" => GetConfigError::CloudHsmService(String::from(error_message)),
"InvalidRequestException" => GetConfigError::InvalidRequest(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> ListAvailableZonesError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "CloudHsmInternalException" => ListAvailableZonesError::CloudHsmInternal(String::from(error_message)),
"CloudHsmServiceException" => ListAvailableZonesError::CloudHsmService(String::from(error_message)),
"InvalidRequestException" => ListAvailableZonesError::InvalidRequest(String::from(error_message)),
"ValidationException" => ListAvailableZonesError::Validation(error_message.to_string()),
...
ListAvailableZonesError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> ListHapgsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "CloudHsmInternalException" => ListHapgsError::CloudHsmInternal(String::from(error_message)),
"CloudHsmServiceException" => ListHapgsError::CloudHsmService(String::from(error_message)),
"InvalidRequestException" => ListHapgsError::InvalidRequest(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> ListHsmsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "CloudHsmInternalException" => ListHsmsError::CloudHsmInternal(String::from(error_message)),
"CloudHsmServiceException" => ListHsmsError::CloudHsmService(String::from(error_message)),
"InvalidRequestException" => ListHsmsError::InvalidRequest(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> ListLunaClientsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "CloudHsmInternalException" => ListLunaClientsError::CloudHsmInternal(String::from(error_message)),
"CloudHsmServiceException" => ListLunaClientsError::CloudHsmService(String::from(error_message)),
"InvalidRequestException" => ListLunaClientsError::InvalidRequest(String::from(error_message)),
"ValidationException" => ListLunaClientsError::Validation(error_message.to_string()),
                    ...
                    pub fn from_body(body: &str) -> ListTagsForResourceError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "CloudHsmInternalException" => ListTagsForResourceError::CloudHsmInternal(String::from(error_message)),
"CloudHsmServiceException" => ListTagsForResourceError::CloudHsmService(String::from(error_message)),
"InvalidRequestException" => ListTagsForResourceError::InvalidRequest(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> ModifyHapgError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "CloudHsmInternalException" => ModifyHapgError::CloudHsmInternal(String::from(error_message)),
"CloudHsmServiceException" => ModifyHapgError::CloudHsmService(String::from(error_message)),
"InvalidRequestException" => ModifyHapgError::InvalidRequest(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> ModifyHsmError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "CloudHsmInternalException" => ModifyHsmError::CloudHsmInternal(String::from(error_message)),
"CloudHsmServiceException" => ModifyHsmError::CloudHsmService(String::from(error_message)),
"InvalidRequestException" => ModifyHsmError::InvalidRequest(String::from(error_message)),
...
///<p>Indicates that an exception occurred in the AWS CloudHSM service.</p>
CloudHsmService(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                    ...
                    pub fn from_body(body: &str) -> ModifyLunaClientError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "CloudHsmServiceException" => ModifyLunaClientError::CloudHsmService(String::from(error_message)),
"ValidationException" => ModifyLunaClientError::Validation(error_message.to_string()),
                    ...
                    pub fn from_body(body: &str) -> RemoveTagsFromResourceError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "CloudHsmInternalException" => RemoveTagsFromResourceError::CloudHsmInternal(String::from(error_message)),
"CloudHsmServiceException" => RemoveTagsFromResourceError::CloudHsmService(String::from(error_message)),
"InvalidRequestException" => RemoveTagsFromResourceError::InvalidRequest(String::from(error_message)),
...
/// A client for the CloudHSM API.
        pub struct CloudHsmClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            credentials_provider: P,
            region: region::Region,
            dispatcher: D,
        }

        impl<P, D> CloudHsmClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
        ...
        impl<P, D> CloudHsm for CloudHsmClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                fn list_tags_for_resource(&self, input: &ListTagsForResourceRequest)  -> Box<Future<Item = ListTagsForResourceResponse, Error = ListTagsForResourceError>> {
                    ...
                    request.set_content_type("application/x-amz-json-1.1".to_owned());
                    request.add_header("x-amz-target", "CloudHsmFrontendService.ListTagsForResource");
                    let encoded = serde_json::to_string(input).unwrap();
         request.set_payload(Some(encoded.into_bytes()));
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                fn remove_tags_from_resource(&self, input: &RemoveTagsFromResourceRequest)  -> Box<Future<Item = RemoveTagsFromResourceResponse, Error = RemoveTagsFromResourceError>> {
                    ...
                    request.set_content_type("application/x-amz-json-1.1".to_owned());
                    request.add_header("x-amz-target", "CloudHsmFrontendService.RemoveTagsFromResource");
                    let encoded = serde_json::to_string(input).unwrap();
         request.set_payload(Some(encoded.into_bytes()));
