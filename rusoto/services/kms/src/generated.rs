...
pub type EncryptionContextType = ::std::collections::HashMap<EncryptionContextKey, EncryptionContextValue>;
                    ...
                    pub fn from_body(body: &str) -> CancelKeyDeletionError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => CancelKeyDeletionError::DependencyTimeout(String::from(error_message)),
"InvalidArnException" => CancelKeyDeletionError::InvalidArn(String::from(error_message)),
"KMSInternalException" => CancelKeyDeletionError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => CancelKeyDeletionError::KMSInvalidState(String::from(error_message)),
"NotFoundException" => CancelKeyDeletionError::NotFound(String::from(error_message)),
"ValidationException" => CancelKeyDeletionError::Validation(error_message.to_string()),
...
CancelKeyDeletionError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> CreateAliasError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AlreadyExistsException" => CreateAliasError::AlreadyExists(String::from(error_message)),
"DependencyTimeoutException" => CreateAliasError::DependencyTimeout(String::from(error_message)),
"InvalidAliasNameException" => CreateAliasError::InvalidAliasName(String::from(error_message)),
"KMSInternalException" => CreateAliasError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => CreateAliasError::KMSInvalidState(String::from(error_message)),
"LimitExceededException" => CreateAliasError::LimitExceeded(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> CreateGrantError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => CreateGrantError::DependencyTimeout(String::from(error_message)),
"DisabledException" => CreateGrantError::Disabled(String::from(error_message)),
"InvalidArnException" => CreateGrantError::InvalidArn(String::from(error_message)),
"InvalidGrantTokenException" => CreateGrantError::InvalidGrantToken(String::from(error_message)),
"KMSInternalException" => CreateGrantError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => CreateGrantError::KMSInvalidState(String::from(error_message)),
"LimitExceededException" => CreateGrantError::LimitExceeded(String::from(error_message)),
"NotFoundException" => CreateGrantError::NotFound(String::from(error_message)),
"ValidationException" => CreateGrantError::Validation(error_message.to_string()),
                    ...
                    pub fn from_body(body: &str) -> CreateKeyError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => CreateKeyError::DependencyTimeout(String::from(error_message)),
"InvalidArnException" => CreateKeyError::InvalidArn(String::from(error_message)),
"KMSInternalException" => CreateKeyError::KMSInternal(String::from(error_message)),
"LimitExceededException" => CreateKeyError::LimitExceeded(String::from(error_message)),
"MalformedPolicyDocumentException" => CreateKeyError::MalformedPolicyDocument(String::from(error_message)),
"UnsupportedOperationException" => CreateKeyError::UnsupportedOperation(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> DecryptError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => DecryptError::DependencyTimeout(String::from(error_message)),
"DisabledException" => DecryptError::Disabled(String::from(error_message)),
"InvalidCiphertextException" => DecryptError::InvalidCiphertext(String::from(error_message)),
"InvalidGrantTokenException" => DecryptError::InvalidGrantToken(String::from(error_message)),
"KMSInternalException" => DecryptError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => DecryptError::KMSInvalidState(String::from(error_message)),
"KeyUnavailableException" => DecryptError::KeyUnavailable(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> DeleteAliasError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => DeleteAliasError::DependencyTimeout(String::from(error_message)),
"KMSInternalException" => DeleteAliasError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => DeleteAliasError::KMSInvalidState(String::from(error_message)),
...
"InvalidArnException" => DeleteImportedKeyMaterialError::InvalidArn(String::from(error_message)),
"KMSInternalException" => DeleteImportedKeyMaterialError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => DeleteImportedKeyMaterialError::KMSInvalidState(String::from(error_message)),
"NotFoundException" => DeleteImportedKeyMaterialError::NotFound(String::from(error_message)),
"UnsupportedOperationException" => DeleteImportedKeyMaterialError::UnsupportedOperation(String::from(error_message)),
"ValidationException" => DeleteImportedKeyMaterialError::Validation(error_message.to_string()),
...
DeleteImportedKeyMaterialError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> DescribeKeyError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => DescribeKeyError::DependencyTimeout(String::from(error_message)),
"InvalidArnException" => DescribeKeyError::InvalidArn(String::from(error_message)),
"KMSInternalException" => DescribeKeyError::KMSInternal(String::from(error_message)),
"NotFoundException" => DescribeKeyError::NotFound(String::from(error_message)),
"ValidationException" => DescribeKeyError::Validation(error_message.to_string()),
                    ...
                    pub fn from_body(body: &str) -> DisableKeyError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => DisableKeyError::DependencyTimeout(String::from(error_message)),
"InvalidArnException" => DisableKeyError::InvalidArn(String::from(error_message)),
"KMSInternalException" => DisableKeyError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => DisableKeyError::KMSInvalidState(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> DisableKeyRotationError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => DisableKeyRotationError::DependencyTimeout(String::from(error_message)),
"DisabledException" => DisableKeyRotationError::Disabled(String::from(error_message)),
"InvalidArnException" => DisableKeyRotationError::InvalidArn(String::from(error_message)),
"KMSInternalException" => DisableKeyRotationError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => DisableKeyRotationError::KMSInvalidState(String::from(error_message)),
"NotFoundException" => DisableKeyRotationError::NotFound(String::from(error_message)),
"UnsupportedOperationException" => DisableKeyRotationError::UnsupportedOperation(String::from(error_message)),
"ValidationException" => DisableKeyRotationError::Validation(error_message.to_string()),
...
DisableKeyRotationError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> EnableKeyError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => EnableKeyError::DependencyTimeout(String::from(error_message)),
"InvalidArnException" => EnableKeyError::InvalidArn(String::from(error_message)),
"KMSInternalException" => EnableKeyError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => EnableKeyError::KMSInvalidState(String::from(error_message)),
"LimitExceededException" => EnableKeyError::LimitExceeded(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> EnableKeyRotationError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => EnableKeyRotationError::DependencyTimeout(String::from(error_message)),
"DisabledException" => EnableKeyRotationError::Disabled(String::from(error_message)),
"InvalidArnException" => EnableKeyRotationError::InvalidArn(String::from(error_message)),
"KMSInternalException" => EnableKeyRotationError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => EnableKeyRotationError::KMSInvalidState(String::from(error_message)),
"NotFoundException" => EnableKeyRotationError::NotFound(String::from(error_message)),
"UnsupportedOperationException" => EnableKeyRotationError::UnsupportedOperation(String::from(error_message)),
"ValidationException" => EnableKeyRotationError::Validation(error_message.to_string()),
...
EnableKeyRotationError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> EncryptError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => EncryptError::DependencyTimeout(String::from(error_message)),
"DisabledException" => EncryptError::Disabled(String::from(error_message)),
"InvalidGrantTokenException" => EncryptError::InvalidGrantToken(String::from(error_message)),
"InvalidKeyUsageException" => EncryptError::InvalidKeyUsage(String::from(error_message)),
"KMSInternalException" => EncryptError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => EncryptError::KMSInvalidState(String::from(error_message)),
"KeyUnavailableException" => EncryptError::KeyUnavailable(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> GenerateDataKeyError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => GenerateDataKeyError::DependencyTimeout(String::from(error_message)),
"DisabledException" => GenerateDataKeyError::Disabled(String::from(error_message)),
"InvalidGrantTokenException" => GenerateDataKeyError::InvalidGrantToken(String::from(error_message)),
"InvalidKeyUsageException" => GenerateDataKeyError::InvalidKeyUsage(String::from(error_message)),
"KMSInternalException" => GenerateDataKeyError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => GenerateDataKeyError::KMSInvalidState(String::from(error_message)),
"KeyUnavailableException" => GenerateDataKeyError::KeyUnavailable(String::from(error_message)),
"NotFoundException" => GenerateDataKeyError::NotFound(String::from(error_message)),
"ValidationException" => GenerateDataKeyError::Validation(error_message.to_string()),
...
"DisabledException" => GenerateDataKeyWithoutPlaintextError::Disabled(String::from(error_message)),
...
"NotFoundException" => GenerateDataKeyWithoutPlaintextError::NotFound(String::from(error_message)),
"ValidationException" => GenerateDataKeyWithoutPlaintextError::Validation(error_message.to_string()),
...
GenerateDataKeyWithoutPlaintextError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> GenerateRandomError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => GenerateRandomError::DependencyTimeout(String::from(error_message)),
"KMSInternalException" => GenerateRandomError::KMSInternal(String::from(error_message)),
"ValidationException" => GenerateRandomError::Validation(error_message.to_string()),
                    ...
                    pub fn from_body(body: &str) -> GetKeyPolicyError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => GetKeyPolicyError::DependencyTimeout(String::from(error_message)),
"InvalidArnException" => GetKeyPolicyError::InvalidArn(String::from(error_message)),
"KMSInternalException" => GetKeyPolicyError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => GetKeyPolicyError::KMSInvalidState(String::from(error_message)),
"NotFoundException" => GetKeyPolicyError::NotFound(String::from(error_message)),
"ValidationException" => GetKeyPolicyError::Validation(error_message.to_string()),
                    ...
                    pub fn from_body(body: &str) -> GetKeyRotationStatusError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => GetKeyRotationStatusError::DependencyTimeout(String::from(error_message)),
"InvalidArnException" => GetKeyRotationStatusError::InvalidArn(String::from(error_message)),
"KMSInternalException" => GetKeyRotationStatusError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => GetKeyRotationStatusError::KMSInvalidState(String::from(error_message)),
"NotFoundException" => GetKeyRotationStatusError::NotFound(String::from(error_message)),
"UnsupportedOperationException" => GetKeyRotationStatusError::UnsupportedOperation(String::from(error_message)),
"ValidationException" => GetKeyRotationStatusError::Validation(error_message.to_string()),
...
GetKeyRotationStatusError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> GetParametersForImportError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => GetParametersForImportError::DependencyTimeout(String::from(error_message)),
"InvalidArnException" => GetParametersForImportError::InvalidArn(String::from(error_message)),
"KMSInternalException" => GetParametersForImportError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => GetParametersForImportError::KMSInvalidState(String::from(error_message)),
"NotFoundException" => GetParametersForImportError::NotFound(String::from(error_message)),
"UnsupportedOperationException" => GetParametersForImportError::UnsupportedOperation(String::from(error_message)),
"ValidationException" => GetParametersForImportError::Validation(error_message.to_string()),
...
GetParametersForImportError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> ImportKeyMaterialError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => ImportKeyMaterialError::DependencyTimeout(String::from(error_message)),
"ExpiredImportTokenException" => ImportKeyMaterialError::ExpiredImportToken(String::from(error_message)),
"IncorrectKeyMaterialException" => ImportKeyMaterialError::IncorrectKeyMaterial(String::from(error_message)),
"InvalidArnException" => ImportKeyMaterialError::InvalidArn(String::from(error_message)),
"InvalidCiphertextException" => ImportKeyMaterialError::InvalidCiphertext(String::from(error_message)),
"InvalidImportTokenException" => ImportKeyMaterialError::InvalidImportToken(String::from(error_message)),
"KMSInternalException" => ImportKeyMaterialError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => ImportKeyMaterialError::KMSInvalidState(String::from(error_message)),
"NotFoundException" => ImportKeyMaterialError::NotFound(String::from(error_message)),
"UnsupportedOperationException" => ImportKeyMaterialError::UnsupportedOperation(String::from(error_message)),
"ValidationException" => ImportKeyMaterialError::Validation(error_message.to_string()),
...
ImportKeyMaterialError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> ListAliasesError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => ListAliasesError::DependencyTimeout(String::from(error_message)),
"InvalidMarkerException" => ListAliasesError::InvalidMarker(String::from(error_message)),
"KMSInternalException" => ListAliasesError::KMSInternal(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> ListGrantsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => ListGrantsError::DependencyTimeout(String::from(error_message)),
"InvalidArnException" => ListGrantsError::InvalidArn(String::from(error_message)),
"InvalidMarkerException" => ListGrantsError::InvalidMarker(String::from(error_message)),
"KMSInternalException" => ListGrantsError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => ListGrantsError::KMSInvalidState(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> ListKeyPoliciesError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => ListKeyPoliciesError::DependencyTimeout(String::from(error_message)),
"InvalidArnException" => ListKeyPoliciesError::InvalidArn(String::from(error_message)),
"KMSInternalException" => ListKeyPoliciesError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => ListKeyPoliciesError::KMSInvalidState(String::from(error_message)),
"NotFoundException" => ListKeyPoliciesError::NotFound(String::from(error_message)),
"ValidationException" => ListKeyPoliciesError::Validation(error_message.to_string()),
                    ...
                    pub fn from_body(body: &str) -> ListKeysError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => ListKeysError::DependencyTimeout(String::from(error_message)),
"InvalidMarkerException" => ListKeysError::InvalidMarker(String::from(error_message)),
"KMSInternalException" => ListKeysError::KMSInternal(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> ListRetirableGrantsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => ListRetirableGrantsError::DependencyTimeout(String::from(error_message)),
"InvalidArnException" => ListRetirableGrantsError::InvalidArn(String::from(error_message)),
"InvalidMarkerException" => ListRetirableGrantsError::InvalidMarker(String::from(error_message)),
"KMSInternalException" => ListRetirableGrantsError::KMSInternal(String::from(error_message)),
"NotFoundException" => ListRetirableGrantsError::NotFound(String::from(error_message)),
"ValidationException" => ListRetirableGrantsError::Validation(error_message.to_string()),
...
ListRetirableGrantsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> PutKeyPolicyError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => PutKeyPolicyError::DependencyTimeout(String::from(error_message)),
"InvalidArnException" => PutKeyPolicyError::InvalidArn(String::from(error_message)),
"KMSInternalException" => PutKeyPolicyError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => PutKeyPolicyError::KMSInvalidState(String::from(error_message)),
"LimitExceededException" => PutKeyPolicyError::LimitExceeded(String::from(error_message)),
"MalformedPolicyDocumentException" => PutKeyPolicyError::MalformedPolicyDocument(String::from(error_message)),
"NotFoundException" => PutKeyPolicyError::NotFound(String::from(error_message)),
"UnsupportedOperationException" => PutKeyPolicyError::UnsupportedOperation(String::from(error_message)),
"ValidationException" => PutKeyPolicyError::Validation(error_message.to_string()),
                    ...
                    pub fn from_body(body: &str) -> ReEncryptError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => ReEncryptError::DependencyTimeout(String::from(error_message)),
"DisabledException" => ReEncryptError::Disabled(String::from(error_message)),
"InvalidCiphertextException" => ReEncryptError::InvalidCiphertext(String::from(error_message)),
"InvalidGrantTokenException" => ReEncryptError::InvalidGrantToken(String::from(error_message)),
"InvalidKeyUsageException" => ReEncryptError::InvalidKeyUsage(String::from(error_message)),
"KMSInternalException" => ReEncryptError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => ReEncryptError::KMSInvalidState(String::from(error_message)),
"KeyUnavailableException" => ReEncryptError::KeyUnavailable(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> RetireGrantError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => RetireGrantError::DependencyTimeout(String::from(error_message)),
"InvalidGrantIdException" => RetireGrantError::InvalidGrantId(String::from(error_message)),
"InvalidGrantTokenException" => RetireGrantError::InvalidGrantToken(String::from(error_message)),
"KMSInternalException" => RetireGrantError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => RetireGrantError::KMSInvalidState(String::from(error_message)),
"NotFoundException" => RetireGrantError::NotFound(String::from(error_message)),
"ValidationException" => RetireGrantError::Validation(error_message.to_string()),
                    ...
                    pub fn from_body(body: &str) -> RevokeGrantError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => RevokeGrantError::DependencyTimeout(String::from(error_message)),
"InvalidArnException" => RevokeGrantError::InvalidArn(String::from(error_message)),
"InvalidGrantIdException" => RevokeGrantError::InvalidGrantId(String::from(error_message)),
"KMSInternalException" => RevokeGrantError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => RevokeGrantError::KMSInvalidState(String::from(error_message)),
"NotFoundException" => RevokeGrantError::NotFound(String::from(error_message)),
"ValidationException" => RevokeGrantError::Validation(error_message.to_string()),
                    ...
                    pub fn from_body(body: &str) -> ScheduleKeyDeletionError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => ScheduleKeyDeletionError::DependencyTimeout(String::from(error_message)),
"InvalidArnException" => ScheduleKeyDeletionError::InvalidArn(String::from(error_message)),
"KMSInternalException" => ScheduleKeyDeletionError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => ScheduleKeyDeletionError::KMSInvalidState(String::from(error_message)),
"NotFoundException" => ScheduleKeyDeletionError::NotFound(String::from(error_message)),
"ValidationException" => ScheduleKeyDeletionError::Validation(error_message.to_string()),
...
ScheduleKeyDeletionError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> UpdateAliasError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => UpdateAliasError::DependencyTimeout(String::from(error_message)),
"KMSInternalException" => UpdateAliasError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => UpdateAliasError::KMSInvalidState(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> UpdateKeyDescriptionError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "DependencyTimeoutException" => UpdateKeyDescriptionError::DependencyTimeout(String::from(error_message)),
"InvalidArnException" => UpdateKeyDescriptionError::InvalidArn(String::from(error_message)),
"KMSInternalException" => UpdateKeyDescriptionError::KMSInternal(String::from(error_message)),
"KMSInvalidStateException" => UpdateKeyDescriptionError::KMSInvalidState(String::from(error_message)),
"NotFoundException" => UpdateKeyDescriptionError::NotFound(String::from(error_message)),
"ValidationException" => UpdateKeyDescriptionError::Validation(error_message.to_string()),
...
UpdateKeyDescriptionError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
/// A client for the KMS API.
        pub struct KmsClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            credentials_provider: P,
            region: region::Region,
            dispatcher: D,
        }

        impl<P, D> KmsClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
        ...
        impl<P, D> Kms for KmsClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
