        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AlarmName" => {
                obj.alarm_name = Some(try!(AlarmNameDeserializer::deserialize("AlarmName", stack)));
            }
"HistoryData" => {
                obj.history_data = Some(try!(HistoryDataDeserializer::deserialize("HistoryData", stack)));
            }
"HistoryItemType" => {
                obj.history_item_type = Some(try!(HistoryItemTypeDeserializer::deserialize("HistoryItemType", stack)));
            }
"HistorySummary" => {
                obj.history_summary = Some(try!(HistorySummaryDeserializer::deserialize("HistorySummary", stack)));
            }
"Timestamp" => {
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Average" => {
                obj.average = Some(try!(DatapointValueDeserializer::deserialize("Average", stack)));
            }
"ExtendedStatistics" => {
                obj.extended_statistics = Some(try!(DatapointValueMapDeserializer::deserialize("ExtendedStatistics", stack)));
            }
"Maximum" => {
                obj.maximum = Some(try!(DatapointValueDeserializer::deserialize("Maximum", stack)));
            }
"Minimum" => {
                obj.minimum = Some(try!(DatapointValueDeserializer::deserialize("Minimum", stack)));
            }
"SampleCount" => {
                obj.sample_count = Some(try!(DatapointValueDeserializer::deserialize("SampleCount", stack)));
            }
"Sum" => {
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AlarmHistoryItems" => {
                obj.alarm_history_items = Some(try!(AlarmHistoryItemsDeserializer::deserialize("AlarmHistoryItems", stack)));
            }
"NextToken" => {
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "MetricAlarms" => {
                obj.metric_alarms = Some(try!(MetricAlarmsDeserializer::deserialize("MetricAlarms", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Datapoints" => {
                obj.datapoints = Some(try!(DatapointsDeserializer::deserialize("Datapoints", stack)));
            }
"Label" => {
                obj.label = Some(try!(MetricLabelDeserializer::deserialize("Label", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Metrics" => {
                obj.metrics = Some(try!(MetricsDeserializer::deserialize("Metrics", stack)));
            }
"NextToken" => {
                obj.next_token = Some(try!(NextTokenDeserializer::deserialize("NextToken", stack)));
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Dimensions" => {
                obj.dimensions = Some(try!(DimensionsDeserializer::deserialize("Dimensions", stack)));
            }
"MetricName" => {
                obj.metric_name = Some(try!(MetricNameDeserializer::deserialize("MetricName", stack)));
            }
"Namespace" => {
                obj.namespace = Some(try!(NamespaceDeserializer::deserialize("Namespace", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ActionsEnabled" => {
                obj.actions_enabled = Some(try!(ActionsEnabledDeserializer::deserialize("ActionsEnabled", stack)));
            }
"AlarmActions" => {
                obj.alarm_actions = Some(try!(ResourceListDeserializer::deserialize("AlarmActions", stack)));
            }
"AlarmArn" => {
                obj.alarm_arn = Some(try!(AlarmArnDeserializer::deserialize("AlarmArn", stack)));
            }
"AlarmConfigurationUpdatedTimestamp" => {
                obj.alarm_configuration_updated_timestamp = Some(try!(TimestampDeserializer::deserialize("AlarmConfigurationUpdatedTimestamp", stack)));
            }
"AlarmDescription" => {
                obj.alarm_description = Some(try!(AlarmDescriptionDeserializer::deserialize("AlarmDescription", stack)));
            }
"AlarmName" => {
                obj.alarm_name = Some(try!(AlarmNameDeserializer::deserialize("AlarmName", stack)));
            }
"ComparisonOperator" => {
                obj.comparison_operator = Some(try!(ComparisonOperatorDeserializer::deserialize("ComparisonOperator", stack)));
            }
"Dimensions" => {
                obj.dimensions = Some(try!(DimensionsDeserializer::deserialize("Dimensions", stack)));
            }
"EvaluationPeriods" => {
                obj.evaluation_periods = Some(try!(EvaluationPeriodsDeserializer::deserialize("EvaluationPeriods", stack)));
            }
"ExtendedStatistic" => {
                obj.extended_statistic = Some(try!(ExtendedStatisticDeserializer::deserialize("ExtendedStatistic", stack)));
            }
"InsufficientDataActions" => {
                obj.insufficient_data_actions = Some(try!(ResourceListDeserializer::deserialize("InsufficientDataActions", stack)));
            }
"MetricName" => {
                obj.metric_name = Some(try!(MetricNameDeserializer::deserialize("MetricName", stack)));
            }
...
"OKActions" => {
                obj.ok_actions = Some(try!(ResourceListDeserializer::deserialize("OKActions", stack)));
            }
"Period" => {
                obj.period = Some(try!(PeriodDeserializer::deserialize("Period", stack)));
            }
"StateReason" => {
                obj.state_reason = Some(try!(StateReasonDeserializer::deserialize("StateReason", stack)));
            }
"StateReasonData" => {
                obj.state_reason_data = Some(try!(StateReasonDataDeserializer::deserialize("StateReasonData", stack)));
            }
"StateUpdatedTimestamp" => {
                obj.state_updated_timestamp = Some(try!(TimestampDeserializer::deserialize("StateUpdatedTimestamp", stack)));
            }
"StateValue" => {
                obj.state_value = Some(try!(StateValueDeserializer::deserialize("StateValue", stack)));
            }
"Statistic" => {
                obj.statistic = Some(try!(StatisticDeserializer::deserialize("Statistic", stack)));
            }
"Threshold" => {
                obj.threshold = Some(try!(ThresholdDeserializer::deserialize("Threshold", stack)));
            }
"Unit" => {
                obj.unit = Some(try!(StandardUnitDeserializer::deserialize("Unit", stack)));
            }
...
pub unit: Option<StandardUnit>,
        ...
        if let Some(ref field_value) = obj.actions_enabled {
                params.put(&format!("{}{}", prefix, "ActionsEnabled"), &field_value.to_string());
            }
...
params.put(&format!("{}{}", prefix, "ComparisonOperator"), &obj.comparison_operator);
if let Some(ref field_value) = obj.dimensions {
                DimensionsSerializer::serialize(
                    params,
                    &format!("{}{}", prefix, "Dimensions"),
...
params.put(&format!("{}{}", prefix, "EvaluationPeriods"), &obj.evaluation_periods.to_string());
if let Some(ref field_value) = obj.extended_statistic {
                params.put(&format!("{}{}", prefix, "ExtendedStatistic"), &field_value);
            }
...
params.put(&format!("{}{}", prefix, "Threshold"), &obj.threshold.to_string());
if let Some(ref field_value) = obj.unit {
                params.put(&format!("{}{}", prefix, "Unit"), &field_value);
            }
...
pub sum: DatapointValue,
        ...
        params.put(&format!("{}{}", prefix, "Maximum"), &obj.maximum.to_string());
params.put(&format!("{}{}", prefix, "Minimum"), &obj.minimum.to_string());
params.put(&format!("{}{}", prefix, "SampleCount"), &obj.sample_count.to_string());
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceNotFound" => DeleteAlarmsError::ResourceNotFound(String::from(parsed_error.message)),_ => DeleteAlarmsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeAlarmHistoryError {
                    pub fn from_body(body: &str) -> DescribeAlarmHistoryError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidNextToken" => DescribeAlarmHistoryError::InvalidNextToken(String::from(parsed_error.message)),_ => DescribeAlarmHistoryError::Unknown(String::from(body))
                                }
                           },
...
DescribeAlarmHistoryError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                ...
                impl DescribeAlarmsError {
                    pub fn from_body(body: &str) -> DescribeAlarmsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidNextToken" => DescribeAlarmsError::InvalidNextToken(String::from(parsed_error.message)),_ => DescribeAlarmsError::Unknown(String::from(body))
                                }
                           },
...
DescribeAlarmsForMetricError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
DisableAlarmActionsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
EnableAlarmActionsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
GetMetricStatisticsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                ...
                impl ListMetricsError {
                    pub fn from_body(body: &str) -> ListMetricsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InternalServiceFault" => ListMetricsError::InternalServiceFault(String::from(parsed_error.message)),"InvalidParameterValueException" => ListMetricsError::InvalidParameterValue(String::from(parsed_error.message)),_ => ListMetricsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl PutMetricAlarmError {
                    pub fn from_body(body: &str) -> PutMetricAlarmError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "LimitExceededFault" => PutMetricAlarmError::LimitExceededFault(String::from(parsed_error.message)),_ => PutMetricAlarmError::Unknown(String::from(body))
                                }
                           },
...
/// A client for the CloudWatch API.
        pub struct CloudWatchClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            credentials_provider: P,
            region: region::Region,
            dispatcher: D,
        }

        impl<P, D> CloudWatchClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
        ...
        impl<P, D> CloudWatch for CloudWatchClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
        ...
        fn test_parse_error_cloudwatch_describe_alarm_history() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/error", "cloudwatch-describe-alarm-history.xml");
        ...
        fn test_parse_valid_cloudwatch_describe_alarms() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/valid", "cloudwatch-describe-alarms.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = CloudWatchClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
