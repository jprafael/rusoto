...
pub type Date = f64;
#[doc="<p>Represents the input of a <i>DescribeStream</i> operation.</p>"]
...
#[doc="<p>Represents the output of a <i>DescribeStream</i> operation.</p>"]
#[derive(Default,Debug,Clone,Deserialize)]
...
#[doc="<p>Represents the input of a <i>GetRecords</i> operation.</p>"]
#[derive(Default,Debug,Clone,Serialize)]
...
#[doc="<p>Represents the output of a <i>GetRecords</i> operation.</p>"]
#[derive(Default,Debug,Clone,Deserialize)]
...
#[doc="<p>Represents the input of a <i>GetShardIterator</i> operation.</p>"]
#[derive(Default,Debug,Clone,Serialize)]
...
#[doc="<p>Represents the output of a <i>GetShardIterator</i> operation.</p>"]
#[derive(Default,Debug,Clone,Deserialize)]
...
#[doc="<p>Represents the input of a <i>ListStreams</i> operation.</p>"]
#[derive(Default,Debug,Clone,Serialize)]
...
#[doc="<p>Represents the output of a <i>ListStreams</i> operation.</p>"]
#[derive(Default,Debug,Clone,Deserialize)]
...
#[derive(Default,Debug,Clone,Deserialize)]
            pub struct Record {
                #[doc="<p>The region in which the <i>GetRecords</i> request was received.</p>"]
...
#[doc="<p>The AWS service from which the stream record originated. For DynamoDB Streams, this is <i>aws:dynamodb</i>.</p>"]
...
/// A client for the Amazon DynamoDB Streams API.
        pub struct DynamoDbStreamsClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            credentials_provider: P,
            region: region::Region,
            dispatcher: D,
        }

        impl<P, D> DynamoDbStreamsClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
        ...
        impl<P, D> DynamoDbStreams for DynamoDbStreamsClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
