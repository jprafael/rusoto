                    ...
                    pub fn from_body(body: &str) -> AddAttributesToFindingsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => AddAttributesToFindingsError::AccessDenied(String::from(error_message)),
"InternalException" => AddAttributesToFindingsError::Internal(String::from(error_message)),
"InvalidInputException" => AddAttributesToFindingsError::InvalidInput(String::from(error_message)),
"NoSuchEntityException" => AddAttributesToFindingsError::NoSuchEntity(String::from(error_message)),
"ValidationException" => AddAttributesToFindingsError::Validation(error_message.to_string()),
...
AddAttributesToFindingsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> CreateAssessmentTargetError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => CreateAssessmentTargetError::AccessDenied(String::from(error_message)),
"InternalException" => CreateAssessmentTargetError::Internal(String::from(error_message)),
"InvalidInputException" => CreateAssessmentTargetError::InvalidInput(String::from(error_message)),
"LimitExceededException" => CreateAssessmentTargetError::LimitExceeded(String::from(error_message)),
"NoSuchEntityException" => CreateAssessmentTargetError::NoSuchEntity(String::from(error_message)),
"ValidationException" => CreateAssessmentTargetError::Validation(error_message.to_string()),
...
CreateAssessmentTargetError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> CreateAssessmentTemplateError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => CreateAssessmentTemplateError::AccessDenied(String::from(error_message)),
"InternalException" => CreateAssessmentTemplateError::Internal(String::from(error_message)),
"InvalidInputException" => CreateAssessmentTemplateError::InvalidInput(String::from(error_message)),
"LimitExceededException" => CreateAssessmentTemplateError::LimitExceeded(String::from(error_message)),
"NoSuchEntityException" => CreateAssessmentTemplateError::NoSuchEntity(String::from(error_message)),
"ValidationException" => CreateAssessmentTemplateError::Validation(error_message.to_string()),
...
CreateAssessmentTemplateError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> CreateResourceGroupError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => CreateResourceGroupError::AccessDenied(String::from(error_message)),
"InternalException" => CreateResourceGroupError::Internal(String::from(error_message)),
"InvalidInputException" => CreateResourceGroupError::InvalidInput(String::from(error_message)),
"LimitExceededException" => CreateResourceGroupError::LimitExceeded(String::from(error_message)),
"ValidationException" => CreateResourceGroupError::Validation(error_message.to_string()),
...
CreateResourceGroupError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> DeleteAssessmentRunError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => DeleteAssessmentRunError::AccessDenied(String::from(error_message)),
"AssessmentRunInProgressException" => DeleteAssessmentRunError::AssessmentRunInProgress(String::from(error_message)),
"InternalException" => DeleteAssessmentRunError::Internal(String::from(error_message)),
"InvalidInputException" => DeleteAssessmentRunError::InvalidInput(String::from(error_message)),
"NoSuchEntityException" => DeleteAssessmentRunError::NoSuchEntity(String::from(error_message)),
"ValidationException" => DeleteAssessmentRunError::Validation(error_message.to_string()),
...
DeleteAssessmentRunError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> DeleteAssessmentTargetError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => DeleteAssessmentTargetError::AccessDenied(String::from(error_message)),
"AssessmentRunInProgressException" => DeleteAssessmentTargetError::AssessmentRunInProgress(String::from(error_message)),
"InternalException" => DeleteAssessmentTargetError::Internal(String::from(error_message)),
"InvalidInputException" => DeleteAssessmentTargetError::InvalidInput(String::from(error_message)),
"NoSuchEntityException" => DeleteAssessmentTargetError::NoSuchEntity(String::from(error_message)),
"ValidationException" => DeleteAssessmentTargetError::Validation(error_message.to_string()),
...
DeleteAssessmentTargetError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> DeleteAssessmentTemplateError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => DeleteAssessmentTemplateError::AccessDenied(String::from(error_message)),
"AssessmentRunInProgressException" => DeleteAssessmentTemplateError::AssessmentRunInProgress(String::from(error_message)),
"InternalException" => DeleteAssessmentTemplateError::Internal(String::from(error_message)),
"InvalidInputException" => DeleteAssessmentTemplateError::InvalidInput(String::from(error_message)),
"NoSuchEntityException" => DeleteAssessmentTemplateError::NoSuchEntity(String::from(error_message)),
"ValidationException" => DeleteAssessmentTemplateError::Validation(error_message.to_string()),
...
DeleteAssessmentTemplateError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> DescribeAssessmentRunsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalException" => DescribeAssessmentRunsError::Internal(String::from(error_message)),
"InvalidInputException" => DescribeAssessmentRunsError::InvalidInput(String::from(error_message)),
"ValidationException" => DescribeAssessmentRunsError::Validation(error_message.to_string()),
...
DescribeAssessmentRunsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> DescribeAssessmentTargetsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalException" => DescribeAssessmentTargetsError::Internal(String::from(error_message)),
"InvalidInputException" => DescribeAssessmentTargetsError::InvalidInput(String::from(error_message)),
"ValidationException" => DescribeAssessmentTargetsError::Validation(error_message.to_string()),
...
DescribeAssessmentTargetsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> DescribeAssessmentTemplatesError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalException" => DescribeAssessmentTemplatesError::Internal(String::from(error_message)),
"InvalidInputException" => DescribeAssessmentTemplatesError::InvalidInput(String::from(error_message)),
"ValidationException" => DescribeAssessmentTemplatesError::Validation(error_message.to_string()),
...
DescribeAssessmentTemplatesError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> DescribeCrossAccountAccessRoleError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalException" => DescribeCrossAccountAccessRoleError::Internal(String::from(error_message)),
"ValidationException" => DescribeCrossAccountAccessRoleError::Validation(error_message.to_string()),
...
DescribeCrossAccountAccessRoleError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> DescribeFindingsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalException" => DescribeFindingsError::Internal(String::from(error_message)),
"InvalidInputException" => DescribeFindingsError::InvalidInput(String::from(error_message)),
"ValidationException" => DescribeFindingsError::Validation(error_message.to_string()),
                    ...
                    pub fn from_body(body: &str) -> DescribeResourceGroupsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalException" => DescribeResourceGroupsError::Internal(String::from(error_message)),
"InvalidInputException" => DescribeResourceGroupsError::InvalidInput(String::from(error_message)),
"ValidationException" => DescribeResourceGroupsError::Validation(error_message.to_string()),
...
DescribeResourceGroupsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> DescribeRulesPackagesError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalException" => DescribeRulesPackagesError::Internal(String::from(error_message)),
"InvalidInputException" => DescribeRulesPackagesError::InvalidInput(String::from(error_message)),
"ValidationException" => DescribeRulesPackagesError::Validation(error_message.to_string()),
...
DescribeRulesPackagesError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> GetTelemetryMetadataError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => GetTelemetryMetadataError::AccessDenied(String::from(error_message)),
"InternalException" => GetTelemetryMetadataError::Internal(String::from(error_message)),
"InvalidInputException" => GetTelemetryMetadataError::InvalidInput(String::from(error_message)),
"NoSuchEntityException" => GetTelemetryMetadataError::NoSuchEntity(String::from(error_message)),
"ValidationException" => GetTelemetryMetadataError::Validation(error_message.to_string()),
...
GetTelemetryMetadataError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> ListAssessmentRunAgentsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => ListAssessmentRunAgentsError::AccessDenied(String::from(error_message)),
"InternalException" => ListAssessmentRunAgentsError::Internal(String::from(error_message)),
"InvalidInputException" => ListAssessmentRunAgentsError::InvalidInput(String::from(error_message)),
"NoSuchEntityException" => ListAssessmentRunAgentsError::NoSuchEntity(String::from(error_message)),
"ValidationException" => ListAssessmentRunAgentsError::Validation(error_message.to_string()),
...
ListAssessmentRunAgentsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> ListAssessmentRunsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => ListAssessmentRunsError::AccessDenied(String::from(error_message)),
"InternalException" => ListAssessmentRunsError::Internal(String::from(error_message)),
"InvalidInputException" => ListAssessmentRunsError::InvalidInput(String::from(error_message)),
"NoSuchEntityException" => ListAssessmentRunsError::NoSuchEntity(String::from(error_message)),
"ValidationException" => ListAssessmentRunsError::Validation(error_message.to_string()),
...
ListAssessmentRunsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> ListAssessmentTargetsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => ListAssessmentTargetsError::AccessDenied(String::from(error_message)),
"InternalException" => ListAssessmentTargetsError::Internal(String::from(error_message)),
"InvalidInputException" => ListAssessmentTargetsError::InvalidInput(String::from(error_message)),
"ValidationException" => ListAssessmentTargetsError::Validation(error_message.to_string()),
...
ListAssessmentTargetsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> ListAssessmentTemplatesError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => ListAssessmentTemplatesError::AccessDenied(String::from(error_message)),
"InternalException" => ListAssessmentTemplatesError::Internal(String::from(error_message)),
"InvalidInputException" => ListAssessmentTemplatesError::InvalidInput(String::from(error_message)),
"NoSuchEntityException" => ListAssessmentTemplatesError::NoSuchEntity(String::from(error_message)),
"ValidationException" => ListAssessmentTemplatesError::Validation(error_message.to_string()),
...
ListAssessmentTemplatesError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> ListEventSubscriptionsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => ListEventSubscriptionsError::AccessDenied(String::from(error_message)),
"InternalException" => ListEventSubscriptionsError::Internal(String::from(error_message)),
"InvalidInputException" => ListEventSubscriptionsError::InvalidInput(String::from(error_message)),
"NoSuchEntityException" => ListEventSubscriptionsError::NoSuchEntity(String::from(error_message)),
"ValidationException" => ListEventSubscriptionsError::Validation(error_message.to_string()),
...
ListEventSubscriptionsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> ListFindingsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => ListFindingsError::AccessDenied(String::from(error_message)),
"InternalException" => ListFindingsError::Internal(String::from(error_message)),
"InvalidInputException" => ListFindingsError::InvalidInput(String::from(error_message)),
"NoSuchEntityException" => ListFindingsError::NoSuchEntity(String::from(error_message)),
"ValidationException" => ListFindingsError::Validation(error_message.to_string()),
                    ...
                    pub fn from_body(body: &str) -> ListRulesPackagesError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => ListRulesPackagesError::AccessDenied(String::from(error_message)),
"InternalException" => ListRulesPackagesError::Internal(String::from(error_message)),
"InvalidInputException" => ListRulesPackagesError::InvalidInput(String::from(error_message)),
"ValidationException" => ListRulesPackagesError::Validation(error_message.to_string()),
...
ListRulesPackagesError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> ListTagsForResourceError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => ListTagsForResourceError::AccessDenied(String::from(error_message)),
"InternalException" => ListTagsForResourceError::Internal(String::from(error_message)),
"InvalidInputException" => ListTagsForResourceError::InvalidInput(String::from(error_message)),
"NoSuchEntityException" => ListTagsForResourceError::NoSuchEntity(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> PreviewAgentsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => PreviewAgentsError::AccessDenied(String::from(error_message)),
"InternalException" => PreviewAgentsError::Internal(String::from(error_message)),
"InvalidCrossAccountRoleException" => PreviewAgentsError::InvalidCrossAccountRole(String::from(error_message)),
"InvalidInputException" => PreviewAgentsError::InvalidInput(String::from(error_message)),
"NoSuchEntityException" => PreviewAgentsError::NoSuchEntity(String::from(error_message)),
"ValidationException" => PreviewAgentsError::Validation(error_message.to_string()),
...
"InternalException" => RegisterCrossAccountAccessRoleError::Internal(String::from(error_message)),
...
"ValidationException" => RegisterCrossAccountAccessRoleError::Validation(error_message.to_string()),
...
RegisterCrossAccountAccessRoleError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> RemoveAttributesFromFindingsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => RemoveAttributesFromFindingsError::AccessDenied(String::from(error_message)),
"InternalException" => RemoveAttributesFromFindingsError::Internal(String::from(error_message)),
"InvalidInputException" => RemoveAttributesFromFindingsError::InvalidInput(String::from(error_message)),
"NoSuchEntityException" => RemoveAttributesFromFindingsError::NoSuchEntity(String::from(error_message)),
"ValidationException" => RemoveAttributesFromFindingsError::Validation(error_message.to_string()),
...
RemoveAttributesFromFindingsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> SetTagsForResourceError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => SetTagsForResourceError::AccessDenied(String::from(error_message)),
"InternalException" => SetTagsForResourceError::Internal(String::from(error_message)),
"InvalidInputException" => SetTagsForResourceError::InvalidInput(String::from(error_message)),
"NoSuchEntityException" => SetTagsForResourceError::NoSuchEntity(String::from(error_message)),
"ValidationException" => SetTagsForResourceError::Validation(error_message.to_string()),
...
SetTagsForResourceError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> StartAssessmentRunError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => StartAssessmentRunError::AccessDenied(String::from(error_message)),
"AgentsAlreadyRunningAssessmentException" => StartAssessmentRunError::AgentsAlreadyRunningAssessment(String::from(error_message)),
"InternalException" => StartAssessmentRunError::Internal(String::from(error_message)),
"InvalidCrossAccountRoleException" => StartAssessmentRunError::InvalidCrossAccountRole(String::from(error_message)),
"InvalidInputException" => StartAssessmentRunError::InvalidInput(String::from(error_message)),
"LimitExceededException" => StartAssessmentRunError::LimitExceeded(String::from(error_message)),
"NoSuchEntityException" => StartAssessmentRunError::NoSuchEntity(String::from(error_message)),
"ValidationException" => StartAssessmentRunError::Validation(error_message.to_string()),
...
StartAssessmentRunError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> StopAssessmentRunError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => StopAssessmentRunError::AccessDenied(String::from(error_message)),
"InternalException" => StopAssessmentRunError::Internal(String::from(error_message)),
"InvalidInputException" => StopAssessmentRunError::InvalidInput(String::from(error_message)),
"NoSuchEntityException" => StopAssessmentRunError::NoSuchEntity(String::from(error_message)),
"ValidationException" => StopAssessmentRunError::Validation(error_message.to_string()),
...
StopAssessmentRunError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> SubscribeToEventError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => SubscribeToEventError::AccessDenied(String::from(error_message)),
"InternalException" => SubscribeToEventError::Internal(String::from(error_message)),
"InvalidInputException" => SubscribeToEventError::InvalidInput(String::from(error_message)),
"LimitExceededException" => SubscribeToEventError::LimitExceeded(String::from(error_message)),
"NoSuchEntityException" => SubscribeToEventError::NoSuchEntity(String::from(error_message)),
"ValidationException" => SubscribeToEventError::Validation(error_message.to_string()),
                    ...
                    pub fn from_body(body: &str) -> UnsubscribeFromEventError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => UnsubscribeFromEventError::AccessDenied(String::from(error_message)),
"InternalException" => UnsubscribeFromEventError::Internal(String::from(error_message)),
"InvalidInputException" => UnsubscribeFromEventError::InvalidInput(String::from(error_message)),
"NoSuchEntityException" => UnsubscribeFromEventError::NoSuchEntity(String::from(error_message)),
"ValidationException" => UnsubscribeFromEventError::Validation(error_message.to_string()),
...
UnsubscribeFromEventError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> UpdateAssessmentTargetError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "AccessDeniedException" => UpdateAssessmentTargetError::AccessDenied(String::from(error_message)),
"InternalException" => UpdateAssessmentTargetError::Internal(String::from(error_message)),
"InvalidInputException" => UpdateAssessmentTargetError::InvalidInput(String::from(error_message)),
"NoSuchEntityException" => UpdateAssessmentTargetError::NoSuchEntity(String::from(error_message)),
"ValidationException" => UpdateAssessmentTargetError::Validation(error_message.to_string()),
...
UpdateAssessmentTargetError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
/// Trait representing the capabilities of the Amazon Inspector API. Amazon Inspector clients implement this trait.
        pub trait Inspector {
                ...
                fn add_attributes_to_findings(&self, input: &AddAttributesToFindingsRequest)  -> Box<Future<Item = AddAttributesToFindingsResponse, Error = AddAttributesToFindingsError>>;
                ...
                fn create_assessment_target(&self, input: &CreateAssessmentTargetRequest)  -> Box<Future<Item = CreateAssessmentTargetResponse, Error = CreateAssessmentTargetError>>;
                

                #[doc="<p>Creates an assessment template for the assessment target that is specified by the ARN of the assessment target.</p>"]
                fn create_assessment_template(&self, input: &CreateAssessmentTemplateRequest)  -> Box<Future<Item = CreateAssessmentTemplateResponse, Error = CreateAssessmentTemplateError>>;
                ...
                fn create_resource_group(&self, input: &CreateResourceGroupRequest)  -> Box<Future<Item = CreateResourceGroupResponse, Error = CreateResourceGroupError>>;
                

                #[doc="<p>Deletes the assessment run that is specified by the ARN of the assessment run.</p>"]
                fn delete_assessment_run(&self, input: &DeleteAssessmentRunRequest)  -> Box<Future<Item = (), Error = DeleteAssessmentRunError>>;
                

                #[doc="<p>Deletes the assessment target that is specified by the ARN of the assessment target.</p>"]
                fn delete_assessment_target(&self, input: &DeleteAssessmentTargetRequest)  -> Box<Future<Item = (), Error = DeleteAssessmentTargetError>>;
                

                #[doc="<p>Deletes the assessment template that is specified by the ARN of the assessment template.</p>"]
                fn delete_assessment_template(&self, input: &DeleteAssessmentTemplateRequest)  -> Box<Future<Item = (), Error = DeleteAssessmentTemplateError>>;
                

                #[doc="<p>Describes the assessment runs that are specified by the ARNs of the assessment runs.</p>"]
                fn describe_assessment_runs(&self, input: &DescribeAssessmentRunsRequest)  -> Box<Future<Item = DescribeAssessmentRunsResponse, Error = DescribeAssessmentRunsError>>;
                

                #[doc="<p>Describes the assessment targets that are specified by the ARNs of the assessment targets.</p>"]
                fn describe_assessment_targets(&self, input: &DescribeAssessmentTargetsRequest)  -> Box<Future<Item = DescribeAssessmentTargetsResponse, Error = DescribeAssessmentTargetsError>>;
                

                #[doc="<p>Describes the assessment templates that are specified by the ARNs of the assessment templates.</p>"]
                fn describe_assessment_templates(&self, input: &DescribeAssessmentTemplatesRequest)  -> Box<Future<Item = DescribeAssessmentTemplatesResponse, Error = DescribeAssessmentTemplatesError>>;
                

                #[doc="<p>Describes the IAM role that enables Amazon Inspector to access your AWS account.</p>"]
                fn describe_cross_account_access_role(&self)  -> Box<Future<Item = DescribeCrossAccountAccessRoleResponse, Error = DescribeCrossAccountAccessRoleError>>;
                

                #[doc="<p>Describes the findings that are specified by the ARNs of the findings.</p>"]
                fn describe_findings(&self, input: &DescribeFindingsRequest)  -> Box<Future<Item = DescribeFindingsResponse, Error = DescribeFindingsError>>;
                

                #[doc="<p>Describes the resource groups that are specified by the ARNs of the resource groups.</p>"]
                fn describe_resource_groups(&self, input: &DescribeResourceGroupsRequest)  -> Box<Future<Item = DescribeResourceGroupsResponse, Error = DescribeResourceGroupsError>>;
                

                #[doc="<p>Describes the rules packages that are specified by the ARNs of the rules packages.</p>"]
                fn describe_rules_packages(&self, input: &DescribeRulesPackagesRequest)  -> Box<Future<Item = DescribeRulesPackagesResponse, Error = DescribeRulesPackagesError>>;
                

                #[doc="<p>Information about the data that is collected for the specified assessment run.</p>"]
                fn get_telemetry_metadata(&self, input: &GetTelemetryMetadataRequest)  -> Box<Future<Item = GetTelemetryMetadataResponse, Error = GetTelemetryMetadataError>>;
                

                #[doc="<p>Lists the agents of the assessment runs that are specified by the ARNs of the assessment runs.</p>"]
                fn list_assessment_run_agents(&self, input: &ListAssessmentRunAgentsRequest)  -> Box<Future<Item = ListAssessmentRunAgentsResponse, Error = ListAssessmentRunAgentsError>>;
                ...
                fn list_assessment_runs(&self, input: &ListAssessmentRunsRequest)  -> Box<Future<Item = ListAssessmentRunsResponse, Error = ListAssessmentRunsError>>;
                ...
                fn list_assessment_targets(&self, input: &ListAssessmentTargetsRequest)  -> Box<Future<Item = ListAssessmentTargetsResponse, Error = ListAssessmentTargetsError>>;
                ...
                fn list_assessment_templates(&self, input: &ListAssessmentTemplatesRequest)  -> Box<Future<Item = ListAssessmentTemplatesResponse, Error = ListAssessmentTemplatesError>>;
                ...
                fn list_event_subscriptions(&self, input: &ListEventSubscriptionsRequest)  -> Box<Future<Item = ListEventSubscriptionsResponse, Error = ListEventSubscriptionsError>>;
                

                #[doc="<p>Lists findings that are generated by the assessment runs that are specified by the ARNs of the assessment runs.</p>"]
                fn list_findings(&self, input: &ListFindingsRequest)  -> Box<Future<Item = ListFindingsResponse, Error = ListFindingsError>>;
                

                #[doc="<p>Lists all available Amazon Inspector rules packages.</p>"]
                fn list_rules_packages(&self, input: &ListRulesPackagesRequest)  -> Box<Future<Item = ListRulesPackagesResponse, Error = ListRulesPackagesError>>;
                ...
                fn preview_agents(&self, input: &PreviewAgentsRequest)  -> Box<Future<Item = PreviewAgentsResponse, Error = PreviewAgentsError>>;
                ...
                fn register_cross_account_access_role(&self, input: &RegisterCrossAccountAccessRoleRequest)  -> Box<Future<Item = (), Error = RegisterCrossAccountAccessRoleError>>;
                ...
                fn remove_attributes_from_findings(&self, input: &RemoveAttributesFromFindingsRequest)  -> Box<Future<Item = RemoveAttributesFromFindingsResponse, Error = RemoveAttributesFromFindingsError>>;
                

                #[doc="<p>Sets tags (key and value pairs) to the assessment template that is specified by the ARN of the assessment template.</p>"]
                fn set_tags_for_resource(&self, input: &SetTagsForResourceRequest)  -> Box<Future<Item = (), Error = SetTagsForResourceError>>;
                ...
                fn start_assessment_run(&self, input: &StartAssessmentRunRequest)  -> Box<Future<Item = StartAssessmentRunResponse, Error = StartAssessmentRunError>>;
                

                #[doc="<p>Stops the assessment run that is specified by the ARN of the assessment run.</p>"]
                fn stop_assessment_run(&self, input: &StopAssessmentRunRequest)  -> Box<Future<Item = (), Error = StopAssessmentRunError>>;
                ...
                fn subscribe_to_event(&self, input: &SubscribeToEventRequest)  -> Box<Future<Item = (), Error = SubscribeToEventError>>;
                ...
                fn unsubscribe_from_event(&self, input: &UnsubscribeFromEventRequest)  -> Box<Future<Item = (), Error = UnsubscribeFromEventError>>;
                

                #[doc="<p>Updates the assessment target that is specified by the ARN of the assessment target.</p>"]
                fn update_assessment_target(&self, input: &UpdateAssessmentTargetRequest)  -> Box<Future<Item = (), Error = UpdateAssessmentTargetError>>;
                
}
/// A client for the Amazon Inspector API.
        pub struct InspectorClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            credentials_provider: P,
            region: region::Region,
            dispatcher: D,
        }

        impl<P, D> InspectorClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
        ...
        impl<P, D> Inspector for InspectorClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(AddAttributesToFindingsError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| AddAttributesToFindingsError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<AddAttributesToFindingsResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(AddAttributesToFindingsError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(CreateAssessmentTargetError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| CreateAssessmentTargetError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<CreateAssessmentTargetResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(CreateAssessmentTargetError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(CreateAssessmentTemplateError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| CreateAssessmentTemplateError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<CreateAssessmentTemplateResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(CreateAssessmentTemplateError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(CreateResourceGroupError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| CreateResourceGroupError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<CreateResourceGroupResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(CreateResourceGroupError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DeleteAssessmentRunError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DeleteAssessmentRunError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(())
                                }
                                _ => future::err(DeleteAssessmentRunError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DeleteAssessmentTargetError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DeleteAssessmentTargetError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(())
                                }
                                _ => future::err(DeleteAssessmentTargetError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DeleteAssessmentTemplateError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DeleteAssessmentTemplateError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(())
                                }
                                _ => future::err(DeleteAssessmentTemplateError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DescribeAssessmentRunsError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DescribeAssessmentRunsError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<DescribeAssessmentRunsResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(DescribeAssessmentRunsError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DescribeAssessmentTargetsError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DescribeAssessmentTargetsError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<DescribeAssessmentTargetsResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(DescribeAssessmentTargetsError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
                ...
                fn describe_assessment_templates(&self, input: &DescribeAssessmentTemplatesRequest)  -> Box<Future<Item = DescribeAssessmentTemplatesResponse, Error = DescribeAssessmentTemplatesError>> {
                    ...
                    request.set_content_type("application/x-amz-json-1.1".to_owned());
                    request.add_header("x-amz-target", "InspectorService.DescribeAssessmentTemplates");
                    let encoded = serde_json::to_string(input).unwrap();
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DescribeAssessmentTemplatesError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DescribeAssessmentTemplatesError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<DescribeAssessmentTemplatesResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(DescribeAssessmentTemplatesError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
                ...
                fn describe_cross_account_access_role(&self)  -> Box<Future<Item = DescribeCrossAccountAccessRoleResponse, Error = DescribeCrossAccountAccessRoleError>> {
                    ...
                    request.set_content_type("application/x-amz-json-1.1".to_owned());
                    request.add_header("x-amz-target", "InspectorService.DescribeCrossAccountAccessRole");
                    

                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DescribeCrossAccountAccessRoleError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DescribeCrossAccountAccessRoleError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<DescribeCrossAccountAccessRoleResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(DescribeCrossAccountAccessRoleError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DescribeFindingsError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DescribeFindingsError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<DescribeFindingsResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(DescribeFindingsError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DescribeResourceGroupsError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DescribeResourceGroupsError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<DescribeResourceGroupsResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(DescribeResourceGroupsError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DescribeRulesPackagesError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DescribeRulesPackagesError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<DescribeRulesPackagesResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(DescribeRulesPackagesError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(GetTelemetryMetadataError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| GetTelemetryMetadataError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<GetTelemetryMetadataResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(GetTelemetryMetadataError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(ListAssessmentRunAgentsError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| ListAssessmentRunAgentsError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<ListAssessmentRunAgentsResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(ListAssessmentRunAgentsError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(ListAssessmentRunsError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| ListAssessmentRunsError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<ListAssessmentRunsResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(ListAssessmentRunsError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(ListAssessmentTargetsError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| ListAssessmentTargetsError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<ListAssessmentTargetsResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(ListAssessmentTargetsError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(ListAssessmentTemplatesError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| ListAssessmentTemplatesError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<ListAssessmentTemplatesResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(ListAssessmentTemplatesError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(ListEventSubscriptionsError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| ListEventSubscriptionsError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<ListEventSubscriptionsResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(ListEventSubscriptionsError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(ListFindingsError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| ListFindingsError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<ListFindingsResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(ListFindingsError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(ListRulesPackagesError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| ListRulesPackagesError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<ListRulesPackagesResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(ListRulesPackagesError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(PreviewAgentsError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| PreviewAgentsError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<PreviewAgentsResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(PreviewAgentsError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
                ...
                fn register_cross_account_access_role(&self, input: &RegisterCrossAccountAccessRoleRequest)  -> Box<Future<Item = (), Error = RegisterCrossAccountAccessRoleError>> {
                    ...
                    request.set_content_type("application/x-amz-json-1.1".to_owned());
                    request.add_header("x-amz-target", "InspectorService.RegisterCrossAccountAccessRole");
                    let encoded = serde_json::to_string(input).unwrap();
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(RegisterCrossAccountAccessRoleError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| RegisterCrossAccountAccessRoleError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(())
                                }
                                _ => future::err(RegisterCrossAccountAccessRoleError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
                ...
                fn remove_attributes_from_findings(&self, input: &RemoveAttributesFromFindingsRequest)  -> Box<Future<Item = RemoveAttributesFromFindingsResponse, Error = RemoveAttributesFromFindingsError>> {
                    ...
                    request.set_content_type("application/x-amz-json-1.1".to_owned());
                    request.add_header("x-amz-target", "InspectorService.RemoveAttributesFromFindings");
                    let encoded = serde_json::to_string(input).unwrap();
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(RemoveAttributesFromFindingsError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| RemoveAttributesFromFindingsError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<RemoveAttributesFromFindingsResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(RemoveAttributesFromFindingsError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(SetTagsForResourceError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| SetTagsForResourceError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(())
                                }
                                _ => future::err(SetTagsForResourceError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(StartAssessmentRunError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| StartAssessmentRunError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<StartAssessmentRunResponse>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(StartAssessmentRunError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(StopAssessmentRunError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| StopAssessmentRunError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(())
                                }
                                _ => future::err(StopAssessmentRunError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(SubscribeToEventError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| SubscribeToEventError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(())
                                }
                                _ => future::err(SubscribeToEventError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(UnsubscribeFromEventError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| UnsubscribeFromEventError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(())
                                }
                                _ => future::err(UnsubscribeFromEventError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(UpdateAssessmentTargetError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| UpdateAssessmentTargetError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(())
                                }
                                _ => future::err(UpdateAssessmentTargetError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
