                    ...
                    pub fn from_body(body: &str) -> ActivatePipelineError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServiceError" => ActivatePipelineError::InternalServiceError(String::from(error_message)),
"InvalidRequestException" => ActivatePipelineError::InvalidRequest(String::from(error_message)),
"PipelineDeletedException" => ActivatePipelineError::PipelineDeleted(String::from(error_message)),
"PipelineNotFoundException" => ActivatePipelineError::PipelineNotFound(String::from(error_message)),
"ValidationException" => ActivatePipelineError::Validation(error_message.to_string()),
                    ...
                    pub fn from_body(body: &str) -> AddTagsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServiceError" => AddTagsError::InternalServiceError(String::from(error_message)),
"InvalidRequestException" => AddTagsError::InvalidRequest(String::from(error_message)),
"PipelineDeletedException" => AddTagsError::PipelineDeleted(String::from(error_message)),
"PipelineNotFoundException" => AddTagsError::PipelineNotFound(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> CreatePipelineError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServiceError" => CreatePipelineError::InternalServiceError(String::from(error_message)),
"InvalidRequestException" => CreatePipelineError::InvalidRequest(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> DeactivatePipelineError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServiceError" => DeactivatePipelineError::InternalServiceError(String::from(error_message)),
"InvalidRequestException" => DeactivatePipelineError::InvalidRequest(String::from(error_message)),
"PipelineDeletedException" => DeactivatePipelineError::PipelineDeleted(String::from(error_message)),
"PipelineNotFoundException" => DeactivatePipelineError::PipelineNotFound(String::from(error_message)),
"ValidationException" => DeactivatePipelineError::Validation(error_message.to_string()),
...
DeactivatePipelineError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> DeletePipelineError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServiceError" => DeletePipelineError::InternalServiceError(String::from(error_message)),
"InvalidRequestException" => DeletePipelineError::InvalidRequest(String::from(error_message)),
"PipelineNotFoundException" => DeletePipelineError::PipelineNotFound(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> DescribeObjectsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServiceError" => DescribeObjectsError::InternalServiceError(String::from(error_message)),
"InvalidRequestException" => DescribeObjectsError::InvalidRequest(String::from(error_message)),
"PipelineDeletedException" => DescribeObjectsError::PipelineDeleted(String::from(error_message)),
"PipelineNotFoundException" => DescribeObjectsError::PipelineNotFound(String::from(error_message)),
"ValidationException" => DescribeObjectsError::Validation(error_message.to_string()),
                    ...
                    pub fn from_body(body: &str) -> DescribePipelinesError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServiceError" => DescribePipelinesError::InternalServiceError(String::from(error_message)),
"InvalidRequestException" => DescribePipelinesError::InvalidRequest(String::from(error_message)),
"PipelineDeletedException" => DescribePipelinesError::PipelineDeleted(String::from(error_message)),
"PipelineNotFoundException" => DescribePipelinesError::PipelineNotFound(String::from(error_message)),
"ValidationException" => DescribePipelinesError::Validation(error_message.to_string()),
...
DescribePipelinesError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> EvaluateExpressionError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServiceError" => EvaluateExpressionError::InternalServiceError(String::from(error_message)),
"InvalidRequestException" => EvaluateExpressionError::InvalidRequest(String::from(error_message)),
"PipelineDeletedException" => EvaluateExpressionError::PipelineDeleted(String::from(error_message)),
"PipelineNotFoundException" => EvaluateExpressionError::PipelineNotFound(String::from(error_message)),
"TaskNotFoundException" => EvaluateExpressionError::TaskNotFound(String::from(error_message)),
"ValidationException" => EvaluateExpressionError::Validation(error_message.to_string()),
...
EvaluateExpressionError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
"InvalidRequestException" => GetPipelineDefinitionError::InvalidRequest(String::from(error_message)),
"PipelineDeletedException" => GetPipelineDefinitionError::PipelineDeleted(String::from(error_message)),
"PipelineNotFoundException" => GetPipelineDefinitionError::PipelineNotFound(String::from(error_message)),
"ValidationException" => GetPipelineDefinitionError::Validation(error_message.to_string()),
...
GetPipelineDefinitionError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> ListPipelinesError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServiceError" => ListPipelinesError::InternalServiceError(String::from(error_message)),
"InvalidRequestException" => ListPipelinesError::InvalidRequest(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> PollForTaskError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServiceError" => PollForTaskError::InternalServiceError(String::from(error_message)),
"InvalidRequestException" => PollForTaskError::InvalidRequest(String::from(error_message)),
"TaskNotFoundException" => PollForTaskError::TaskNotFound(String::from(error_message)),
"ValidationException" => PollForTaskError::Validation(error_message.to_string()),
...
"InvalidRequestException" => PutPipelineDefinitionError::InvalidRequest(String::from(error_message)),
"PipelineDeletedException" => PutPipelineDefinitionError::PipelineDeleted(String::from(error_message)),
"PipelineNotFoundException" => PutPipelineDefinitionError::PipelineNotFound(String::from(error_message)),
"ValidationException" => PutPipelineDefinitionError::Validation(error_message.to_string()),
...
PutPipelineDefinitionError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> QueryObjectsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServiceError" => QueryObjectsError::InternalServiceError(String::from(error_message)),
"InvalidRequestException" => QueryObjectsError::InvalidRequest(String::from(error_message)),
"PipelineDeletedException" => QueryObjectsError::PipelineDeleted(String::from(error_message)),
"PipelineNotFoundException" => QueryObjectsError::PipelineNotFound(String::from(error_message)),
"ValidationException" => QueryObjectsError::Validation(error_message.to_string()),
                    ...
                    pub fn from_body(body: &str) -> RemoveTagsError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServiceError" => RemoveTagsError::InternalServiceError(String::from(error_message)),
"InvalidRequestException" => RemoveTagsError::InvalidRequest(String::from(error_message)),
"PipelineDeletedException" => RemoveTagsError::PipelineDeleted(String::from(error_message)),
"PipelineNotFoundException" => RemoveTagsError::PipelineNotFound(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> ReportTaskProgressError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServiceError" => ReportTaskProgressError::InternalServiceError(String::from(error_message)),
"InvalidRequestException" => ReportTaskProgressError::InvalidRequest(String::from(error_message)),
"PipelineDeletedException" => ReportTaskProgressError::PipelineDeleted(String::from(error_message)),
"PipelineNotFoundException" => ReportTaskProgressError::PipelineNotFound(String::from(error_message)),
"TaskNotFoundException" => ReportTaskProgressError::TaskNotFound(String::from(error_message)),
"ValidationException" => ReportTaskProgressError::Validation(error_message.to_string()),
...
ReportTaskProgressError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
"InvalidRequestException" => ReportTaskRunnerHeartbeatError::InvalidRequest(String::from(error_message)),
"ValidationException" => ReportTaskRunnerHeartbeatError::Validation(error_message.to_string()),
...
ReportTaskRunnerHeartbeatError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                    ...
                    pub fn from_body(body: &str) -> SetStatusError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServiceError" => SetStatusError::InternalServiceError(String::from(error_message)),
"InvalidRequestException" => SetStatusError::InvalidRequest(String::from(error_message)),
"PipelineDeletedException" => SetStatusError::PipelineDeleted(String::from(error_message)),
"PipelineNotFoundException" => SetStatusError::PipelineNotFound(String::from(error_message)),
                    ...
                    pub fn from_body(body: &str) -> SetTaskStatusError {
                        match from_str::<SerdeJsonValue>(body) {
                            Ok(json) => {
                                ...
                                match *error_type {
                                    "InternalServiceError" => SetTaskStatusError::InternalServiceError(String::from(error_message)),
"InvalidRequestException" => SetTaskStatusError::InvalidRequest(String::from(error_message)),
"PipelineDeletedException" => SetTaskStatusError::PipelineDeleted(String::from(error_message)),
"PipelineNotFoundException" => SetTaskStatusError::PipelineNotFound(String::from(error_message)),
"TaskNotFoundException" => SetTaskStatusError::TaskNotFound(String::from(error_message)),
"ValidationException" => SetTaskStatusError::Validation(error_message.to_string()),
...
"InvalidRequestException" => ValidatePipelineDefinitionError::InvalidRequest(String::from(error_message)),
...
"ValidationException" => ValidatePipelineDefinitionError::Validation(error_message.to_string()),
...
ValidatePipelineDefinitionError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
/// Trait representing the capabilities of the AWS Data Pipeline API. AWS Data Pipeline clients implement this trait.
        pub trait DataPipeline {
                ...
                fn activate_pipeline(&self, input: &ActivatePipelineInput)  -> Box<Future<Item = ActivatePipelineOutput, Error = ActivatePipelineError>>;
                ...
                fn deactivate_pipeline(&self, input: &DeactivatePipelineInput)  -> Box<Future<Item = DeactivatePipelineOutput, Error = DeactivatePipelineError>>;
                ...
                fn describe_objects(&self, input: &DescribeObjectsInput)  -> Box<Future<Item = DescribeObjectsOutput, Error = DescribeObjectsError>>;
                

                #[doc="<p>Retrieves metadata about one or more pipelines. The information retrieved includes the name of the pipeline, the pipeline identifier, its current state, and the user account that owns the pipeline. Using account credentials, you can retrieve metadata about pipelines that you or your IAM users have created. If you are using an IAM user account, you can retrieve metadata about only those pipelines for which you have read permissions.</p> <p>To retrieve the full pipeline definition instead of metadata about the pipeline, call <a>GetPipelineDefinition</a>.</p>"]
                fn describe_pipelines(&self, input: &DescribePipelinesInput)  -> Box<Future<Item = DescribePipelinesOutput, Error = DescribePipelinesError>>;
                ...
                fn evaluate_expression(&self, input: &EvaluateExpressionInput)  -> Box<Future<Item = EvaluateExpressionOutput, Error = EvaluateExpressionError>>;
                ...
                fn get_pipeline_definition(&self, input: &GetPipelineDefinitionInput)  -> Box<Future<Item = GetPipelineDefinitionOutput, Error = GetPipelineDefinitionError>>;
                ...
                fn poll_for_task(&self, input: &PollForTaskInput)  -> Box<Future<Item = PollForTaskOutput, Error = PollForTaskError>>;
                ...
                fn put_pipeline_definition(&self, input: &PutPipelineDefinitionInput)  -> Box<Future<Item = PutPipelineDefinitionOutput, Error = PutPipelineDefinitionError>>;
                

                #[doc="<p>Queries the specified pipeline for the names of objects that match the specified set of conditions.</p>"]
                fn query_objects(&self, input: &QueryObjectsInput)  -> Box<Future<Item = QueryObjectsOutput, Error = QueryObjectsError>>;
                ...
                fn report_task_progress(&self, input: &ReportTaskProgressInput)  -> Box<Future<Item = ReportTaskProgressOutput, Error = ReportTaskProgressError>>;
                ...
                fn report_task_runner_heartbeat(&self, input: &ReportTaskRunnerHeartbeatInput)  -> Box<Future<Item = ReportTaskRunnerHeartbeatOutput, Error = ReportTaskRunnerHeartbeatError>>;
                ...
                fn set_status(&self, input: &SetStatusInput)  -> Box<Future<Item = (), Error = SetStatusError>>;
                ...
                fn set_task_status(&self, input: &SetTaskStatusInput)  -> Box<Future<Item = SetTaskStatusOutput, Error = SetTaskStatusError>>;
                

                #[doc="<p>Validates the specified pipeline definition to ensure that it is well formed and can be run without error.</p>"]
                fn validate_pipeline_definition(&self, input: &ValidatePipelineDefinitionInput)  -> Box<Future<Item = ValidatePipelineDefinitionOutput, Error = ValidatePipelineDefinitionError>>;
                
}
/// A client for the AWS Data Pipeline API.
        pub struct DataPipelineClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            credentials_provider: P,
            region: region::Region,
            dispatcher: D,
        }

        impl<P, D> DataPipelineClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
        ...
        impl<P, D> DataPipeline for DataPipelineClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(ActivatePipelineError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| ActivatePipelineError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<ActivatePipelineOutput>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(ActivatePipelineError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DeactivatePipelineError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DeactivatePipelineError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<DeactivatePipelineOutput>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(DeactivatePipelineError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DescribeObjectsError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DescribeObjectsError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<DescribeObjectsOutput>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(DescribeObjectsError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DescribePipelinesError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DescribePipelinesError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<DescribePipelinesOutput>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(DescribePipelinesError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(EvaluateExpressionError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| EvaluateExpressionError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<EvaluateExpressionOutput>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(EvaluateExpressionError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(GetPipelineDefinitionError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| GetPipelineDefinitionError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<GetPipelineDefinitionOutput>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(GetPipelineDefinitionError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(PollForTaskError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| PollForTaskError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<PollForTaskOutput>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(PollForTaskError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(PutPipelineDefinitionError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| PutPipelineDefinitionError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<PutPipelineDefinitionOutput>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(PutPipelineDefinitionError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(QueryObjectsError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| QueryObjectsError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<QueryObjectsOutput>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(QueryObjectsError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(ReportTaskProgressError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| ReportTaskProgressError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<ReportTaskProgressOutput>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(ReportTaskProgressError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(ReportTaskRunnerHeartbeatError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| ReportTaskRunnerHeartbeatError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<ReportTaskRunnerHeartbeatOutput>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(ReportTaskRunnerHeartbeatError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(SetStatusError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| SetStatusError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(())
                                }
                                _ => future::err(SetStatusError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(SetTaskStatusError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| SetTaskStatusError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<SetTaskStatusOutput>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(SetTaskStatusError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
         ...
         request.set_payload(Some(encoded.into_bytes()));
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(ValidatePipelineDefinitionError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| ValidatePipelineDefinitionError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    future::ok(serde_json::from_str::<ValidatePipelineDefinitionOutput>(String::from_utf8_lossy(&response.body).as_ref()).unwrap())
                                }
                                _ => future::err(ValidatePipelineDefinitionError::from_body(String::from_utf8_lossy(&response.body).as_ref())),
                            }
                        );
