        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Activities" => {
                obj.activities = try!(ActivitiesDeserializer::deserialize("Activities", stack));
            }
"NextToken" => {
                obj.next_token = Some(try!(XmlStringDeserializer::deserialize("NextToken", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ActivityId" => {
                obj.activity_id = try!(XmlStringDeserializer::deserialize("ActivityId", stack));
            }
"AutoScalingGroupName" => {
                obj.auto_scaling_group_name = try!(XmlStringMaxLen255Deserializer::deserialize("AutoScalingGroupName", stack));
            }
"Cause" => {
                obj.cause = try!(XmlStringMaxLen1023Deserializer::deserialize("Cause", stack));
            }
"Description" => {
                obj.description = Some(try!(XmlStringDeserializer::deserialize("Description", stack)));
            }
"Details" => {
                obj.details = Some(try!(XmlStringDeserializer::deserialize("Details", stack)));
            }
"EndTime" => {
                obj.end_time = Some(try!(TimestampTypeDeserializer::deserialize("EndTime", stack)));
            }
"Progress" => {
                obj.progress = Some(try!(ProgressDeserializer::deserialize("Progress", stack)));
            }
"StartTime" => {
                obj.start_time = try!(TimestampTypeDeserializer::deserialize("StartTime", stack));
            }
"StatusCode" => {
                obj.status_code = try!(ScalingActivityStatusCodeDeserializer::deserialize("StatusCode", stack));
            }
"StatusMessage" => {
                obj.status_message = Some(try!(XmlStringMaxLen255Deserializer::deserialize("StatusMessage", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Activity" => {
                obj.activity = Some(try!(ActivityDeserializer::deserialize("Activity", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AdjustmentType" => {
                obj.adjustment_type = Some(try!(XmlStringMaxLen255Deserializer::deserialize("AdjustmentType", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AlarmARN" => {
                obj.alarm_arn = Some(try!(ResourceNameDeserializer::deserialize("AlarmARN", stack)));
            }
"AlarmName" => {
                obj.alarm_name = Some(try!(XmlStringMaxLen255Deserializer::deserialize("AlarmName", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub instance_ids: Option<InstanceIds>,
        ...
        params.put(&format!("{}{}", prefix, "AutoScalingGroupName"), &obj.auto_scaling_group_name);
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AutoScalingGroupARN" => {
                obj.auto_scaling_group_arn = Some(try!(ResourceNameDeserializer::deserialize("AutoScalingGroupARN", stack)));
            }
"AutoScalingGroupName" => {
                obj.auto_scaling_group_name = try!(XmlStringMaxLen255Deserializer::deserialize("AutoScalingGroupName", stack));
            }
"AvailabilityZones" => {
                obj.availability_zones = try!(AvailabilityZonesDeserializer::deserialize("AvailabilityZones", stack));
            }
"CreatedTime" => {
                obj.created_time = try!(TimestampTypeDeserializer::deserialize("CreatedTime", stack));
            }
"DefaultCooldown" => {
                obj.default_cooldown = try!(CooldownDeserializer::deserialize("DefaultCooldown", stack));
            }
"DesiredCapacity" => {
                obj.desired_capacity = try!(AutoScalingGroupDesiredCapacityDeserializer::deserialize("DesiredCapacity", stack));
            }
"EnabledMetrics" => {
                obj.enabled_metrics = Some(try!(EnabledMetricsDeserializer::deserialize("EnabledMetrics", stack)));
            }
"HealthCheckGracePeriod" => {
                obj.health_check_grace_period = Some(try!(HealthCheckGracePeriodDeserializer::deserialize("HealthCheckGracePeriod", stack)));
            }
"HealthCheckType" => {
                obj.health_check_type = try!(XmlStringMaxLen32Deserializer::deserialize("HealthCheckType", stack));
            }
"Instances" => {
                obj.instances = Some(try!(InstancesDeserializer::deserialize("Instances", stack)));
            }
"LaunchConfigurationName" => {
                obj.launch_configuration_name = Some(try!(XmlStringMaxLen255Deserializer::deserialize("LaunchConfigurationName", stack)));
            }
"LoadBalancerNames" => {
                obj.load_balancer_names = Some(try!(LoadBalancerNamesDeserializer::deserialize("LoadBalancerNames", stack)));
            }
"MaxSize" => {
                obj.max_size = try!(AutoScalingGroupMaxSizeDeserializer::deserialize("MaxSize", stack));
            }
"MinSize" => {
                obj.min_size = try!(AutoScalingGroupMinSizeDeserializer::deserialize("MinSize", stack));
            }
"NewInstancesProtectedFromScaleIn" => {
                obj.new_instances_protected_from_scale_in = Some(try!(InstanceProtectedDeserializer::deserialize("NewInstancesProtectedFromScaleIn", stack)));
            }
"PlacementGroup" => {
                obj.placement_group = Some(try!(XmlStringMaxLen255Deserializer::deserialize("PlacementGroup", stack)));
            }
"Status" => {
                obj.status = Some(try!(XmlStringMaxLen255Deserializer::deserialize("Status", stack)));
            }
"SuspendedProcesses" => {
                obj.suspended_processes = Some(try!(SuspendedProcessesDeserializer::deserialize("SuspendedProcesses", stack)));
            }
"Tags" => {
                obj.tags = Some(try!(TagDescriptionListDeserializer::deserialize("Tags", stack)));
            }
"TargetGroupARNs" => {
                obj.target_group_ar_ns = Some(try!(TargetGroupARNsDeserializer::deserialize("TargetGroupARNs", stack)));
            }
"TerminationPolicies" => {
                obj.termination_policies = Some(try!(TerminationPoliciesDeserializer::deserialize("TerminationPolicies", stack)));
            }
"VPCZoneIdentifier" => {
                obj.vpc_zone_identifier = Some(try!(XmlStringMaxLen2047Deserializer::deserialize("VPCZoneIdentifier", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AutoScalingGroups" => {
                obj.auto_scaling_groups = try!(AutoScalingGroupsDeserializer::deserialize("AutoScalingGroups", stack));
            }
"NextToken" => {
                obj.next_token = Some(try!(XmlStringDeserializer::deserialize("NextToken", stack)));
            }
...
"AvailabilityZone" => {
                obj.availability_zone = try!(XmlStringMaxLen255Deserializer::deserialize("AvailabilityZone", stack));
            }
"HealthStatus" => {
                obj.health_status = try!(XmlStringMaxLen32Deserializer::deserialize("HealthStatus", stack));
            }
"InstanceId" => {
                obj.instance_id = try!(XmlStringMaxLen19Deserializer::deserialize("InstanceId", stack));
            }
"LaunchConfigurationName" => {
                obj.launch_configuration_name = try!(XmlStringMaxLen255Deserializer::deserialize("LaunchConfigurationName", stack));
            }
"LifecycleState" => {
                obj.lifecycle_state = try!(XmlStringMaxLen32Deserializer::deserialize("LifecycleState", stack));
            }
"ProtectedFromScaleIn" => {
                obj.protected_from_scale_in = try!(InstanceProtectedDeserializer::deserialize("ProtectedFromScaleIn", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct AutoScalingInstancesDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(AutoScalingInstanceDetailsDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
...
struct AutoScalingInstancesTypeDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.auto_scaling_instances = Some(try!(AutoScalingInstancesDeserializer::deserialize("AutoScalingInstances", stack)));
            }
"NextToken" => {
                obj.next_token = Some(try!(XmlStringDeserializer::deserialize("NextToken", stack)));
            }
...
struct AutoScalingNotificationTypesDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(XmlStringMaxLen255Deserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "DeviceName" => {
                obj.device_name = try!(XmlStringMaxLen255Deserializer::deserialize("DeviceName", stack));
            }
"Ebs" => {
                obj.ebs = Some(try!(EbsDeserializer::deserialize("Ebs", stack)));
            }
"NoDevice" => {
                obj.no_device = Some(try!(NoDeviceDeserializer::deserialize("NoDevice", stack)));
            }
"VirtualName" => {
                obj.virtual_name = Some(try!(XmlStringMaxLen255Deserializer::deserialize("VirtualName", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
if let Some(ref field_value) = obj.no_device {
                params.put(&format!("{}{}", prefix, "NoDevice"), &field_value.to_string());
            }
...
struct BlockDeviceMappingsDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(BlockDeviceMappingDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
...
params.put(&format!("{}{}", prefix, "LifecycleActionResult"), &obj.lifecycle_action_result);
if let Some(ref field_value) = obj.lifecycle_action_token {
                params.put(&format!("{}{}", prefix, "LifecycleActionToken"), &field_value);
            }
params.put(&format!("{}{}", prefix, "LifecycleHookName"), &obj.lifecycle_hook_name);
...
if let Some(ref field_value) = obj.default_cooldown {
                params.put(&format!("{}{}", prefix, "DefaultCooldown"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.desired_capacity {
                params.put(&format!("{}{}", prefix, "DesiredCapacity"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.health_check_grace_period {
                params.put(&format!("{}{}", prefix, "HealthCheckGracePeriod"), &field_value.to_string());
            }
...
if let Some(ref field_value) = obj.launch_configuration_name {
                params.put(&format!("{}{}", prefix, "LaunchConfigurationName"), &field_value);
            }
...
params.put(&format!("{}{}", prefix, "MaxSize"), &obj.max_size.to_string());
params.put(&format!("{}{}", prefix, "MinSize"), &obj.min_size.to_string());
if let Some(ref field_value) = obj.new_instances_protected_from_scale_in {
                params.put(&format!("{}{}", prefix, "NewInstancesProtectedFromScaleIn"), &field_value.to_string());
            }
...
pub user_data: Option<XmlStringUserData>,
        ...
        if let Some(ref field_value) = obj.associate_public_ip_address {
                params.put(&format!("{}{}", prefix, "AssociatePublicIpAddress"), &field_value.to_string());
            }
...
if let Some(ref field_value) = obj.ebs_optimized {
                params.put(&format!("{}{}", prefix, "EbsOptimized"), &field_value.to_string());
            }
...
params.put(&format!("{}{}", prefix, "LaunchConfigurationName"), &obj.launch_configuration_name);
...
if let Some(ref field_value) = obj.force_delete {
                params.put(&format!("{}{}", prefix, "ForceDelete"), &field_value.to_string());
            }
...
pub policy_name: ResourceName,
        ...
        if let Some(ref field_value) = obj.auto_scaling_group_name {
                params.put(&format!("{}{}", prefix, "AutoScalingGroupName"), &field_value);
            }
...
pub scheduled_action_name: ResourceName,
        ...
        params.put(&format!("{}{}", prefix, "AutoScalingGroupName"), &obj.auto_scaling_group_name);
params.put(&format!("{}{}", prefix, "ScheduledActionName"), &obj.scheduled_action_name);
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AdjustmentTypes" => {
                obj.adjustment_types = Some(try!(AdjustmentTypesDeserializer::deserialize("AdjustmentTypes", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "LifecycleHooks" => {
                obj.lifecycle_hooks = Some(try!(LifecycleHooksDeserializer::deserialize("LifecycleHooks", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "LoadBalancers" => {
                obj.load_balancers = Some(try!(LoadBalancerStatesDeserializer::deserialize("LoadBalancers", stack)));
            }
"NextToken" => {
                obj.next_token = Some(try!(XmlStringDeserializer::deserialize("NextToken", stack)));
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Granularities" => {
                obj.granularities = Some(try!(MetricGranularityTypesDeserializer::deserialize("Granularities", stack)));
            }
"Metrics" => {
                obj.metrics = Some(try!(MetricCollectionTypesDeserializer::deserialize("Metrics", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"NotificationConfigurations" => {
                obj.notification_configurations = try!(NotificationConfigurationsDeserializer::deserialize("NotificationConfigurations", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
...
#[derive(Default,Debug,Clone)]
            pub struct DescribePoliciesType {
                #[doc="<p>The name of the group.</p>"]
pub auto_scaling_group_name: Option<ResourceName>,
#[doc="<p>The maximum number of items to be returned with each call.</p>"]
pub max_records: Option<MaxRecords>,
#[doc="<p>The token for the next set of items to return. (You received this token from a previous call.)</p>"]
pub next_token: Option<XmlString>,
...
struct DescribeTerminationPolicyTypesAnswerDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.termination_policy_types = Some(try!(TerminationPoliciesDeserializer::deserialize("TerminationPolicyTypes", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Activities" => {
                obj.activities = Some(try!(ActivitiesDeserializer::deserialize("Activities", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
params.put(&format!("{}{}", prefix, "ShouldDecrementDesiredCapacity"), &obj.should_decrement_desired_capacity.to_string());
...
"Encrypted" => {
                obj.encrypted = Some(try!(BlockDeviceEbsEncryptedDeserializer::deserialize("Encrypted", stack)));
            }
"Iops" => {
                obj.iops = Some(try!(BlockDeviceEbsIopsDeserializer::deserialize("Iops", stack)));
            }
"SnapshotId" => {
                obj.snapshot_id = Some(try!(XmlStringMaxLen255Deserializer::deserialize("SnapshotId", stack)));
            }
"VolumeSize" => {
...
"VolumeType" => {
        ...
        if let Some(ref field_value) = obj.delete_on_termination {
                params.put(&format!("{}{}", prefix, "DeleteOnTermination"), &field_value.to_string());
            }
...
if let Some(ref field_value) = obj.volume_size {
                params.put(&format!("{}{}", prefix, "VolumeSize"), &field_value.to_string());
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Granularity" => {
                obj.granularity = Some(try!(XmlStringMaxLen255Deserializer::deserialize("Granularity", stack)));
            }
"Metric" => {
                obj.metric = Some(try!(XmlStringMaxLen255Deserializer::deserialize("Metric", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
if let Some(ref field_value) = obj.breach_threshold {
                params.put(&format!("{}{}", prefix, "BreachThreshold"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.honor_cooldown {
                params.put(&format!("{}{}", prefix, "HonorCooldown"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.metric_value {
                params.put(&format!("{}{}", prefix, "MetricValue"), &field_value.to_string());
            }
params.put(&format!("{}{}", prefix, "PolicyName"), &obj.policy_name);
...
"LifecycleState" => {
                obj.lifecycle_state = try!(LifecycleStateDeserializer::deserialize("LifecycleState", stack));
            }
"ProtectedFromScaleIn" => {
                obj.protected_from_scale_in = try!(InstanceProtectedDeserializer::deserialize("ProtectedFromScaleIn", stack));
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Enabled" => {
                obj.enabled = Some(try!(MonitoringEnabledDeserializer::deserialize("Enabled", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"BlockDeviceMappings" => {
                obj.block_device_mappings = Some(try!(BlockDeviceMappingsDeserializer::deserialize("BlockDeviceMappings", stack)));
            }
"ClassicLinkVPCId" => {
                obj.classic_link_vpc_id = Some(try!(XmlStringMaxLen255Deserializer::deserialize("ClassicLinkVPCId", stack)));
            }
...
"EbsOptimized" => {
                obj.ebs_optimized = Some(try!(EbsOptimizedDeserializer::deserialize("EbsOptimized", stack)));
            }
"IamInstanceProfile" => {
                obj.iam_instance_profile = Some(try!(XmlStringMaxLen1600Deserializer::deserialize("IamInstanceProfile", stack)));
            }
"ImageId" => {
                obj.image_id = try!(XmlStringMaxLen255Deserializer::deserialize("ImageId", stack));
            }
"InstanceMonitoring" => {
                obj.instance_monitoring = Some(try!(InstanceMonitoringDeserializer::deserialize("InstanceMonitoring", stack)));
            }
"InstanceType" => {
                obj.instance_type = try!(XmlStringMaxLen255Deserializer::deserialize("InstanceType", stack));
            }
"KernelId" => {
                obj.kernel_id = Some(try!(XmlStringMaxLen255Deserializer::deserialize("KernelId", stack)));
            }
"KeyName" => {
                obj.key_name = Some(try!(XmlStringMaxLen255Deserializer::deserialize("KeyName", stack)));
            }
"LaunchConfigurationARN" => {
                obj.launch_configuration_arn = Some(try!(ResourceNameDeserializer::deserialize("LaunchConfigurationARN", stack)));
            }
"LaunchConfigurationName" => {
                obj.launch_configuration_name = try!(XmlStringMaxLen255Deserializer::deserialize("LaunchConfigurationName", stack));
            }
"PlacementTenancy" => {
                obj.placement_tenancy = Some(try!(XmlStringMaxLen64Deserializer::deserialize("PlacementTenancy", stack)));
            }
"RamdiskId" => {
                obj.ramdisk_id = Some(try!(XmlStringMaxLen255Deserializer::deserialize("RamdiskId", stack)));
            }
"SecurityGroups" => {
                obj.security_groups = Some(try!(SecurityGroupsDeserializer::deserialize("SecurityGroups", stack)));
            }
"SpotPrice" => {
                obj.spot_price = Some(try!(SpotPriceDeserializer::deserialize("SpotPrice", stack)));
            }
"UserData" => {
                obj.user_data = Some(try!(XmlStringUserDataDeserializer::deserialize("UserData", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
#[doc="<p>The maximum number of items to return with this call. The default is 100.</p>"]
pub max_records: Option<MaxRecords>,
#[doc="<p>The token for the next set of items to return. (You received this token from a previous call.)</p>"]
pub next_token: Option<XmlString>,
            }
...
struct LaunchConfigurationsTypeDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.launch_configurations = try!(LaunchConfigurationsDeserializer::deserialize("LaunchConfigurations", stack));
            }
"NextToken" => {
                obj.next_token = Some(try!(XmlStringDeserializer::deserialize("NextToken", stack)));
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AutoScalingGroupName" => {
                obj.auto_scaling_group_name = Some(try!(ResourceNameDeserializer::deserialize("AutoScalingGroupName", stack)));
            }
"DefaultResult" => {
                obj.default_result = Some(try!(LifecycleActionResultDeserializer::deserialize("DefaultResult", stack)));
            }
"GlobalTimeout" => {
                obj.global_timeout = Some(try!(GlobalTimeoutDeserializer::deserialize("GlobalTimeout", stack)));
            }
"HeartbeatTimeout" => {
                obj.heartbeat_timeout = Some(try!(HeartbeatTimeoutDeserializer::deserialize("HeartbeatTimeout", stack)));
            }
"LifecycleHookName" => {
                obj.lifecycle_hook_name = Some(try!(AsciiStringMaxLen255Deserializer::deserialize("LifecycleHookName", stack)));
            }
"LifecycleTransition" => {
                obj.lifecycle_transition = Some(try!(LifecycleTransitionDeserializer::deserialize("LifecycleTransition", stack)));
            }
"NotificationMetadata" => {
                obj.notification_metadata = Some(try!(XmlStringMaxLen1023Deserializer::deserialize("NotificationMetadata", stack)));
            }
"NotificationTargetARN" => {
                obj.notification_target_arn = Some(try!(ResourceNameDeserializer::deserialize("NotificationTargetARN", stack)));
            }
"RoleARN" => {
                obj.role_arn = Some(try!(ResourceNameDeserializer::deserialize("RoleARN", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "LoadBalancerName" => {
                obj.load_balancer_name = Some(try!(XmlStringMaxLen255Deserializer::deserialize("LoadBalancerName", stack)));
            }
"State" => {
                obj.state = Some(try!(XmlStringMaxLen255Deserializer::deserialize("State", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct LoadBalancerTargetGroupStateDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.load_balancer_target_group_arn = Some(try!(XmlStringMaxLen511Deserializer::deserialize("LoadBalancerTargetGroupARN", stack)));
            }
"State" => {
                obj.state = Some(try!(XmlStringMaxLen255Deserializer::deserialize("State", stack)));
            }
...
struct MetricCollectionTypesDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(MetricCollectionTypeDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
...
struct MetricGranularityTypesDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(MetricGranularityTypeDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
...
"NotificationType" => {
                obj.notification_type = Some(try!(XmlStringMaxLen255Deserializer::deserialize("NotificationType", stack)));
            }
"TopicARN" => {
                obj.topic_arn = Some(try!(ResourceNameDeserializer::deserialize("TopicARN", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct NotificationConfigurationsDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(NotificationConfigurationDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
...
"ScalingPolicies" => {
                obj.scaling_policies = Some(try!(ScalingPoliciesDeserializer::deserialize("ScalingPolicies", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "PolicyARN" => {
                obj.policy_arn = Some(try!(ResourceNameDeserializer::deserialize("PolicyARN", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ProcessName" => {
                obj.process_name = try!(XmlStringMaxLen255Deserializer::deserialize("ProcessName", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Processes" => {
                obj.processes = Some(try!(ProcessesDeserializer::deserialize("Processes", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
if let Some(ref field_value) = obj.heartbeat_timeout {
                params.put(&format!("{}{}", prefix, "HeartbeatTimeout"), &field_value.to_string());
            }
params.put(&format!("{}{}", prefix, "LifecycleHookName"), &obj.lifecycle_hook_name);
if let Some(ref field_value) = obj.lifecycle_transition {
                params.put(&format!("{}{}", prefix, "LifecycleTransition"), &field_value);
            }
if let Some(ref field_value) = obj.notification_metadata {
                params.put(&format!("{}{}", prefix, "NotificationMetadata"), &field_value);
            }
if let Some(ref field_value) = obj.notification_target_arn {
                params.put(&format!("{}{}", prefix, "NotificationTargetARN"), &field_value);
            }
...
pub step_adjustments: Option<StepAdjustments>,
        ...
        params.put(&format!("{}{}", prefix, "AdjustmentType"), &obj.adjustment_type);
params.put(&format!("{}{}", prefix, "AutoScalingGroupName"), &obj.auto_scaling_group_name);
if let Some(ref field_value) = obj.cooldown {
                params.put(&format!("{}{}", prefix, "Cooldown"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.estimated_instance_warmup {
                params.put(&format!("{}{}", prefix, "EstimatedInstanceWarmup"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.metric_aggregation_type {
                params.put(&format!("{}{}", prefix, "MetricAggregationType"), &field_value);
            }
if let Some(ref field_value) = obj.min_adjustment_magnitude {
                params.put(&format!("{}{}", prefix, "MinAdjustmentMagnitude"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.min_adjustment_step {
                params.put(&format!("{}{}", prefix, "MinAdjustmentStep"), &field_value.to_string());
            }
params.put(&format!("{}{}", prefix, "PolicyName"), &obj.policy_name);
...
if let Some(ref field_value) = obj.scaling_adjustment {
                params.put(&format!("{}{}", prefix, "ScalingAdjustment"), &field_value.to_string());
            }
...
if let Some(ref field_value) = obj.max_size {
                params.put(&format!("{}{}", prefix, "MaxSize"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.min_size {
                params.put(&format!("{}{}", prefix, "MinSize"), &field_value.to_string());
            }
...
"AutoScalingGroupName" => {
                obj.auto_scaling_group_name = Some(try!(XmlStringMaxLen255Deserializer::deserialize("AutoScalingGroupName", stack)));
            }
"Cooldown" => {
                obj.cooldown = Some(try!(CooldownDeserializer::deserialize("Cooldown", stack)));
            }
"EstimatedInstanceWarmup" => {
                obj.estimated_instance_warmup = Some(try!(EstimatedInstanceWarmupDeserializer::deserialize("EstimatedInstanceWarmup", stack)));
            }
"MetricAggregationType" => {
                obj.metric_aggregation_type = Some(try!(XmlStringMaxLen32Deserializer::deserialize("MetricAggregationType", stack)));
            }
"MinAdjustmentMagnitude" => {
                obj.min_adjustment_magnitude = Some(try!(MinAdjustmentMagnitudeDeserializer::deserialize("MinAdjustmentMagnitude", stack)));
            }
"MinAdjustmentStep" => {
                obj.min_adjustment_step = Some(try!(MinAdjustmentStepDeserializer::deserialize("MinAdjustmentStep", stack)));
            }
"PolicyARN" => {
                obj.policy_arn = Some(try!(ResourceNameDeserializer::deserialize("PolicyARN", stack)));
            }
"PolicyName" => {
                obj.policy_name = Some(try!(XmlStringMaxLen255Deserializer::deserialize("PolicyName", stack)));
            }
"PolicyType" => {
                obj.policy_type = Some(try!(XmlStringMaxLen64Deserializer::deserialize("PolicyType", stack)));
            }
"ScalingAdjustment" => {
                obj.scaling_adjustment = Some(try!(PolicyIncrementDeserializer::deserialize("ScalingAdjustment", stack)));
            }
"StepAdjustments" => {
                obj.step_adjustments = Some(try!(StepAdjustmentsDeserializer::deserialize("StepAdjustments", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"MaxSize" => {
                obj.max_size = Some(try!(AutoScalingGroupMaxSizeDeserializer::deserialize("MaxSize", stack)));
            }
"MinSize" => {
                obj.min_size = Some(try!(AutoScalingGroupMinSizeDeserializer::deserialize("MinSize", stack)));
            }
"Recurrence" => {
                obj.recurrence = Some(try!(XmlStringMaxLen255Deserializer::deserialize("Recurrence", stack)));
            }
"ScheduledActionARN" => {
                obj.scheduled_action_arn = Some(try!(ResourceNameDeserializer::deserialize("ScheduledActionARN", stack)));
            }
"ScheduledActionName" => {
                obj.scheduled_action_name = Some(try!(XmlStringMaxLen255Deserializer::deserialize("ScheduledActionName", stack)));
            }
"StartTime" => {
                obj.start_time = Some(try!(TimestampTypeDeserializer::deserialize("StartTime", stack)));
            }
"Time" => {
                obj.time = Some(try!(TimestampTypeDeserializer::deserialize("Time", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct ScheduledUpdateGroupActionsDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(ScheduledUpdateGroupActionDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
...
pub honor_cooldown: Option<HonorCooldown>,
        ...
        params.put(&format!("{}{}", prefix, "AutoScalingGroupName"), &obj.auto_scaling_group_name);
params.put(&format!("{}{}", prefix, "DesiredCapacity"), &obj.desired_capacity.to_string());
if let Some(ref field_value) = obj.honor_cooldown {
                params.put(&format!("{}{}", prefix, "HonorCooldown"), &field_value.to_string());
            }
...
if let Some(ref field_value) = obj.should_respect_grace_period {
                params.put(&format!("{}{}", prefix, "ShouldRespectGracePeriod"), &field_value.to_string());
            }
...
params.put(&format!("{}{}", prefix, "ProtectedFromScaleIn"), &obj.protected_from_scale_in.to_string());
...
struct StepAdjustmentDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.metric_interval_lower_bound = Some(try!(MetricScaleDeserializer::deserialize("MetricIntervalLowerBound", stack)));
            }
"MetricIntervalUpperBound" => {
                obj.metric_interval_upper_bound = Some(try!(MetricScaleDeserializer::deserialize("MetricIntervalUpperBound", stack)));
            }
"ScalingAdjustment" => {
                obj.scaling_adjustment = try!(PolicyIncrementDeserializer::deserialize("ScalingAdjustment", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        if let Some(ref field_value) = obj.metric_interval_lower_bound {
                params.put(&format!("{}{}", prefix, "MetricIntervalLowerBound"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.metric_interval_upper_bound {
                params.put(&format!("{}{}", prefix, "MetricIntervalUpperBound"), &field_value.to_string());
            }
params.put(&format!("{}{}", prefix, "ScalingAdjustment"), &obj.scaling_adjustment.to_string());
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ProcessName" => {
                obj.process_name = Some(try!(XmlStringMaxLen255Deserializer::deserialize("ProcessName", stack)));
            }
"SuspensionReason" => {
                obj.suspension_reason = Some(try!(XmlStringMaxLen255Deserializer::deserialize("SuspensionReason", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
if let Some(ref field_value) = obj.propagate_at_launch {
                params.put(&format!("{}{}", prefix, "PropagateAtLaunch"), &field_value.to_string());
            }
...
"PropagateAtLaunch" => {
                obj.propagate_at_launch = Some(try!(PropagateAtLaunchDeserializer::deserialize("PropagateAtLaunch", stack)));
            }
"ResourceId" => {
                obj.resource_id = Some(try!(XmlStringDeserializer::deserialize("ResourceId", stack)));
            }
"ResourceType" => {
                obj.resource_type = Some(try!(XmlStringDeserializer::deserialize("ResourceType", stack)));
            }
"Value" => {
...
struct TargetGroupARNsDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(XmlStringMaxLen511Deserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
...
struct TerminationPoliciesDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(XmlStringMaxLen1600Deserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => AttachInstancesError::ResourceContentionFault(String::from(parsed_error.message)),_ => AttachInstancesError::Unknown(String::from(body))
                                }
                           },
                ...
                impl AttachLoadBalancerTargetGroupsError {
                    pub fn from_body(body: &str) -> AttachLoadBalancerTargetGroupsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => AttachLoadBalancerTargetGroupsError::ResourceContentionFault(String::from(parsed_error.message)),_ => AttachLoadBalancerTargetGroupsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl AttachLoadBalancersError {
                    pub fn from_body(body: &str) -> AttachLoadBalancersError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => AttachLoadBalancersError::ResourceContentionFault(String::from(parsed_error.message)),_ => AttachLoadBalancersError::Unknown(String::from(body))
                                }
                           },
                ...
                impl CompleteLifecycleActionError {
                    pub fn from_body(body: &str) -> CompleteLifecycleActionError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => CompleteLifecycleActionError::ResourceContentionFault(String::from(parsed_error.message)),_ => CompleteLifecycleActionError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DeleteLifecycleHookError {
                    pub fn from_body(body: &str) -> DeleteLifecycleHookError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => DeleteLifecycleHookError::ResourceContentionFault(String::from(parsed_error.message)),_ => DeleteLifecycleHookError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DeleteNotificationConfigurationError {
                    pub fn from_body(body: &str) -> DeleteNotificationConfigurationError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => DeleteNotificationConfigurationError::ResourceContentionFault(String::from(parsed_error.message)),_ => DeleteNotificationConfigurationError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DeletePolicyError {
                    pub fn from_body(body: &str) -> DeletePolicyError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => DeletePolicyError::ResourceContentionFault(String::from(parsed_error.message)),_ => DeletePolicyError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DeleteScheduledActionError {
                    pub fn from_body(body: &str) -> DeleteScheduledActionError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => DeleteScheduledActionError::ResourceContentionFault(String::from(parsed_error.message)),_ => DeleteScheduledActionError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DeleteTagsError {
                    pub fn from_body(body: &str) -> DeleteTagsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => DeleteTagsError::ResourceContentionFault(String::from(parsed_error.message)),_ => DeleteTagsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeAccountLimitsError {
                    pub fn from_body(body: &str) -> DescribeAccountLimitsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => DescribeAccountLimitsError::ResourceContentionFault(String::from(parsed_error.message)),_ => DescribeAccountLimitsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeAdjustmentTypesError {
                    pub fn from_body(body: &str) -> DescribeAdjustmentTypesError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => DescribeAdjustmentTypesError::ResourceContentionFault(String::from(parsed_error.message)),_ => DescribeAdjustmentTypesError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeAutoScalingGroupsError {
                    pub fn from_body(body: &str) -> DescribeAutoScalingGroupsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidNextToken" => DescribeAutoScalingGroupsError::InvalidNextToken(String::from(parsed_error.message)),"ResourceContentionFault" => DescribeAutoScalingGroupsError::ResourceContentionFault(String::from(parsed_error.message)),_ => DescribeAutoScalingGroupsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeAutoScalingNotificationTypesError {
                    pub fn from_body(body: &str) -> DescribeAutoScalingNotificationTypesError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => DescribeAutoScalingNotificationTypesError::ResourceContentionFault(String::from(parsed_error.message)),_ => DescribeAutoScalingNotificationTypesError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeLaunchConfigurationsError {
                    pub fn from_body(body: &str) -> DescribeLaunchConfigurationsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidNextToken" => DescribeLaunchConfigurationsError::InvalidNextToken(String::from(parsed_error.message)),"ResourceContentionFault" => DescribeLaunchConfigurationsError::ResourceContentionFault(String::from(parsed_error.message)),_ => DescribeLaunchConfigurationsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeLifecycleHookTypesError {
                    pub fn from_body(body: &str) -> DescribeLifecycleHookTypesError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => DescribeLifecycleHookTypesError::ResourceContentionFault(String::from(parsed_error.message)),_ => DescribeLifecycleHookTypesError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeLifecycleHooksError {
                    pub fn from_body(body: &str) -> DescribeLifecycleHooksError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => DescribeLifecycleHooksError::ResourceContentionFault(String::from(parsed_error.message)),_ => DescribeLifecycleHooksError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeLoadBalancerTargetGroupsError {
                    pub fn from_body(body: &str) -> DescribeLoadBalancerTargetGroupsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => DescribeLoadBalancerTargetGroupsError::ResourceContentionFault(String::from(parsed_error.message)),_ => DescribeLoadBalancerTargetGroupsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeLoadBalancersError {
                    pub fn from_body(body: &str) -> DescribeLoadBalancersError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => DescribeLoadBalancersError::ResourceContentionFault(String::from(parsed_error.message)),_ => DescribeLoadBalancersError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeMetricCollectionTypesError {
                    pub fn from_body(body: &str) -> DescribeMetricCollectionTypesError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => DescribeMetricCollectionTypesError::ResourceContentionFault(String::from(parsed_error.message)),_ => DescribeMetricCollectionTypesError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribePoliciesError {
                    pub fn from_body(body: &str) -> DescribePoliciesError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidNextToken" => DescribePoliciesError::InvalidNextToken(String::from(parsed_error.message)),"ResourceContentionFault" => DescribePoliciesError::ResourceContentionFault(String::from(parsed_error.message)),_ => DescribePoliciesError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeScalingActivitiesError {
                    pub fn from_body(body: &str) -> DescribeScalingActivitiesError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidNextToken" => DescribeScalingActivitiesError::InvalidNextToken(String::from(parsed_error.message)),"ResourceContentionFault" => DescribeScalingActivitiesError::ResourceContentionFault(String::from(parsed_error.message)),_ => DescribeScalingActivitiesError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeScalingProcessTypesError {
                    pub fn from_body(body: &str) -> DescribeScalingProcessTypesError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => DescribeScalingProcessTypesError::ResourceContentionFault(String::from(parsed_error.message)),_ => DescribeScalingProcessTypesError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeScheduledActionsError {
                    pub fn from_body(body: &str) -> DescribeScheduledActionsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidNextToken" => DescribeScheduledActionsError::InvalidNextToken(String::from(parsed_error.message)),"ResourceContentionFault" => DescribeScheduledActionsError::ResourceContentionFault(String::from(parsed_error.message)),_ => DescribeScheduledActionsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeTagsError {
                    pub fn from_body(body: &str) -> DescribeTagsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidNextToken" => DescribeTagsError::InvalidNextToken(String::from(parsed_error.message)),"ResourceContentionFault" => DescribeTagsError::ResourceContentionFault(String::from(parsed_error.message)),_ => DescribeTagsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeTerminationPolicyTypesError {
                    pub fn from_body(body: &str) -> DescribeTerminationPolicyTypesError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => DescribeTerminationPolicyTypesError::ResourceContentionFault(String::from(parsed_error.message)),_ => DescribeTerminationPolicyTypesError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DetachInstancesError {
                    pub fn from_body(body: &str) -> DetachInstancesError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => DetachInstancesError::ResourceContentionFault(String::from(parsed_error.message)),_ => DetachInstancesError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DetachLoadBalancerTargetGroupsError {
                    pub fn from_body(body: &str) -> DetachLoadBalancerTargetGroupsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => DetachLoadBalancerTargetGroupsError::ResourceContentionFault(String::from(parsed_error.message)),_ => DetachLoadBalancerTargetGroupsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DetachLoadBalancersError {
                    pub fn from_body(body: &str) -> DetachLoadBalancersError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => DetachLoadBalancersError::ResourceContentionFault(String::from(parsed_error.message)),_ => DetachLoadBalancersError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DisableMetricsCollectionError {
                    pub fn from_body(body: &str) -> DisableMetricsCollectionError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => DisableMetricsCollectionError::ResourceContentionFault(String::from(parsed_error.message)),_ => DisableMetricsCollectionError::Unknown(String::from(body))
                                }
                           },
                ...
                impl EnableMetricsCollectionError {
                    pub fn from_body(body: &str) -> EnableMetricsCollectionError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => EnableMetricsCollectionError::ResourceContentionFault(String::from(parsed_error.message)),_ => EnableMetricsCollectionError::Unknown(String::from(body))
                                }
                           },
                ...
                impl EnterStandbyError {
                    pub fn from_body(body: &str) -> EnterStandbyError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => EnterStandbyError::ResourceContentionFault(String::from(parsed_error.message)),_ => EnterStandbyError::Unknown(String::from(body))
                                }
                           },
                ...
                impl ExitStandbyError {
                    pub fn from_body(body: &str) -> ExitStandbyError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => ExitStandbyError::ResourceContentionFault(String::from(parsed_error.message)),_ => ExitStandbyError::Unknown(String::from(body))
                                }
                           },
                ...
                impl PutLifecycleHookError {
                    pub fn from_body(body: &str) -> PutLifecycleHookError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "LimitExceededFault" => PutLifecycleHookError::LimitExceededFault(String::from(parsed_error.message)),"ResourceContentionFault" => PutLifecycleHookError::ResourceContentionFault(String::from(parsed_error.message)),_ => PutLifecycleHookError::Unknown(String::from(body))
                                }
                           },
                ...
                impl PutNotificationConfigurationError {
                    pub fn from_body(body: &str) -> PutNotificationConfigurationError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "LimitExceededFault" => PutNotificationConfigurationError::LimitExceededFault(String::from(parsed_error.message)),"ResourceContentionFault" => PutNotificationConfigurationError::ResourceContentionFault(String::from(parsed_error.message)),_ => PutNotificationConfigurationError::Unknown(String::from(body))
                                }
                           },
                ...
                impl RecordLifecycleActionHeartbeatError {
                    pub fn from_body(body: &str) -> RecordLifecycleActionHeartbeatError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => RecordLifecycleActionHeartbeatError::ResourceContentionFault(String::from(parsed_error.message)),_ => RecordLifecycleActionHeartbeatError::Unknown(String::from(body))
                                }
                           },
                ...
                impl SetInstanceHealthError {
                    pub fn from_body(body: &str) -> SetInstanceHealthError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ResourceContentionFault" => SetInstanceHealthError::ResourceContentionFault(String::from(parsed_error.message)),_ => SetInstanceHealthError::Unknown(String::from(body))
                                }
                           },
                ...
                impl SetInstanceProtectionError {
                    pub fn from_body(body: &str) -> SetInstanceProtectionError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "LimitExceededFault" => SetInstanceProtectionError::LimitExceededFault(String::from(parsed_error.message)),"ResourceContentionFault" => SetInstanceProtectionError::ResourceContentionFault(String::from(parsed_error.message)),_ => SetInstanceProtectionError::Unknown(String::from(body))
                                }
                           },
...
/// A client for the Auto Scaling API.
        pub struct AutoscalingClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            credentials_provider: P,
            region: region::Region,
            dispatcher: D,
        }

        impl<P, D> AutoscalingClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
        ...
        impl<P, D> Autoscaling for AutoscalingClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
        ...
        fn test_parse_error_autoscaling_delete_policy() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/error", "autoscaling-delete-policy.xml");
        ...
        fn test_parse_valid_autoscaling_describe_metric_collection_types() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/valid", "autoscaling-describe-metric-collection-types.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = AutoscalingClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_valid_autoscaling_describe_notification_configurations() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/valid", "autoscaling-describe-notification-configurations.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = AutoscalingClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_valid_autoscaling_describe_scaling_activities() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/valid", "autoscaling-describe-scaling-activities.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = AutoscalingClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_valid_autoscaling_describe_tags() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/valid", "autoscaling-describe-tags.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = AutoscalingClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
