...
pub album_art_format: Option<JpgOrPng>,
...
pub input_key: Option<WatermarkKey>,
...
pub max_height: Option<DigitsOrAuto>,
...
pub max_width: Option<DigitsOrAuto>,
...
pub type Artworks = Vec<Artwork>;
pub type Ascending = String;
pub type AspectRatio = String;
pub type AudioBitDepth = String;
pub type AudioBitOrder = String;
pub type AudioBitRate = String;
pub type AudioChannels = String;
...
pub bit_order: Option<AudioBitOrder>,
...
pub profile: Option<AudioCodecProfile>,
...
#[serde(rename="Signed")]
pub signed: Option<AudioSigned>,
            }
            
pub type AudioCodecProfile = String;
pub type AudioPackingMode = String;
...
pub audio_packing_mode: Option<AudioPackingMode>,
...
pub bit_rate: Option<AudioBitRate>,
...
pub sample_rate: Option<AudioSampleRate>,
            }
            
pub type AudioSampleRate = String;
pub type AudioSigned = String;
pub type Base64EncodedString = String;
...
#[serde(rename="Format")]
pub format: Option<CaptionFormatFormat>,
...
pub pattern: Option<CaptionFormatPattern>,
            }
            
pub type CaptionFormatFormat = String;
pub type CaptionFormatPattern = String;
pub type CaptionFormats = Vec<CaptionFormat>;
pub type CaptionMergePolicy = String;
...
pub type CaptionSources = Vec<CaptionSource>;
...
pub caption_formats: Option<CaptionFormats>,
            }
...
pub type CodecOption = String;
pub type CodecOptions = ::std::collections::HashMap<CodecOption, CodecOption>;
pub type Composition = Vec<Clip>;
...
pub segment_duration: Option<FloatString>,
...
pub thumbnail_pattern: Option<ThumbnailPattern>,
...
pub watermarks: Option<JobWatermarks>,
            }
            
pub type CreateJobOutputs = Vec<CreateJobOutput>;
...
pub type CreateJobPlaylists = Vec<CreateJobPlaylist>;
...
pub output_key_prefix: Option<Key>,
...
pub outputs: Option<CreateJobOutputs>,
...
pub playlists: Option<CreateJobPlaylists>,
...
pub aws_kms_key_arn: Option<KeyArn>,
...
pub output_bucket: Option<BucketName>,
...
pub initialization_vector: Option<ZeroTo255String>,
...
#[serde(rename="Key")]
pub key: Option<Base64EncodedString>,
...
#[serde(rename="KeyMd5")]
pub key_md_5: Option<Base64EncodedString>,
...
pub type EncryptionMode = String;
pub type ExceptionMessages = Vec<String>;
pub type Filename = String;
pub type FixedGOP = String;
pub type FloatString = String;
pub type FrameRate = String;
pub type Grantee = String;
...
pub key_storage_policy: Option<KeyStoragePolicy>,
...
pub license_acquisition_url: Option<ZeroTo512String>,
...
#[serde(rename="Method")]
pub method: Option<HlsContentProtectionMethod>,
            }
            
pub type HlsContentProtectionMethod = String;
pub type HorizontalAlign = String;
pub type Id = String;
#[doc="<p>The captions to be created, if any.</p>"]
#[derive(Default,Debug,Clone,Serialize,Deserialize)]
...
pub caption_sources: Option<CaptionSources>,
...
pub merge_policy: Option<CaptionMergePolicy>,
            }
            
pub type Interlaced = String;
#[doc="<p>A section of the response body that provides information about the job that is created.</p>"]
#[derive(Default,Debug,Clone,Deserialize)]
            pub struct Job {
...
pub interlaced: Option<Interlaced>,
...
pub type JobInputs = Vec<JobInput>;
...
pub duration: Option<NullableLong>,
...
pub status_detail: Option<Description>,
#[doc="<p>The encryption settings, if any, that you want Elastic Transcoder to apply to your thumbnail.</p>"]
#[serde(rename="ThumbnailEncryption")]
pub thumbnail_encryption: Option<Encryption>,
#[doc="<p>Whether you want Elastic Transcoder to create thumbnails for your videos and, if so, how you want Elastic Transcoder to name the files.</p> <p>If you don't want Elastic Transcoder to create thumbnails, specify \"\".</p> <p>If you do want Elastic Transcoder to create thumbnails, specify the information that you want to include in the file name for each thumbnail. You can specify the following values in any sequence:</p> <ul> <li> <p> <b> <code>{count}</code> (Required)</b>: If you want to create thumbnails, you must include <code>{count}</code> in the <code>ThumbnailPattern</code> object. Wherever you specify <code>{count}</code>, Elastic Transcoder adds a five-digit sequence number (beginning with <b>00001</b>) to thumbnail file names. The number indicates where a given thumbnail appears in the sequence of thumbnails for a transcoded file. </p> <important> <p>If you specify a literal value and/or <code>{resolution}</code> but you omit <code>{count}</code>, Elastic Transcoder returns a validation error and does not create the job.</p> </important> </li> <li> <p> <b>Literal values (Optional)</b>: You can specify literal values anywhere in the <code>ThumbnailPattern</code> object. For example, you can include them as a file name prefix or as a delimiter between <code>{resolution}</code> and <code>{count}</code>. </p> </li> <li> <p> <b> <code>{resolution}</code> (Optional)</b>: If you want Elastic Transcoder to include the resolution in the file name, include <code>{resolution}</code> in the <code>ThumbnailPattern</code> object. </p> </li> </ul> <p>When creating thumbnails, Elastic Transcoder automatically saves the files in the format (.jpg or .png) that appears in the preset that you specified in the <code>PresetID</code> value of <code>CreateJobOutput</code>. Elastic Transcoder also appends the applicable file name extension.</p>"]
...
pub type JobOutputs = Vec<JobOutput>;
...
pub preset_watermark_id: Option<PresetWatermarkId>,
            }
            
pub type JobWatermarks = Vec<JobWatermark>;
pub type Jobs = Vec<Job>;
pub type JpgOrPng = String;
pub type Key = String;
pub type KeyArn = String;
pub type KeyIdGuid = String;
pub type KeyStoragePolicy = String;
pub type KeyframesMaxDist = String;
...
pub type LongKey = String;
pub type MaxFrameRate = String;
pub type MergePolicy = String;
pub type Name = String;
pub type NonEmptyBase64EncodedString = String;
...
pub progressing: Option<SnsTopic>,
#[doc="<p>The Amazon SNS topic that you want to notify when Elastic Transcoder encounters a warning condition.</p>"]
#[serde(rename="Warning")]
pub warning: Option<SnsTopic>,
            }
            
pub type NullableInteger = i64;
pub type NullableLong = i64;
pub type OneTo512String = String;
pub type Opacity = String;
pub type OutputKeys = Vec<Key>;
pub type PaddingPolicy = String;
...
#[serde(rename="Access")]
pub access: Option<AccessControls>,
...
#[serde(rename="InputBucket")]
pub input_bucket: Option<BucketName>,
#[doc="<p>The name of the pipeline. We recommend that the name be unique within the AWS account, but uniqueness is not enforced.</p> <p>Constraints: Maximum 40 characters</p>"]
#[serde(rename="Name")]
...
pub type PipelineStatus = String;
pub type Pipelines = Vec<Pipeline>;
pub type PixelsOrPercent = String;
...
#[serde(rename="Format")]
pub format: Option<PlayReadyDrmFormatString>,
...
#[serde(rename="Key")]
pub key: Option<NonEmptyBase64EncodedString>,
...
#[serde(rename="KeyMd5")]
pub key_md_5: Option<NonEmptyBase64EncodedString>,
...
#[serde(rename="LicenseAcquisitionUrl")]
pub license_acquisition_url: Option<OneTo512String>,
            }
            
pub type PlayReadyDrmFormatString = String;
...
pub type PlaylistFormat = String;
...
pub type PresetContainer = String;
pub type PresetType = String;
...
#[serde(rename="MaxHeight")]
pub max_height: Option<PixelsOrPercent>,
...
#[serde(rename="MaxWidth")]
pub max_width: Option<PixelsOrPercent>,
...
#[serde(rename="SizingPolicy")]
pub sizing_policy: Option<WatermarkSizingPolicy>,
...
pub vertical_offset: Option<PixelsOrPercent>,
            }
            
pub type PresetWatermarkId = String;
pub type PresetWatermarks = Vec<PresetWatermark>;
...
pub type Rotate = String;
pub type SizingPolicy = String;
pub type SnsTopic = String;
pub type SnsTopics = Vec<SnsTopic>;
pub type StorageClass = String;
pub type Success = String;
...
pub type ThumbnailPattern = String;
pub type ThumbnailResolution = String;
...
pub type UserMetadata = ::std::collections::HashMap<String, String>;
pub type VerticalAlign = String;
pub type VideoBitRate = String;
...
pub display_aspect_ratio: Option<AspectRatio>,
...
pub keyframes_max_dist: Option<KeyframesMaxDist>,
...
pub max_frame_rate: Option<MaxFrameRate>,
...
#[doc="<p>Settings for the size, location, and opacity of graphics that you want Elastic Transcoder to overlay over videos that are transcoded using this preset. You can specify settings for up to four watermarks. Watermarks appear in the specified size and location, and with the specified opacity for the duration of the transcoded video.</p> <p>Watermarks can be in .png or .jpg format. If you want to display a watermark that is not rectangular, use the .png format, which supports transparency.</p> <p>When you create a job that uses this preset, you specify the .png or .jpg graphics that you want Elastic Transcoder to include in the transcoded videos. You can specify fewer graphics in the job than you specify watermark settings in the preset, which allows you to use the same preset for up to four watermarks that have different dimensions.</p>"]
#[serde(rename="Watermarks")]
pub watermarks: Option<PresetWatermarks>,
            }
...
pub type WatermarkKey = String;
pub type WatermarkSizingPolicy = String;
pub type ZeroTo255String = String;
pub type ZeroTo512String = String;
...
/// A client for the Amazon Elastic Transcoder API.
        pub struct EtsClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            credentials_provider: P,
            region: region::Region,
            dispatcher: D,
        }

        impl<P, D> EtsClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
        ...
        impl<P, D> Ets for EtsClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
                ...
                fn cancel_job(&self, input: &CancelJobRequest) -> Box<Future<Item = CancelJobResponse, Error = CancelJobError>> {
                    ...
                    let mut request = SignedRequest::new("DELETE", "elastictranscoder", self.region, &request_uri);
                ...
                fn create_job(&self, input: &CreateJobRequest) -> Box<Future<Item = CreateJobResponse, Error = CreateJobError>> {
                    ...
                    let mut request = SignedRequest::new("POST", "elastictranscoder", self.region, &request_uri);
                    request.set_content_type("application/x-amz-json-1.1".to_owned());
