...
/// Trait representing the capabilities of the Amazon SQS API. Amazon SQS clients implement this trait.
        pub trait Sqs {
                ...
                fn add_permission(&self, input: &AddPermissionRequest) -> Box<Future<Item = (), Error = AddPermissionError>>;
                ...
                fn change_message_visibility(&self, input: &ChangeMessageVisibilityRequest) -> Box<Future<Item = (), Error = ChangeMessageVisibilityError>>;
                ...
                fn change_message_visibility_batch(&self, input: &ChangeMessageVisibilityBatchRequest) -> Box<Future<Item = ChangeMessageVisibilityBatchResult, Error = ChangeMessageVisibilityBatchError>>;
                ...
                fn create_queue(&self, input: &CreateQueueRequest) -> Box<Future<Item = CreateQueueResult, Error = CreateQueueError>>;
                ...
                fn delete_message(&self, input: &DeleteMessageRequest) -> Box<Future<Item = (), Error = DeleteMessageError>>;
                ...
                fn delete_message_batch(&self, input: &DeleteMessageBatchRequest) -> Box<Future<Item = DeleteMessageBatchResult, Error = DeleteMessageBatchError>>;
                ...
                fn delete_queue(&self, input: &DeleteQueueRequest) -> Box<Future<Item = (), Error = DeleteQueueError>>;
                ...
                fn get_queue_attributes(&self, input: &GetQueueAttributesRequest) -> Box<Future<Item = GetQueueAttributesResult, Error = GetQueueAttributesError>>;
                ...
                fn get_queue_url(&self, input: &GetQueueUrlRequest) -> Box<Future<Item = GetQueueUrlResult, Error = GetQueueUrlError>>;
                ...
                fn list_dead_letter_source_queues(&self, input: &ListDeadLetterSourceQueuesRequest) -> Box<Future<Item = ListDeadLetterSourceQueuesResult, Error = ListDeadLetterSourceQueuesError>>;
                ...
                fn list_queues(&self, input: &ListQueuesRequest) -> Box<Future<Item = ListQueuesResult, Error = ListQueuesError>>;
                ...
                fn purge_queue(&self, input: &PurgeQueueRequest) -> Box<Future<Item = (), Error = PurgeQueueError>>;
                ...
                fn receive_message(&self, input: &ReceiveMessageRequest) -> Box<Future<Item = ReceiveMessageResult, Error = ReceiveMessageError>>;
                ...
                fn send_message(&self, input: &SendMessageRequest) -> Box<Future<Item = SendMessageResult, Error = SendMessageError>>;
                ...
                fn send_message_batch(&self, input: &SendMessageBatchRequest) -> Box<Future<Item = SendMessageBatchResult, Error = SendMessageBatchError>>;
                ...
                fn set_queue_attributes(&self, input: &SetQueueAttributesRequest) -> Box<Future<Item = (), Error = SetQueueAttributesError>>;
...
/// A client for the Amazon SQS API.
        ...
        impl<P, D> Sqs for SqsClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
                ...
                fn change_message_visibility(&self, input: &ChangeMessageVisibilityRequest) -> Box<Future<Item = (), Error = ChangeMessageVisibilityError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(ChangeMessageVisibilityError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| ChangeMessageVisibilityError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    let result = ();
                                ...
                                _ => future::err(ChangeMessageVisibilityError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn change_message_visibility_batch(&self, input: &ChangeMessageVisibilityBatchRequest) -> Box<Future<Item = ChangeMessageVisibilityBatchResult, Error = ChangeMessageVisibilityBatchError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(ChangeMessageVisibilityBatchError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| ChangeMessageVisibilityBatchError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(ChangeMessageVisibilityBatchResultDeserializer::deserialize("ChangeMessageVisibilityBatchResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(ChangeMessageVisibilityBatchError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn create_queue(&self, input: &CreateQueueRequest) -> Box<Future<Item = CreateQueueResult, Error = CreateQueueError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(CreateQueueError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| CreateQueueError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(CreateQueueResultDeserializer::deserialize("CreateQueueResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(CreateQueueError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn delete_message(&self, input: &DeleteMessageRequest) -> Box<Future<Item = (), Error = DeleteMessageError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DeleteMessageError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DeleteMessageError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    let result = ();
                                ...
                                _ => future::err(DeleteMessageError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn delete_message_batch(&self, input: &DeleteMessageBatchRequest) -> Box<Future<Item = DeleteMessageBatchResult, Error = DeleteMessageBatchError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DeleteMessageBatchError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DeleteMessageBatchError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(DeleteMessageBatchResultDeserializer::deserialize("DeleteMessageBatchResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(DeleteMessageBatchError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn delete_queue(&self, input: &DeleteQueueRequest) -> Box<Future<Item = (), Error = DeleteQueueError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(DeleteQueueError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| DeleteQueueError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    let result = ();
                                ...
                                _ => future::err(DeleteQueueError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn get_queue_attributes(&self, input: &GetQueueAttributesRequest) -> Box<Future<Item = GetQueueAttributesResult, Error = GetQueueAttributesError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(GetQueueAttributesError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| GetQueueAttributesError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(GetQueueAttributesResultDeserializer::deserialize("GetQueueAttributesResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(GetQueueAttributesError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn get_queue_url(&self, input: &GetQueueUrlRequest) -> Box<Future<Item = GetQueueUrlResult, Error = GetQueueUrlError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(GetQueueUrlError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| GetQueueUrlError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(GetQueueUrlResultDeserializer::deserialize("GetQueueUrlResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(GetQueueUrlError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn list_dead_letter_source_queues(&self, input: &ListDeadLetterSourceQueuesRequest) -> Box<Future<Item = ListDeadLetterSourceQueuesResult, Error = ListDeadLetterSourceQueuesError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(ListDeadLetterSourceQueuesError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| ListDeadLetterSourceQueuesError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(ListDeadLetterSourceQueuesResultDeserializer::deserialize("ListDeadLetterSourceQueuesResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(ListDeadLetterSourceQueuesError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn list_queues(&self, input: &ListQueuesRequest) -> Box<Future<Item = ListQueuesResult, Error = ListQueuesError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(ListQueuesError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| ListQueuesError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(ListQueuesResultDeserializer::deserialize("ListQueuesResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(ListQueuesError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn purge_queue(&self, input: &PurgeQueueRequest) -> Box<Future<Item = (), Error = PurgeQueueError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(PurgeQueueError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| PurgeQueueError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    let result = ();
                                ...
                                _ => future::err(PurgeQueueError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn receive_message(&self, input: &ReceiveMessageRequest) -> Box<Future<Item = ReceiveMessageResult, Error = ReceiveMessageError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(ReceiveMessageError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| ReceiveMessageError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(ReceiveMessageResultDeserializer::deserialize("ReceiveMessageResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(ReceiveMessageError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn send_message(&self, input: &SendMessageRequest) -> Box<Future<Item = SendMessageResult, Error = SendMessageError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(SendMessageError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| SendMessageError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(SendMessageResultDeserializer::deserialize("SendMessageResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(SendMessageError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn send_message_batch(&self, input: &SendMessageBatchRequest) -> Box<Future<Item = SendMessageBatchResult, Error = SendMessageBatchError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(SendMessageBatchError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| SendMessageBatchError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
        ...
        if response.body.is_empty() {
            ...
            let actual_tag_name = try_future!(peek_at_name(&mut stack));
            try_future!(start_element(&actual_tag_name, &mut stack));
                     result = try_future!(SendMessageBatchResultDeserializer::deserialize("SendMessageBatchResult", &mut stack));
                     skip_tree(&mut stack);
                     try_future!(end_element(&actual_tag_name, &mut stack));
        }
                                    future::ok(result)
                                }
                                _ => future::err(SendMessageBatchError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
                ...
                fn set_queue_attributes(&self, input: &SetQueueAttributesRequest) -> Box<Future<Item = (), Error = SetQueueAttributesError>> {
                    ...
                    let credentials = match self.credentials_provider.credentials() {
                        Ok(c) => c,
                        Err(err) => return Box::new(future::err(SetQueueAttributesError::from(err)))
                    };

                    request.sign(&credentials);

                    let res = self.dispatcher.dispatch(&request)
                        .map_err(|dispatch_err| SetQueueAttributesError::from(dispatch_err))
                        .and_then(
                            |response| match response.status {
                                StatusCode::Ok => {
                                    let result = ();
                                ...
                                _ => future::err(SetQueueAttributesError::from_body(String::from_utf8_lossy(&response.body).as_ref()))
                            }
                        );
