        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Options" => {
                obj.options = try!(PolicyDocumentDeserializer::deserialize("Options", stack));
            }
"Status" => {
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AlgorithmicStemming" => {
                obj.algorithmic_stemming = Some(try!(AlgorithmicStemmingDeserializer::deserialize("AlgorithmicStemming", stack)));
            }
"JapaneseTokenizationDictionary" => {
                obj.japanese_tokenization_dictionary = Some(try!(StringDeserializer::deserialize("JapaneseTokenizationDictionary", stack)));
            }
"StemmingDictionary" => {
                obj.stemming_dictionary = Some(try!(StringDeserializer::deserialize("StemmingDictionary", stack)));
            }
"Stopwords" => {
                obj.stopwords = Some(try!(StringDeserializer::deserialize("Stopwords", stack)));
            }
"Synonyms" => {
                obj.synonyms = Some(try!(StringDeserializer::deserialize("Synonyms", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        if let Some(ref field_value) = obj.algorithmic_stemming {
                params.put(&format!("{}{}", prefix, "AlgorithmicStemming"), &field_value);
            }
if let Some(ref field_value) = obj.japanese_tokenization_dictionary {
                params.put(&format!("{}{}", prefix, "JapaneseTokenizationDictionary"), &field_value);
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AnalysisOptions" => {
                obj.analysis_options = Some(try!(AnalysisOptionsDeserializer::deserialize("AnalysisOptions", stack)));
            }
"AnalysisSchemeLanguage" => {
                obj.analysis_scheme_language = try!(AnalysisSchemeLanguageDeserializer::deserialize("AnalysisSchemeLanguage", stack));
            }
"AnalysisSchemeName" => {
                obj.analysis_scheme_name = try!(StandardNameDeserializer::deserialize("AnalysisSchemeName", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
...
params.put(&format!("{}{}", prefix, "AnalysisSchemeLanguage"), &obj.analysis_scheme_language);
params.put(&format!("{}{}", prefix, "AnalysisSchemeName"), &obj.analysis_scheme_name);
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Options" => {
                obj.options = try!(AnalysisSchemeDeserializer::deserialize("Options", stack));
            }
"Status" => {
                obj.status = try!(OptionStatusDeserializer::deserialize("Status", stack));
            }
...
struct AnalysisSchemeStatusListDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(AnalysisSchemeStatusDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "FieldNames" => {
                obj.field_names = Some(try!(FieldNameListDeserializer::deserialize("FieldNames", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "DomainStatus" => {
                obj.domain_status = Some(try!(DomainStatusDeserializer::deserialize("DomainStatus", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "DefaultValue" => {
                obj.default_value = Some(try!(FieldValueDeserializer::deserialize("DefaultValue", stack)));
            }
"FacetEnabled" => {
                obj.facet_enabled = Some(try!(BooleanDeserializer::deserialize("FacetEnabled", stack)));
            }
"ReturnEnabled" => {
                obj.return_enabled = Some(try!(BooleanDeserializer::deserialize("ReturnEnabled", stack)));
            }
"SearchEnabled" => {
                obj.search_enabled = Some(try!(BooleanDeserializer::deserialize("SearchEnabled", stack)));
            }
"SourceFields" => {
                obj.source_fields = Some(try!(FieldNameCommaListDeserializer::deserialize("SourceFields", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
if let Some(ref field_value) = obj.facet_enabled {
                params.put(&format!("{}{}", prefix, "FacetEnabled"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.return_enabled {
                params.put(&format!("{}{}", prefix, "ReturnEnabled"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.search_enabled {
                params.put(&format!("{}{}", prefix, "SearchEnabled"), &field_value.to_string());
            }
...
"SortEnabled" => {
                obj.sort_enabled = Some(try!(BooleanDeserializer::deserialize("SortEnabled", stack)));
            }
"SourceField" => {
                obj.source_field = Some(try!(FieldNameDeserializer::deserialize("SourceField", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
if let Some(ref field_value) = obj.sort_enabled {
                params.put(&format!("{}{}", prefix, "SortEnabled"), &field_value.to_string());
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AnalysisScheme" => {
                obj.analysis_scheme = try!(AnalysisSchemeStatusDeserializer::deserialize("AnalysisScheme", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Expression" => {
                obj.expression = try!(ExpressionStatusDeserializer::deserialize("Expression", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "IndexField" => {
                obj.index_field = try!(IndexFieldStatusDeserializer::deserialize("IndexField", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Suggester" => {
                obj.suggester = try!(SuggesterStatusDeserializer::deserialize("Suggester", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub expression_name: StandardName,
        ...
        params.put(&format!("{}{}", prefix, "DomainName"), &obj.domain_name);
params.put(&format!("{}{}", prefix, "ExpressionName"), &obj.expression_name);
...
pub index_field_name: DynamicFieldName,
        ...
        params.put(&format!("{}{}", prefix, "DomainName"), &obj.domain_name);
params.put(&format!("{}{}", prefix, "IndexFieldName"), &obj.index_field_name);
...
pub suggester_name: StandardName,
        ...
        params.put(&format!("{}{}", prefix, "DomainName"), &obj.domain_name);
params.put(&format!("{}{}", prefix, "SuggesterName"), &obj.suggester_name);
...
if let Some(ref field_value) = obj.deployed {
                params.put(&format!("{}{}", prefix, "Deployed"), &field_value.to_string());
            }
params.put(&format!("{}{}", prefix, "DomainName"), &obj.domain_name);
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AnalysisSchemes" => {
                obj.analysis_schemes = try!(AnalysisSchemeStatusListDeserializer::deserialize("AnalysisSchemes", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "DomainStatusList" => {
                obj.domain_status_list = try!(DomainStatusListDeserializer::deserialize("DomainStatusList", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Expressions" => {
                obj.expressions = try!(ExpressionStatusListDeserializer::deserialize("Expressions", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "IndexFields" => {
                obj.index_fields = try!(IndexFieldStatusListDeserializer::deserialize("IndexFields", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ScalingParameters" => {
                obj.scaling_parameters = try!(ScalingParametersStatusDeserializer::deserialize("ScalingParameters", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AccessPolicies" => {
                obj.access_policies = try!(AccessPoliciesStatusDeserializer::deserialize("AccessPolicies", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Suggesters" => {
                obj.suggesters = try!(SuggesterStatusListDeserializer::deserialize("Suggesters", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "FuzzyMatching" => {
                obj.fuzzy_matching = Some(try!(SuggesterFuzzyMatchingDeserializer::deserialize("FuzzyMatching", stack)));
            }
"SortExpression" => {
                obj.sort_expression = Some(try!(StringDeserializer::deserialize("SortExpression", stack)));
            }
"SourceField" => {
                obj.source_field = try!(FieldNameDeserializer::deserialize("SourceField", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"Created" => {
                obj.created = Some(try!(BooleanDeserializer::deserialize("Created", stack)));
            }
"Deleted" => {
                obj.deleted = Some(try!(BooleanDeserializer::deserialize("Deleted", stack)));
            }
"DocService" => {
                obj.doc_service = Some(try!(ServiceEndpointDeserializer::deserialize("DocService", stack)));
            }
"DomainId" => {
                obj.domain_id = try!(DomainIdDeserializer::deserialize("DomainId", stack));
            }
"DomainName" => {
                obj.domain_name = try!(DomainNameDeserializer::deserialize("DomainName", stack));
            }
"Limits" => {
                obj.limits = Some(try!(LimitsDeserializer::deserialize("Limits", stack)));
            }
"Processing" => {
                obj.processing = Some(try!(BooleanDeserializer::deserialize("Processing", stack)));
            }
"RequiresIndexDocuments" => {
                obj.requires_index_documents = try!(BooleanDeserializer::deserialize("RequiresIndexDocuments", stack));
            }
"SearchInstanceCount" => {
                obj.search_instance_count = Some(try!(InstanceCountDeserializer::deserialize("SearchInstanceCount", stack)));
            }
"SearchInstanceType" => {
                obj.search_instance_type = Some(try!(SearchInstanceTypeDeserializer::deserialize("SearchInstanceType", stack)));
            }
"SearchPartitionCount" => {
                obj.search_partition_count = Some(try!(PartitionCountDeserializer::deserialize("SearchPartitionCount", stack)));
            }
"SearchService" => {
                obj.search_service = Some(try!(ServiceEndpointDeserializer::deserialize("SearchService", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "DefaultValue" => {
                obj.default_value = Some(try!(DoubleDeserializer::deserialize("DefaultValue", stack)));
            }
"FacetEnabled" => {
                obj.facet_enabled = Some(try!(BooleanDeserializer::deserialize("FacetEnabled", stack)));
            }
...
"SourceFields" => {
        ...
        if let Some(ref field_value) = obj.default_value {
                params.put(&format!("{}{}", prefix, "DefaultValue"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.facet_enabled {
                params.put(&format!("{}{}", prefix, "FacetEnabled"), &field_value.to_string());
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ExpressionName" => {
                obj.expression_name = try!(StandardNameDeserializer::deserialize("ExpressionName", stack));
            }
"ExpressionValue" => {
                obj.expression_value = try!(ExpressionValueDeserializer::deserialize("ExpressionValue", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        params.put(&format!("{}{}", prefix, "ExpressionName"), &obj.expression_name);
params.put(&format!("{}{}", prefix, "ExpressionValue"), &obj.expression_value);
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "DateArrayOptions" => {
                obj.date_array_options = Some(try!(DateArrayOptionsDeserializer::deserialize("DateArrayOptions", stack)));
            }
"DateOptions" => {
                obj.date_options = Some(try!(DateOptionsDeserializer::deserialize("DateOptions", stack)));
            }
"DoubleArrayOptions" => {
                obj.double_array_options = Some(try!(DoubleArrayOptionsDeserializer::deserialize("DoubleArrayOptions", stack)));
            }
"DoubleOptions" => {
                obj.double_options = Some(try!(DoubleOptionsDeserializer::deserialize("DoubleOptions", stack)));
            }
"IndexFieldName" => {
                obj.index_field_name = try!(DynamicFieldNameDeserializer::deserialize("IndexFieldName", stack));
            }
"IndexFieldType" => {
                obj.index_field_type = try!(IndexFieldTypeDeserializer::deserialize("IndexFieldType", stack));
            }
"IntArrayOptions" => {
                obj.int_array_options = Some(try!(IntArrayOptionsDeserializer::deserialize("IntArrayOptions", stack)));
            }
"IntOptions" => {
                obj.int_options = Some(try!(IntOptionsDeserializer::deserialize("IntOptions", stack)));
            }
"LatLonOptions" => {
                obj.lat_lon_options = Some(try!(LatLonOptionsDeserializer::deserialize("LatLonOptions", stack)));
            }
"LiteralArrayOptions" => {
                obj.literal_array_options = Some(try!(LiteralArrayOptionsDeserializer::deserialize("LiteralArrayOptions", stack)));
            }
"LiteralOptions" => {
                obj.literal_options = Some(try!(LiteralOptionsDeserializer::deserialize("LiteralOptions", stack)));
            }
"TextArrayOptions" => {
                obj.text_array_options = Some(try!(TextArrayOptionsDeserializer::deserialize("TextArrayOptions", stack)));
            }
"TextOptions" => {
                obj.text_options = Some(try!(TextOptionsDeserializer::deserialize("TextOptions", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
params.put(&format!("{}{}", prefix, "IndexFieldName"), &obj.index_field_name);
params.put(&format!("{}{}", prefix, "IndexFieldType"), &obj.index_field_type);
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "DefaultValue" => {
                obj.default_value = Some(try!(LongDeserializer::deserialize("DefaultValue", stack)));
            }
"FacetEnabled" => {
                obj.facet_enabled = Some(try!(BooleanDeserializer::deserialize("FacetEnabled", stack)));
            }
...
struct LimitsDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.maximum_partition_count = try!(MaximumPartitionCountDeserializer::deserialize("MaximumPartitionCount", stack));
            }
"MaximumReplicationCount" => {
                obj.maximum_replication_count = try!(MaximumReplicationCountDeserializer::deserialize("MaximumReplicationCount", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "DomainNames" => {
                obj.domain_names = Some(try!(DomainNameMapDeserializer::deserialize("DomainNames", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "CreationDate" => {
                obj.creation_date = try!(UpdateTimestampDeserializer::deserialize("CreationDate", stack));
            }
"PendingDeletion" => {
                obj.pending_deletion = Some(try!(BooleanDeserializer::deserialize("PendingDeletion", stack)));
            }
"State" => {
                obj.state = try!(OptionStateDeserializer::deserialize("State", stack));
            }
"UpdateDate" => {
                obj.update_date = try!(UpdateTimestampDeserializer::deserialize("UpdateDate", stack));
            }
"UpdateVersion" => {
                obj.update_version = Some(try!(UIntValueDeserializer::deserialize("UpdateVersion", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "DesiredInstanceType" => {
                obj.desired_instance_type = Some(try!(PartitionInstanceTypeDeserializer::deserialize("DesiredInstanceType", stack)));
            }
"DesiredPartitionCount" => {
                obj.desired_partition_count = Some(try!(UIntValueDeserializer::deserialize("DesiredPartitionCount", stack)));
            }
"DesiredReplicationCount" => {
                obj.desired_replication_count = Some(try!(UIntValueDeserializer::deserialize("DesiredReplicationCount", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        if let Some(ref field_value) = obj.desired_instance_type {
                params.put(&format!("{}{}", prefix, "DesiredInstanceType"), &field_value);
            }
if let Some(ref field_value) = obj.desired_partition_count {
                params.put(&format!("{}{}", prefix, "DesiredPartitionCount"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.desired_replication_count {
                params.put(&format!("{}{}", prefix, "DesiredReplicationCount"), &field_value.to_string());
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Options" => {
                obj.options = try!(ScalingParametersDeserializer::deserialize("Options", stack));
            }
"Status" => {
                obj.status = try!(OptionStatusDeserializer::deserialize("Status", stack));
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Endpoint" => {
                obj.endpoint = Some(try!(ServiceUrlDeserializer::deserialize("Endpoint", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct SuggesterDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.document_suggester_options = try!(DocumentSuggesterOptionsDeserializer::deserialize("DocumentSuggesterOptions", stack));
            }
"SuggesterName" => {
                obj.suggester_name = try!(StandardNameDeserializer::deserialize("SuggesterName", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AnalysisScheme" => {
                obj.analysis_scheme = Some(try!(WordDeserializer::deserialize("AnalysisScheme", stack)));
            }
"DefaultValue" => {
                obj.default_value = Some(try!(FieldValueDeserializer::deserialize("DefaultValue", stack)));
            }
"HighlightEnabled" => {
                obj.highlight_enabled = Some(try!(BooleanDeserializer::deserialize("HighlightEnabled", stack)));
            }
"ReturnEnabled" => {
                obj.return_enabled = Some(try!(BooleanDeserializer::deserialize("ReturnEnabled", stack)));
            }
...
if let Some(ref field_value) = obj.highlight_enabled {
                params.put(&format!("{}{}", prefix, "HighlightEnabled"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.return_enabled {
                params.put(&format!("{}{}", prefix, "ReturnEnabled"), &field_value.to_string());
            }
...
pub multi_az: Boolean,
        ...
        params.put(&format!("{}{}", prefix, "DomainName"), &obj.domain_name);
params.put(&format!("{}{}", prefix, "MultiAZ"), &obj.multi_az.to_string());
...
pub domain_name: DomainName,
        ...
        params.put(&format!("{}{}", prefix, "AccessPolicies"), &obj.access_policies);
params.put(&format!("{}{}", prefix, "DomainName"), &obj.domain_name);
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => BuildSuggestersError::Base(String::from(parsed_error.message)),"InternalException" => BuildSuggestersError::Internal(String::from(parsed_error.message)),"ResourceNotFoundException" => BuildSuggestersError::ResourceNotFound(String::from(parsed_error.message)),_ => BuildSuggestersError::Unknown(String::from(body))
                                }
                           },
                ...
                impl CreateDomainError {
                    pub fn from_body(body: &str) -> CreateDomainError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => CreateDomainError::Base(String::from(parsed_error.message)),"InternalException" => CreateDomainError::Internal(String::from(parsed_error.message)),"LimitExceededException" => CreateDomainError::LimitExceeded(String::from(parsed_error.message)),_ => CreateDomainError::Unknown(String::from(body))
                                }
                           },
...
InvalidType(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl DefineAnalysisSchemeError {
                    pub fn from_body(body: &str) -> DefineAnalysisSchemeError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => DefineAnalysisSchemeError::Base(String::from(parsed_error.message)),"InternalException" => DefineAnalysisSchemeError::Internal(String::from(parsed_error.message)),"LimitExceededException" => DefineAnalysisSchemeError::LimitExceeded(String::from(parsed_error.message)),"ResourceNotFoundException" => DefineAnalysisSchemeError::ResourceNotFound(String::from(parsed_error.message)),"InvalidTypeException" => DefineAnalysisSchemeError::InvalidType(String::from(parsed_error.message)),_ => DefineAnalysisSchemeError::Unknown(String::from(body))
                                }
                           },
...
DefineAnalysisSchemeError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                ...
                impl DefineExpressionError {
                    pub fn from_body(body: &str) -> DefineExpressionError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => DefineExpressionError::Base(String::from(parsed_error.message)),"InternalException" => DefineExpressionError::Internal(String::from(parsed_error.message)),"LimitExceededException" => DefineExpressionError::LimitExceeded(String::from(parsed_error.message)),"ResourceNotFoundException" => DefineExpressionError::ResourceNotFound(String::from(parsed_error.message)),"InvalidTypeException" => DefineExpressionError::InvalidType(String::from(parsed_error.message)),_ => DefineExpressionError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DefineIndexFieldError {
                    pub fn from_body(body: &str) -> DefineIndexFieldError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => DefineIndexFieldError::Base(String::from(parsed_error.message)),"InternalException" => DefineIndexFieldError::Internal(String::from(parsed_error.message)),"LimitExceededException" => DefineIndexFieldError::LimitExceeded(String::from(parsed_error.message)),"ResourceNotFoundException" => DefineIndexFieldError::ResourceNotFound(String::from(parsed_error.message)),"InvalidTypeException" => DefineIndexFieldError::InvalidType(String::from(parsed_error.message)),_ => DefineIndexFieldError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DefineSuggesterError {
                    pub fn from_body(body: &str) -> DefineSuggesterError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => DefineSuggesterError::Base(String::from(parsed_error.message)),"InternalException" => DefineSuggesterError::Internal(String::from(parsed_error.message)),"LimitExceededException" => DefineSuggesterError::LimitExceeded(String::from(parsed_error.message)),"ResourceNotFoundException" => DefineSuggesterError::ResourceNotFound(String::from(parsed_error.message)),"InvalidTypeException" => DefineSuggesterError::InvalidType(String::from(parsed_error.message)),_ => DefineSuggesterError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DeleteAnalysisSchemeError {
                    pub fn from_body(body: &str) -> DeleteAnalysisSchemeError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => DeleteAnalysisSchemeError::Base(String::from(parsed_error.message)),"InternalException" => DeleteAnalysisSchemeError::Internal(String::from(parsed_error.message)),"ResourceNotFoundException" => DeleteAnalysisSchemeError::ResourceNotFound(String::from(parsed_error.message)),"InvalidTypeException" => DeleteAnalysisSchemeError::InvalidType(String::from(parsed_error.message)),_ => DeleteAnalysisSchemeError::Unknown(String::from(body))
                                }
                           },
...
DeleteAnalysisSchemeError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                ...
                impl DeleteDomainError {
                    pub fn from_body(body: &str) -> DeleteDomainError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => DeleteDomainError::Base(String::from(parsed_error.message)),"InternalException" => DeleteDomainError::Internal(String::from(parsed_error.message)),_ => DeleteDomainError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DeleteExpressionError {
                    pub fn from_body(body: &str) -> DeleteExpressionError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => DeleteExpressionError::Base(String::from(parsed_error.message)),"InternalException" => DeleteExpressionError::Internal(String::from(parsed_error.message)),"ResourceNotFoundException" => DeleteExpressionError::ResourceNotFound(String::from(parsed_error.message)),"InvalidTypeException" => DeleteExpressionError::InvalidType(String::from(parsed_error.message)),_ => DeleteExpressionError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DeleteIndexFieldError {
                    pub fn from_body(body: &str) -> DeleteIndexFieldError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => DeleteIndexFieldError::Base(String::from(parsed_error.message)),"InternalException" => DeleteIndexFieldError::Internal(String::from(parsed_error.message)),"ResourceNotFoundException" => DeleteIndexFieldError::ResourceNotFound(String::from(parsed_error.message)),"InvalidTypeException" => DeleteIndexFieldError::InvalidType(String::from(parsed_error.message)),_ => DeleteIndexFieldError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DeleteSuggesterError {
                    pub fn from_body(body: &str) -> DeleteSuggesterError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => DeleteSuggesterError::Base(String::from(parsed_error.message)),"InternalException" => DeleteSuggesterError::Internal(String::from(parsed_error.message)),"ResourceNotFoundException" => DeleteSuggesterError::ResourceNotFound(String::from(parsed_error.message)),"InvalidTypeException" => DeleteSuggesterError::InvalidType(String::from(parsed_error.message)),_ => DeleteSuggesterError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeAnalysisSchemesError {
                    pub fn from_body(body: &str) -> DescribeAnalysisSchemesError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => DescribeAnalysisSchemesError::Base(String::from(parsed_error.message)),"InternalException" => DescribeAnalysisSchemesError::Internal(String::from(parsed_error.message)),"ResourceNotFoundException" => DescribeAnalysisSchemesError::ResourceNotFound(String::from(parsed_error.message)),_ => DescribeAnalysisSchemesError::Unknown(String::from(body))
                                }
                           },
...
DescribeAnalysisSchemesError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                ...
                impl DescribeAvailabilityOptionsError {
                    pub fn from_body(body: &str) -> DescribeAvailabilityOptionsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => DescribeAvailabilityOptionsError::Base(String::from(parsed_error.message)),"InternalException" => DescribeAvailabilityOptionsError::Internal(String::from(parsed_error.message)),"LimitExceededException" => DescribeAvailabilityOptionsError::LimitExceeded(String::from(parsed_error.message)),"DisabledOperationException" => DescribeAvailabilityOptionsError::DisabledOperation(String::from(parsed_error.message)),"ResourceNotFoundException" => DescribeAvailabilityOptionsError::ResourceNotFound(String::from(parsed_error.message)),"InvalidTypeException" => DescribeAvailabilityOptionsError::InvalidType(String::from(parsed_error.message)),_ => DescribeAvailabilityOptionsError::Unknown(String::from(body))
                                }
                           },
...
DescribeAvailabilityOptionsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                ...
                impl DescribeDomainsError {
                    pub fn from_body(body: &str) -> DescribeDomainsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => DescribeDomainsError::Base(String::from(parsed_error.message)),"InternalException" => DescribeDomainsError::Internal(String::from(parsed_error.message)),_ => DescribeDomainsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeExpressionsError {
                    pub fn from_body(body: &str) -> DescribeExpressionsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => DescribeExpressionsError::Base(String::from(parsed_error.message)),"InternalException" => DescribeExpressionsError::Internal(String::from(parsed_error.message)),"ResourceNotFoundException" => DescribeExpressionsError::ResourceNotFound(String::from(parsed_error.message)),_ => DescribeExpressionsError::Unknown(String::from(body))
                                }
                           },
...
DescribeExpressionsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                ...
                impl DescribeIndexFieldsError {
                    pub fn from_body(body: &str) -> DescribeIndexFieldsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => DescribeIndexFieldsError::Base(String::from(parsed_error.message)),"InternalException" => DescribeIndexFieldsError::Internal(String::from(parsed_error.message)),"ResourceNotFoundException" => DescribeIndexFieldsError::ResourceNotFound(String::from(parsed_error.message)),_ => DescribeIndexFieldsError::Unknown(String::from(body))
                                }
                           },
...
DescribeIndexFieldsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                ...
                impl DescribeScalingParametersError {
                    pub fn from_body(body: &str) -> DescribeScalingParametersError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => DescribeScalingParametersError::Base(String::from(parsed_error.message)),"InternalException" => DescribeScalingParametersError::Internal(String::from(parsed_error.message)),"ResourceNotFoundException" => DescribeScalingParametersError::ResourceNotFound(String::from(parsed_error.message)),_ => DescribeScalingParametersError::Unknown(String::from(body))
                                }
                           },
...
DescribeScalingParametersError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                ...
                impl DescribeServiceAccessPoliciesError {
                    pub fn from_body(body: &str) -> DescribeServiceAccessPoliciesError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => DescribeServiceAccessPoliciesError::Base(String::from(parsed_error.message)),"InternalException" => DescribeServiceAccessPoliciesError::Internal(String::from(parsed_error.message)),"ResourceNotFoundException" => DescribeServiceAccessPoliciesError::ResourceNotFound(String::from(parsed_error.message)),_ => DescribeServiceAccessPoliciesError::Unknown(String::from(body))
                                }
                           },
...
DescribeServiceAccessPoliciesError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                ...
                impl DescribeSuggestersError {
                    pub fn from_body(body: &str) -> DescribeSuggestersError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => DescribeSuggestersError::Base(String::from(parsed_error.message)),"InternalException" => DescribeSuggestersError::Internal(String::from(parsed_error.message)),"ResourceNotFoundException" => DescribeSuggestersError::ResourceNotFound(String::from(parsed_error.message)),_ => DescribeSuggestersError::Unknown(String::from(body))
                                }
                           },
...
DescribeSuggestersError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                ...
                impl IndexDocumentsError {
                    pub fn from_body(body: &str) -> IndexDocumentsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => IndexDocumentsError::Base(String::from(parsed_error.message)),"InternalException" => IndexDocumentsError::Internal(String::from(parsed_error.message)),"ResourceNotFoundException" => IndexDocumentsError::ResourceNotFound(String::from(parsed_error.message)),_ => IndexDocumentsError::Unknown(String::from(body))
                                }
                           },
...
///<p>An error occurred while processing the request.</p>
Base(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl ListDomainNamesError {
                    pub fn from_body(body: &str) -> ListDomainNamesError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => ListDomainNamesError::Base(String::from(parsed_error.message)),_ => ListDomainNamesError::Unknown(String::from(body))
                                }
                           },
                ...
                impl UpdateAvailabilityOptionsError {
                    pub fn from_body(body: &str) -> UpdateAvailabilityOptionsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => UpdateAvailabilityOptionsError::Base(String::from(parsed_error.message)),"InternalException" => UpdateAvailabilityOptionsError::Internal(String::from(parsed_error.message)),"LimitExceededException" => UpdateAvailabilityOptionsError::LimitExceeded(String::from(parsed_error.message)),"DisabledOperationException" => UpdateAvailabilityOptionsError::DisabledOperation(String::from(parsed_error.message)),"ResourceNotFoundException" => UpdateAvailabilityOptionsError::ResourceNotFound(String::from(parsed_error.message)),"InvalidTypeException" => UpdateAvailabilityOptionsError::InvalidType(String::from(parsed_error.message)),_ => UpdateAvailabilityOptionsError::Unknown(String::from(body))
                                }
                           },
...
UpdateAvailabilityOptionsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                ...
                impl UpdateScalingParametersError {
                    pub fn from_body(body: &str) -> UpdateScalingParametersError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => UpdateScalingParametersError::Base(String::from(parsed_error.message)),"InternalException" => UpdateScalingParametersError::Internal(String::from(parsed_error.message)),"LimitExceededException" => UpdateScalingParametersError::LimitExceeded(String::from(parsed_error.message)),"ResourceNotFoundException" => UpdateScalingParametersError::ResourceNotFound(String::from(parsed_error.message)),"InvalidTypeException" => UpdateScalingParametersError::InvalidType(String::from(parsed_error.message)),_ => UpdateScalingParametersError::Unknown(String::from(body))
                                }
                           },
...
UpdateScalingParametersError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                ...
                impl UpdateServiceAccessPoliciesError {
                    pub fn from_body(body: &str) -> UpdateServiceAccessPoliciesError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "BaseException" => UpdateServiceAccessPoliciesError::Base(String::from(parsed_error.message)),"InternalException" => UpdateServiceAccessPoliciesError::Internal(String::from(parsed_error.message)),"LimitExceededException" => UpdateServiceAccessPoliciesError::LimitExceeded(String::from(parsed_error.message)),"ResourceNotFoundException" => UpdateServiceAccessPoliciesError::ResourceNotFound(String::from(parsed_error.message)),"InvalidTypeException" => UpdateServiceAccessPoliciesError::InvalidType(String::from(parsed_error.message)),_ => UpdateServiceAccessPoliciesError::Unknown(String::from(body))
                                }
                           },
...
UpdateServiceAccessPoliciesError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
/// A client for the Amazon CloudSearch API.
        pub struct CloudSearchClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            credentials_provider: P,
            region: region::Region,
            dispatcher: D,
        }

        impl<P, D> CloudSearchClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
        ...
        impl<P, D> CloudSearch for CloudSearchClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
