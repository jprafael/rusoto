        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ResourceChange" => {
                obj.resource_change = Some(try!(ResourceChangeDeserializer::deserialize("ResourceChange", stack)));
            }
"Type" => {
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ChangeSetId" => {
                obj.change_set_id = Some(try!(ChangeSetIdDeserializer::deserialize("ChangeSetId", stack)));
            }
"ChangeSetName" => {
                obj.change_set_name = Some(try!(ChangeSetNameDeserializer::deserialize("ChangeSetName", stack)));
            }
"CreationTime" => {
                obj.creation_time = Some(try!(CreationTimeDeserializer::deserialize("CreationTime", stack)));
            }
"Description" => {
                obj.description = Some(try!(DescriptionDeserializer::deserialize("Description", stack)));
            }
"ExecutionStatus" => {
                obj.execution_status = Some(try!(ExecutionStatusDeserializer::deserialize("ExecutionStatus", stack)));
            }
"StackId" => {
                obj.stack_id = Some(try!(StackIdDeserializer::deserialize("StackId", stack)));
            }
"StackName" => {
                obj.stack_name = Some(try!(StackNameDeserializer::deserialize("StackName", stack)));
            }
"Status" => {
                obj.status = Some(try!(ChangeSetStatusDeserializer::deserialize("Status", stack)));
            }
"StatusReason" => {
                obj.status_reason = Some(try!(ChangeSetStatusReasonDeserializer::deserialize("StatusReason", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
params.put(&format!("{}{}", prefix, "ChangeSetName"), &obj.change_set_name);
...
if let Some(ref field_value) = obj.use_previous_template {
                params.put(&format!("{}{}", prefix, "UsePreviousTemplate"), &field_value.to_string());
            }
...
if let Some(ref field_value) = obj.disable_rollback {
                params.put(&format!("{}{}", prefix, "DisableRollback"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.notification_ar_ns {
                NotificationARNsSerializer::serialize(
                    params,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AccountLimits" => {
                obj.account_limits = Some(try!(AccountLimitListDeserializer::deserialize("AccountLimits", stack)));
            }
"NextToken" => {
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Capabilities" => {
                obj.capabilities = Some(try!(CapabilitiesDeserializer::deserialize("Capabilities", stack)));
            }
"ChangeSetId" => {
                obj.change_set_id = Some(try!(ChangeSetIdDeserializer::deserialize("ChangeSetId", stack)));
            }
...
"Changes" => {
                obj.changes = Some(try!(ChangesDeserializer::deserialize("Changes", stack)));
            }
"CreationTime" => {
                obj.creation_time = Some(try!(CreationTimeDeserializer::deserialize("CreationTime", stack)));
            }
...
"NotificationARNs" => {
                obj.notification_ar_ns = Some(try!(NotificationARNsDeserializer::deserialize("NotificationARNs", stack)));
            }
"Parameters" => {
                obj.parameters = Some(try!(ParametersDeserializer::deserialize("Parameters", stack)));
            }
"StackId" => {
                obj.stack_id = Some(try!(StackIdDeserializer::deserialize("StackId", stack)));
            }
...
"StackEvents" => {
                obj.stack_events = Some(try!(StackEventsDeserializer::deserialize("StackEvents", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub stack_name: StackName,
        ...
        params.put(&format!("{}{}", prefix, "LogicalResourceId"), &obj.logical_resource_id);
params.put(&format!("{}{}", prefix, "StackName"), &obj.stack_name);
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "StackResourceDetail" => {
                obj.stack_resource_detail = Some(try!(StackResourceDetailDeserializer::deserialize("StackResourceDetail", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "StackResources" => {
                obj.stack_resources = Some(try!(StackResourcesDeserializer::deserialize("StackResources", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ExportingStackId" => {
                obj.exporting_stack_id = Some(try!(StackIdDeserializer::deserialize("ExportingStackId", stack)));
            }
"Name" => {
                obj.name = Some(try!(ExportNameDeserializer::deserialize("Name", stack)));
            }
"Value" => {
                obj.value = Some(try!(ExportValueDeserializer::deserialize("Value", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "StackPolicyBody" => {
                obj.stack_policy_body = Some(try!(StackPolicyBodyDeserializer::deserialize("StackPolicyBody", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "StagesAvailable" => {
                obj.stages_available = Some(try!(StageListDeserializer::deserialize("StagesAvailable", stack)));
            }
"TemplateBody" => {
                obj.template_body = Some(try!(TemplateBodyDeserializer::deserialize("TemplateBody", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"CapabilitiesReason" => {
                obj.capabilities_reason = Some(try!(CapabilitiesReasonDeserializer::deserialize("CapabilitiesReason", stack)));
            }
"DeclaredTransforms" => {
                obj.declared_transforms = Some(try!(TransformsListDeserializer::deserialize("DeclaredTransforms", stack)));
            }
"Description" => {
                obj.description = Some(try!(DescriptionDeserializer::deserialize("Description", stack)));
            }
"Metadata" => {
                obj.metadata = Some(try!(MetadataDeserializer::deserialize("Metadata", stack)));
            }
"Parameters" => {
                obj.parameters = Some(try!(ParameterDeclarationsDeserializer::deserialize("Parameters", stack)));
            }
"ResourceTypes" => {
                obj.resource_types = Some(try!(ResourceTypesDeserializer::deserialize("ResourceTypes", stack)));
            }
"Version" => {
                obj.version = Some(try!(VersionDeserializer::deserialize("Version", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"Summaries" => {
                obj.summaries = Some(try!(ChangeSetSummariesDeserializer::deserialize("Summaries", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Exports" => {
                obj.exports = Some(try!(ExportsDeserializer::deserialize("Exports", stack)));
            }
"NextToken" => {
                obj.next_token = Some(try!(NextTokenDeserializer::deserialize("NextToken", stack)));
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Imports" => {
                obj.imports = Some(try!(ImportsDeserializer::deserialize("Imports", stack)));
            }
"NextToken" => {
                obj.next_token = Some(try!(NextTokenDeserializer::deserialize("NextToken", stack)));
            }
...
"StackResourceSummaries" => {
                obj.stack_resource_summaries = Some(try!(StackResourceSummariesDeserializer::deserialize("StackResourceSummaries", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"StackSummaries" => {
                obj.stack_summaries = Some(try!(StackSummariesDeserializer::deserialize("StackSummaries", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"OutputKey" => {
                obj.output_key = Some(try!(OutputKeyDeserializer::deserialize("OutputKey", stack)));
            }
"OutputValue" => {
                obj.output_value = Some(try!(OutputValueDeserializer::deserialize("OutputValue", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ParameterKey" => {
                obj.parameter_key = Some(try!(ParameterKeyDeserializer::deserialize("ParameterKey", stack)));
            }
"ParameterValue" => {
                obj.parameter_value = Some(try!(ParameterValueDeserializer::deserialize("ParameterValue", stack)));
            }
"UsePreviousValue" => {
                obj.use_previous_value = Some(try!(UsePreviousValueDeserializer::deserialize("UsePreviousValue", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
if let Some(ref field_value) = obj.use_previous_value {
                params.put(&format!("{}{}", prefix, "UsePreviousValue"), &field_value.to_string());
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AllowedValues" => {
                obj.allowed_values = Some(try!(AllowedValuesDeserializer::deserialize("AllowedValues", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "DefaultValue" => {
                obj.default_value = Some(try!(ParameterValueDeserializer::deserialize("DefaultValue", stack)));
            }
"Description" => {
                obj.description = Some(try!(DescriptionDeserializer::deserialize("Description", stack)));
            }
...
"ParameterConstraints" => {
                obj.parameter_constraints = Some(try!(ParameterConstraintsDeserializer::deserialize("ParameterConstraints", stack)));
            }
"ParameterKey" => {
                obj.parameter_key = Some(try!(ParameterKeyDeserializer::deserialize("ParameterKey", stack)));
            }
"ParameterType" => {
                obj.parameter_type = Some(try!(ParameterTypeDeserializer::deserialize("ParameterType", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct ParameterDeclarationsDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(ParameterDeclarationDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Action" => {
                obj.action = Some(try!(ChangeActionDeserializer::deserialize("Action", stack)));
            }
"Details" => {
                obj.details = Some(try!(ResourceChangeDetailsDeserializer::deserialize("Details", stack)));
            }
"LogicalResourceId" => {
                obj.logical_resource_id = Some(try!(LogicalResourceIdDeserializer::deserialize("LogicalResourceId", stack)));
            }
"PhysicalResourceId" => {
                obj.physical_resource_id = Some(try!(PhysicalResourceIdDeserializer::deserialize("PhysicalResourceId", stack)));
            }
"Replacement" => {
                obj.replacement = Some(try!(ReplacementDeserializer::deserialize("Replacement", stack)));
            }
"ResourceType" => {
                obj.resource_type = Some(try!(ResourceTypeDeserializer::deserialize("ResourceType", stack)));
            }
"Scope" => {
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "CausingEntity" => {
                obj.causing_entity = Some(try!(CausingEntityDeserializer::deserialize("CausingEntity", stack)));
            }
"ChangeSource" => {
                obj.change_source = Some(try!(ChangeSourceDeserializer::deserialize("ChangeSource", stack)));
            }
"Evaluation" => {
                obj.evaluation = Some(try!(EvaluationTypeDeserializer::deserialize("Evaluation", stack)));
            }
"Target" => {
...
struct ResourceChangeDetailsDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(ResourceChangeDetailDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Attribute" => {
                obj.attribute = Some(try!(ResourceAttributeDeserializer::deserialize("Attribute", stack)));
            }
"Name" => {
                obj.name = Some(try!(PropertyNameDeserializer::deserialize("Name", stack)));
            }
"RequiresRecreation" => {
                obj.requires_recreation = Some(try!(RequiresRecreationDeserializer::deserialize("RequiresRecreation", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"CreationTime" => {
                obj.creation_time = try!(CreationTimeDeserializer::deserialize("CreationTime", stack));
            }
"Description" => {
                obj.description = Some(try!(DescriptionDeserializer::deserialize("Description", stack)));
            }
"DisableRollback" => {
                obj.disable_rollback = Some(try!(DisableRollbackDeserializer::deserialize("DisableRollback", stack)));
            }
"LastUpdatedTime" => {
                obj.last_updated_time = Some(try!(LastUpdatedTimeDeserializer::deserialize("LastUpdatedTime", stack)));
            }
"NotificationARNs" => {
                obj.notification_ar_ns = Some(try!(NotificationARNsDeserializer::deserialize("NotificationARNs", stack)));
            }
"Outputs" => {
                obj.outputs = Some(try!(OutputsDeserializer::deserialize("Outputs", stack)));
            }
"Parameters" => {
                obj.parameters = Some(try!(ParametersDeserializer::deserialize("Parameters", stack)));
            }
"RoleARN" => {
                obj.role_arn = Some(try!(RoleARNDeserializer::deserialize("RoleARN", stack)));
            }
"StackId" => {
                obj.stack_id = Some(try!(StackIdDeserializer::deserialize("StackId", stack)));
            }
"StackName" => {
                obj.stack_name = try!(StackNameDeserializer::deserialize("StackName", stack));
            }
"StackStatus" => {
                obj.stack_status = try!(StackStatusDeserializer::deserialize("StackStatus", stack));
            }
"StackStatusReason" => {
                obj.stack_status_reason = Some(try!(StackStatusReasonDeserializer::deserialize("StackStatusReason", stack)));
            }
"Tags" => {
                obj.tags = Some(try!(TagsDeserializer::deserialize("Tags", stack)));
            }
"TimeoutInMinutes" => {
                obj.timeout_in_minutes = Some(try!(TimeoutMinutesDeserializer::deserialize("TimeoutInMinutes", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"ResourceProperties" => {
                obj.resource_properties = Some(try!(ResourcePropertiesDeserializer::deserialize("ResourceProperties", stack)));
            }
"ResourceStatus" => {
                obj.resource_status = Some(try!(ResourceStatusDeserializer::deserialize("ResourceStatus", stack)));
            }
"ResourceStatusReason" => {
                obj.resource_status_reason = Some(try!(ResourceStatusReasonDeserializer::deserialize("ResourceStatusReason", stack)));
            }
"ResourceType" => {
                obj.resource_type = Some(try!(ResourceTypeDeserializer::deserialize("ResourceType", stack)));
            }
...
"Timestamp" => {
                obj.timestamp = try!(TimestampDeserializer::deserialize("Timestamp", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"LogicalResourceId" => {
                obj.logical_resource_id = try!(LogicalResourceIdDeserializer::deserialize("LogicalResourceId", stack));
            }
"PhysicalResourceId" => {
                obj.physical_resource_id = Some(try!(PhysicalResourceIdDeserializer::deserialize("PhysicalResourceId", stack)));
            }
"ResourceStatus" => {
                obj.resource_status = try!(ResourceStatusDeserializer::deserialize("ResourceStatus", stack));
            }
"ResourceStatusReason" => {
                obj.resource_status_reason = Some(try!(ResourceStatusReasonDeserializer::deserialize("ResourceStatusReason", stack)));
            }
"ResourceType" => {
                obj.resource_type = try!(ResourceTypeDeserializer::deserialize("ResourceType", stack));
            }
"StackId" => {
                obj.stack_id = Some(try!(StackIdDeserializer::deserialize("StackId", stack)));
            }
...
"LastUpdatedTimestamp" => {
                obj.last_updated_timestamp = try!(TimestampDeserializer::deserialize("LastUpdatedTimestamp", stack));
            }
"LogicalResourceId" => {
                obj.logical_resource_id = try!(LogicalResourceIdDeserializer::deserialize("LogicalResourceId", stack));
            }
...
struct StackResourceSummariesDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(StackResourceSummaryDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
...
"DeletionTime" => {
                obj.deletion_time = Some(try!(DeletionTimeDeserializer::deserialize("DeletionTime", stack)));
            }
"LastUpdatedTime" => {
                obj.last_updated_time = Some(try!(LastUpdatedTimeDeserializer::deserialize("LastUpdatedTime", stack)));
            }
...
"TemplateDescription" => {
                obj.template_description = Some(try!(TemplateDescriptionDeserializer::deserialize("TemplateDescription", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
if let Some(ref field_value) = obj.stack_policy_during_update_body {
                params.put(&format!("{}{}", prefix, "StackPolicyDuringUpdateBody"), &field_value);
            }
if let Some(ref field_value) = obj.stack_policy_during_update_url {
                params.put(&format!("{}{}", prefix, "StackPolicyDuringUpdateURL"), &field_value);
            }
if let Some(ref field_value) = obj.stack_policy_url {
                params.put(&format!("{}{}", prefix, "StackPolicyURL"), &field_value);
            }
...
"Parameters" => {
                obj.parameters = Some(try!(TemplateParametersDeserializer::deserialize("Parameters", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
                ...
                impl DeleteChangeSetError {
                    pub fn from_body(body: &str) -> DeleteChangeSetError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidChangeSetStatusException" => DeleteChangeSetError::InvalidChangeSetStatus(String::from(parsed_error.message)),_ => DeleteChangeSetError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeChangeSetError {
                    pub fn from_body(body: &str) -> DescribeChangeSetError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ChangeSetNotFoundException" => DescribeChangeSetError::ChangeSetNotFound(String::from(parsed_error.message)),_ => DescribeChangeSetError::Unknown(String::from(body))
                                }
                           },
                ...
                impl GetTemplateError {
                    pub fn from_body(body: &str) -> GetTemplateError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ChangeSetNotFoundException" => GetTemplateError::ChangeSetNotFound(String::from(parsed_error.message)),_ => GetTemplateError::Unknown(String::from(body))
                                }
                           },
                ...
                impl UpdateStackError {
                    pub fn from_body(body: &str) -> UpdateStackError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InsufficientCapabilitiesException" => UpdateStackError::InsufficientCapabilities(String::from(parsed_error.message)),_ => UpdateStackError::Unknown(String::from(body))
                                }
                           },
...
/// A client for the AWS CloudFormation API.
        pub struct CloudFormationClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            credentials_provider: P,
            region: region::Region,
            dispatcher: D,
        }

        impl<P, D> CloudFormationClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
        ...
        impl<P, D> CloudFormation for CloudFormationClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
        ...
        fn test_parse_error_cloudformation_cancel_update_stack() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/error", "cloudformation-cancel-update-stack.xml");
        ...
        fn test_parse_valid_cloudformation_get_template() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/valid", "cloudformation-get-template.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = CloudFormationClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
