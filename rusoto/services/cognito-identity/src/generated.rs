...
pub type AmbiguousRoleResolutionType = String;
pub type ClaimName = String;
pub type ClaimValue = String;
...
pub identity_ids_to_delete: IdentityIdList,
            }
...
pub type DeveloperProviderName = String;
pub type DeveloperUserIdentifier = String;
pub type DeveloperUserIdentifierList = Vec<DeveloperUserIdentifier>;
...
pub type HideDisabled = bool;
pub type IdentitiesList = Vec<IdentityDescription>;
...
pub type IdentityIdList = Vec<IdentityId>;
...
pub type IdentityPoolId = String;
pub type IdentityPoolName = String;
...
pub type IdentityPoolUnauthenticated = bool;
pub type IdentityPoolsList = Vec<IdentityPoolShortDescription>;
pub type IdentityProviderId = String;
pub type IdentityProviderName = String;
pub type IdentityProviderToken = String;
pub type IdentityProviders = ::std::collections::HashMap<IdentityProviderName, IdentityProviderId>;
...
pub type LoginsList = Vec<IdentityProviderName>;
pub type LoginsMap = ::std::collections::HashMap<IdentityProviderName, IdentityProviderToken>;
...
pub role_arn: ARNString,
#[doc="<p>A brief string that the claim must match, for example, \"paid\" or \"yes\".</p>"]
#[serde(rename="Value")]
pub value: ClaimValue,
            }
            
pub type MappingRuleMatchType = String;
pub type MappingRulesList = Vec<MappingRule>;
...
pub destination_user_identifier: DeveloperUserIdentifier,
#[doc="<p>The \"domain\" by which Cognito will refer to your users. This is a (pseudo) domain name that you provide while creating an identity pool. This name acts as a placeholder that allows your backend and the Cognito service to communicate about the developer provider. For the <code>DeveloperProviderName</code>, you can use letters as well as period (.), underscore (_), and dash (-).</p>"]
#[serde(rename="DeveloperProviderName")]
pub developer_provider_name: DeveloperProviderName,
#[doc="<p>An identity pool ID in the format REGION:GUID.</p>"]
#[serde(rename="IdentityPoolId")]
pub identity_pool_id: IdentityPoolId,
...
pub source_user_identifier: DeveloperUserIdentifier,
            }
...
pub type OIDCProviderList = Vec<ARNString>;
pub type OIDCToken = String;
pub type PaginationKey = String;
...
pub type RoleMappingMap = ::std::collections::HashMap<IdentityProviderName, RoleMapping>;
pub type RoleMappingType = String;
pub type RoleType = String;
pub type RolesMap = ::std::collections::HashMap<RoleType, ARNString>;
...
#[serde(rename="Rules")]
pub rules: MappingRulesList,
            }
            
pub type SAMLProviderList = Vec<ARNString>;
pub type SecretKeyString = String;
pub type SessionTokenString = String;
...
#[serde(rename="DeveloperUserIdentifier")]
pub developer_user_identifier: DeveloperUserIdentifier,
#[doc="<p>A unique identifier in the format REGION:GUID.</p>"]
#[serde(rename="IdentityId")]
pub identity_id: IdentityId,
#[doc="<p>An identity pool ID in the format REGION:GUID.</p>"]
...
pub logins_to_remove: LoginsList,
            }
...
pub type UnprocessedIdentityIdList = Vec<UnprocessedIdentityId>;
...
/// A client for the Amazon Cognito Identity API.
        pub struct CognitoIdentityClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            credentials_provider: P,
            region: region::Region,
            dispatcher: D,
        }

        impl<P, D> CognitoIdentityClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
        ...
        impl<P, D> CognitoIdentity for CognitoIdentityClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
                ...
                fn create_identity_pool(&self, input: &CreateIdentityPoolInput)  -> Box<Future<Item = IdentityPool, Error = CreateIdentityPoolError>> {
                    ...
                    request.add_header("x-amz-target", "AWSCognitoIdentityService.CreateIdentityPool");
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                fn delete_identity_pool(&self, input: &DeleteIdentityPoolInput)  -> Box<Future<Item = (), Error = DeleteIdentityPoolError>> {
                    ...
                    request.set_content_type("application/x-amz-json-1.1".to_owned());
                    request.add_header("x-amz-target", "AWSCognitoIdentityService.DeleteIdentityPool");
                    let encoded = serde_json::to_string(input).unwrap();
         request.set_payload(Some(encoded.into_bytes()));
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                fn describe_identity_pool(&self, input: &DescribeIdentityPoolInput)  -> Box<Future<Item = IdentityPool, Error = DescribeIdentityPoolError>> {
                    ...
                    request.set_content_type("application/x-amz-json-1.1".to_owned());
                    request.add_header("x-amz-target", "AWSCognitoIdentityService.DescribeIdentityPool");
                    let encoded = serde_json::to_string(input).unwrap();
         request.set_payload(Some(encoded.into_bytes()));
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                fn get_identity_pool_roles(&self, input: &GetIdentityPoolRolesInput)  -> Box<Future<Item = GetIdentityPoolRolesResponse, Error = GetIdentityPoolRolesError>> {
                    ...
                    request.set_content_type("application/x-amz-json-1.1".to_owned());
                    request.add_header("x-amz-target", "AWSCognitoIdentityService.GetIdentityPoolRoles");
                    let encoded = serde_json::to_string(input).unwrap();
         request.set_payload(Some(encoded.into_bytes()));
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                fn get_open_id_token_for_developer_identity(&self, input: &GetOpenIdTokenForDeveloperIdentityInput)  -> Box<Future<Item = GetOpenIdTokenForDeveloperIdentityResponse, Error = GetOpenIdTokenForDeveloperIdentityError>> {
                    ...
                    request.set_content_type("application/x-amz-json-1.1".to_owned());
                    request.add_header("x-amz-target", "AWSCognitoIdentityService.GetOpenIdTokenForDeveloperIdentity");
                    let encoded = serde_json::to_string(input).unwrap();
         request.set_payload(Some(encoded.into_bytes()));
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                fn list_identity_pools(&self, input: &ListIdentityPoolsInput)  -> Box<Future<Item = ListIdentityPoolsResponse, Error = ListIdentityPoolsError>> {
                    ...
                    request.set_content_type("application/x-amz-json-1.1".to_owned());
                    request.add_header("x-amz-target", "AWSCognitoIdentityService.ListIdentityPools");
                    let encoded = serde_json::to_string(input).unwrap();
         request.set_payload(Some(encoded.into_bytes()));
                ...
                fn lookup_developer_identity(&self, input: &LookupDeveloperIdentityInput)  -> Box<Future<Item = LookupDeveloperIdentityResponse, Error = LookupDeveloperIdentityError>> {
                    ...
                    request.set_content_type("application/x-amz-json-1.1".to_owned());
                    request.add_header("x-amz-target", "AWSCognitoIdentityService.LookupDeveloperIdentity");
                    let encoded = serde_json::to_string(input).unwrap();
         request.set_payload(Some(encoded.into_bytes()));
                ...
                fn merge_developer_identities(&self, input: &MergeDeveloperIdentitiesInput)  -> Box<Future<Item = MergeDeveloperIdentitiesResponse, Error = MergeDeveloperIdentitiesError>> {
                    ...
                    request.set_content_type("application/x-amz-json-1.1".to_owned());
                    request.add_header("x-amz-target", "AWSCognitoIdentityService.MergeDeveloperIdentities");
                    let encoded = serde_json::to_string(input).unwrap();
         request.set_payload(Some(encoded.into_bytes()));
                ...
                fn set_identity_pool_roles(&self, input: &SetIdentityPoolRolesInput)  -> Box<Future<Item = (), Error = SetIdentityPoolRolesError>> {
                    ...
                    request.set_content_type("application/x-amz-json-1.1".to_owned());
                    request.add_header("x-amz-target", "AWSCognitoIdentityService.SetIdentityPoolRoles");
                    let encoded = serde_json::to_string(input).unwrap();
         request.set_payload(Some(encoded.into_bytes()));
                ...
                fn unlink_developer_identity(&self, input: &UnlinkDeveloperIdentityInput)  -> Box<Future<Item = (), Error = UnlinkDeveloperIdentityError>> {
                    ...
                    request.set_content_type("application/x-amz-json-1.1".to_owned());
                    request.add_header("x-amz-target", "AWSCognitoIdentityService.UnlinkDeveloperIdentity");
                    let encoded = serde_json::to_string(input).unwrap();
         request.set_payload(Some(encoded.into_bytes()));
         ...
         request.set_payload(Some(encoded.into_bytes()));
                ...
                fn update_identity_pool(&self, input: &IdentityPool)  -> Box<Future<Item = IdentityPool, Error = UpdateIdentityPoolError>> {
                    ...
                    request.set_content_type("application/x-amz-json-1.1".to_owned());
                    request.add_header("x-amz-target", "AWSCognitoIdentityService.UpdateIdentityPool");
                    let encoded = serde_json::to_string(input).unwrap();
         request.set_payload(Some(encoded.into_bytes()));
