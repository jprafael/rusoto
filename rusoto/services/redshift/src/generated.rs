        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AccountId" => {
                obj.account_id = Some(try!(StringDeserializer::deserialize("AccountId", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub ec2_security_group_owner_id: Option<String>,
            ...
            impl AuthorizeClusterSecurityGroupIngressMessageSerializer {
                fn serialize(params: &mut Params, name: &str, obj: &AuthorizeClusterSecurityGroupIngressMessage) {
...
params.put(&format!("{}{}", prefix, "ClusterSecurityGroupName"), &obj.cluster_security_group_name);
if let Some(ref field_value) = obj.ec2_security_group_name {
                params.put(&format!("{}{}", prefix, "EC2SecurityGroupName"), &field_value);
            }
if let Some(ref field_value) = obj.ec2_security_group_owner_id {
                params.put(&format!("{}{}", prefix, "EC2SecurityGroupOwnerId"), &field_value);
            }
...
struct AuthorizeClusterSecurityGroupIngressResultDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.cluster_security_group = Some(try!(ClusterSecurityGroupDeserializer::deserialize("ClusterSecurityGroup", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub snapshot_identifier: String,
        ...
        params.put(&format!("{}{}", prefix, "AccountWithRestoreAccess"), &obj.account_with_restore_access);
if let Some(ref field_value) = obj.snapshot_cluster_identifier {
                params.put(&format!("{}{}", prefix, "SnapshotClusterIdentifier"), &field_value);
            }
params.put(&format!("{}{}", prefix, "SnapshotIdentifier"), &obj.snapshot_identifier);
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Snapshot" => {
                obj.snapshot = Some(try!(SnapshotDeserializer::deserialize("Snapshot", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "AvailabilityZone" {
                        obj.push(try!(AvailabilityZoneDeserializer::deserialize("AvailabilityZone", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AllowVersionUpgrade" => {
                obj.allow_version_upgrade = Some(try!(BooleanDeserializer::deserialize("AllowVersionUpgrade", stack)));
            }
"AutomatedSnapshotRetentionPeriod" => {
                obj.automated_snapshot_retention_period = Some(try!(IntegerDeserializer::deserialize("AutomatedSnapshotRetentionPeriod", stack)));
            }
"AvailabilityZone" => {
                obj.availability_zone = Some(try!(StringDeserializer::deserialize("AvailabilityZone", stack)));
            }
"ClusterCreateTime" => {
                obj.cluster_create_time = Some(try!(TStampDeserializer::deserialize("ClusterCreateTime", stack)));
            }
"ClusterIdentifier" => {
                obj.cluster_identifier = Some(try!(StringDeserializer::deserialize("ClusterIdentifier", stack)));
            }
"ClusterNodes" => {
                obj.cluster_nodes = Some(try!(ClusterNodesListDeserializer::deserialize("ClusterNodes", stack)));
            }
...
"ClusterPublicKey" => {
                obj.cluster_public_key = Some(try!(StringDeserializer::deserialize("ClusterPublicKey", stack)));
            }
"ClusterRevisionNumber" => {
                obj.cluster_revision_number = Some(try!(StringDeserializer::deserialize("ClusterRevisionNumber", stack)));
            }
...
"ClusterStatus" => {
                obj.cluster_status = Some(try!(StringDeserializer::deserialize("ClusterStatus", stack)));
            }
"ClusterSubnetGroupName" => {
                obj.cluster_subnet_group_name = Some(try!(StringDeserializer::deserialize("ClusterSubnetGroupName", stack)));
            }
"ClusterVersion" => {
                obj.cluster_version = Some(try!(StringDeserializer::deserialize("ClusterVersion", stack)));
            }
"DBName" => {
                obj.db_name = Some(try!(StringDeserializer::deserialize("DBName", stack)));
            }
"ElasticIpStatus" => {
                obj.elastic_ip_status = Some(try!(ElasticIpStatusDeserializer::deserialize("ElasticIpStatus", stack)));
            }
"Encrypted" => {
                obj.encrypted = Some(try!(BooleanDeserializer::deserialize("Encrypted", stack)));
            }
"Endpoint" => {
                obj.endpoint = Some(try!(EndpointDeserializer::deserialize("Endpoint", stack)));
            }
"EnhancedVpcRouting" => {
                obj.enhanced_vpc_routing = Some(try!(BooleanDeserializer::deserialize("EnhancedVpcRouting", stack)));
            }
"HsmStatus" => {
                obj.hsm_status = Some(try!(HsmStatusDeserializer::deserialize("HsmStatus", stack)));
            }
"IamRoles" => {
                obj.iam_roles = Some(try!(ClusterIamRoleListDeserializer::deserialize("IamRoles", stack)));
            }
"KmsKeyId" => {
                obj.kms_key_id = Some(try!(StringDeserializer::deserialize("KmsKeyId", stack)));
            }
"MasterUsername" => {
                obj.master_username = Some(try!(StringDeserializer::deserialize("MasterUsername", stack)));
            }
"ModifyStatus" => {
                obj.modify_status = Some(try!(StringDeserializer::deserialize("ModifyStatus", stack)));
            }
"NodeType" => {
                obj.node_type = Some(try!(StringDeserializer::deserialize("NodeType", stack)));
            }
"NumberOfNodes" => {
                obj.number_of_nodes = Some(try!(IntegerDeserializer::deserialize("NumberOfNodes", stack)));
            }
"PendingModifiedValues" => {
                obj.pending_modified_values = Some(try!(PendingModifiedValuesDeserializer::deserialize("PendingModifiedValues", stack)));
            }
"PreferredMaintenanceWindow" => {
                obj.preferred_maintenance_window = Some(try!(StringDeserializer::deserialize("PreferredMaintenanceWindow", stack)));
            }
"PubliclyAccessible" => {
                obj.publicly_accessible = Some(try!(BooleanDeserializer::deserialize("PubliclyAccessible", stack)));
            }
"RestoreStatus" => {
                obj.restore_status = Some(try!(RestoreStatusDeserializer::deserialize("RestoreStatus", stack)));
            }
"Tags" => {
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ApplyStatus" => {
                obj.apply_status = Some(try!(StringDeserializer::deserialize("ApplyStatus", stack)));
            }
"IamRoleArn" => {
                obj.iam_role_arn = Some(try!(StringDeserializer::deserialize("IamRoleArn", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "ClusterIamRole" {
                        obj.push(try!(ClusterIamRoleDeserializer::deserialize("ClusterIamRole", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "NodeRole" => {
                obj.node_role = Some(try!(StringDeserializer::deserialize("NodeRole", stack)));
            }
"PrivateIPAddress" => {
                obj.private_ip_address = Some(try!(StringDeserializer::deserialize("PrivateIPAddress", stack)));
            }
"PublicIPAddress" => {
                obj.public_ip_address = Some(try!(StringDeserializer::deserialize("PublicIPAddress", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Description" => {
                obj.description = Some(try!(StringDeserializer::deserialize("Description", stack)));
            }
"ParameterGroupFamily" => {
                obj.parameter_group_family = Some(try!(StringDeserializer::deserialize("ParameterGroupFamily", stack)));
            }
"ParameterGroupName" => {
                obj.parameter_group_name = Some(try!(StringDeserializer::deserialize("ParameterGroupName", stack)));
            }
"Tags" => {
                obj.tags = Some(try!(TagListDeserializer::deserialize("Tags", stack)));
            }
...
"Parameters" => {
                obj.parameters = Some(try!(ParametersListDeserializer::deserialize("Parameters", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"ParameterGroupStatus" => {
                obj.parameter_group_status = Some(try!(StringDeserializer::deserialize("ParameterGroupStatus", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"ParameterApplyStatus" => {
                obj.parameter_apply_status = Some(try!(StringDeserializer::deserialize("ParameterApplyStatus", stack)));
            }
"ParameterGroupName" => {
                obj.parameter_group_name = Some(try!(StringDeserializer::deserialize("ParameterGroupName", stack)));
            }
...
"ParameterGroups" => {
                obj.parameter_groups = Some(try!(ParameterGroupListDeserializer::deserialize("ParameterGroups", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct ClusterParameterStatusDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.parameter_apply_error_description = Some(try!(StringDeserializer::deserialize("ParameterApplyErrorDescription", stack)));
            }
"ParameterApplyStatus" => {
                obj.parameter_apply_status = Some(try!(StringDeserializer::deserialize("ParameterApplyStatus", stack)));
            }
"ParameterName" => {
                obj.parameter_name = Some(try!(StringDeserializer::deserialize("ParameterName", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct ClusterParameterStatusListDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(ClusterParameterStatusDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
...
struct ClusterSecurityGroupDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.cluster_security_group_name = Some(try!(StringDeserializer::deserialize("ClusterSecurityGroupName", stack)));
            }
"Description" => {
                obj.description = Some(try!(StringDeserializer::deserialize("Description", stack)));
            }
"EC2SecurityGroups" => {
                obj.ec2_security_groups = Some(try!(EC2SecurityGroupListDeserializer::deserialize("EC2SecurityGroups", stack)));
            }
"IPRanges" => {
                obj.ip_ranges = Some(try!(IPRangeListDeserializer::deserialize("IPRanges", stack)));
            }
"Tags" => {
                obj.tags = Some(try!(TagListDeserializer::deserialize("Tags", stack)));
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ClusterSecurityGroups" => {
                obj.cluster_security_groups = Some(try!(ClusterSecurityGroupsDeserializer::deserialize("ClusterSecurityGroups", stack)));
            }
"Marker" => {
                obj.marker = Some(try!(StringDeserializer::deserialize("Marker", stack)));
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "DestinationRegion" => {
                obj.destination_region = Some(try!(StringDeserializer::deserialize("DestinationRegion", stack)));
            }
"RetentionPeriod" => {
                obj.retention_period = Some(try!(LongDeserializer::deserialize("RetentionPeriod", stack)));
            }
"SnapshotCopyGrantName" => {
                obj.snapshot_copy_grant_name = Some(try!(StringDeserializer::deserialize("SnapshotCopyGrantName", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"SubnetGroupStatus" => {
                obj.subnet_group_status = Some(try!(StringDeserializer::deserialize("SubnetGroupStatus", stack)));
            }
"Subnets" => {
                obj.subnets = Some(try!(SubnetListDeserializer::deserialize("Subnets", stack)));
            }
"Tags" => {
                obj.tags = Some(try!(TagListDeserializer::deserialize("Tags", stack)));
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ClusterSubnetGroups" => {
                obj.cluster_subnet_groups = Some(try!(ClusterSubnetGroupsDeserializer::deserialize("ClusterSubnetGroups", stack)));
            }
"Marker" => {
                obj.marker = Some(try!(StringDeserializer::deserialize("Marker", stack)));
            }
...
struct ClusterVersionDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.cluster_parameter_group_family = Some(try!(StringDeserializer::deserialize("ClusterParameterGroupFamily", stack)));
            }
"ClusterVersion" => {
                obj.cluster_version = Some(try!(StringDeserializer::deserialize("ClusterVersion", stack)));
            }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "ClusterVersion" {
                        obj.push(try!(ClusterVersionDeserializer::deserialize("ClusterVersion", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ClusterVersions" => {
                obj.cluster_versions = Some(try!(ClusterVersionListDeserializer::deserialize("ClusterVersions", stack)));
            }
"Marker" => {
                obj.marker = Some(try!(StringDeserializer::deserialize("Marker", stack)));
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Clusters" => {
                obj.clusters = Some(try!(ClusterListDeserializer::deserialize("Clusters", stack)));
            }
"Marker" => {
                obj.marker = Some(try!(StringDeserializer::deserialize("Marker", stack)));
            }
...
params.put(&format!("{}{}", prefix, "SourceSnapshotIdentifier"), &obj.source_snapshot_identifier);
params.put(&format!("{}{}", prefix, "TargetSnapshotIdentifier"), &obj.target_snapshot_identifier);
...
if let Some(ref field_value) = obj.allow_version_upgrade {
                params.put(&format!("{}{}", prefix, "AllowVersionUpgrade"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.automated_snapshot_retention_period {
                params.put(&format!("{}{}", prefix, "AutomatedSnapshotRetentionPeriod"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.availability_zone {
                params.put(&format!("{}{}", prefix, "AvailabilityZone"), &field_value);
            }
params.put(&format!("{}{}", prefix, "ClusterIdentifier"), &obj.cluster_identifier);
if let Some(ref field_value) = obj.cluster_parameter_group_name {
                params.put(&format!("{}{}", prefix, "ClusterParameterGroupName"), &field_value);
            }
...
if let Some(ref field_value) = obj.cluster_subnet_group_name {
                params.put(&format!("{}{}", prefix, "ClusterSubnetGroupName"), &field_value);
            }
...
if let Some(ref field_value) = obj.encrypted {
                params.put(&format!("{}{}", prefix, "Encrypted"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.enhanced_vpc_routing {
                params.put(&format!("{}{}", prefix, "EnhancedVpcRouting"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.hsm_client_certificate_identifier {
                params.put(&format!("{}{}", prefix, "HsmClientCertificateIdentifier"), &field_value);
            }
if let Some(ref field_value) = obj.hsm_configuration_identifier {
                params.put(&format!("{}{}", prefix, "HsmConfigurationIdentifier"), &field_value);
            }
...
params.put(&format!("{}{}", prefix, "MasterUserPassword"), &obj.master_user_password);
params.put(&format!("{}{}", prefix, "MasterUsername"), &obj.master_username);
params.put(&format!("{}{}", prefix, "NodeType"), &obj.node_type);
if let Some(ref field_value) = obj.number_of_nodes {
                params.put(&format!("{}{}", prefix, "NumberOfNodes"), &field_value.to_string());
            }
...
if let Some(ref field_value) = obj.preferred_maintenance_window {
                params.put(&format!("{}{}", prefix, "PreferredMaintenanceWindow"), &field_value);
            }
if let Some(ref field_value) = obj.publicly_accessible {
                params.put(&format!("{}{}", prefix, "PubliclyAccessible"), &field_value.to_string());
            }
...
params.put(&format!("{}{}", prefix, "ParameterGroupFamily"), &obj.parameter_group_family);
params.put(&format!("{}{}", prefix, "ParameterGroupName"), &obj.parameter_group_name);
if let Some(ref field_value) = obj.tags {
                TagListSerializer::serialize(
                    params,
                    &format!("{}{}", prefix, "Tags"),
...
struct CreateClusterParameterGroupResultDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.cluster_parameter_group = Some(try!(ClusterParameterGroupDeserializer::deserialize("ClusterParameterGroup", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Cluster" => {
                obj.cluster = Some(try!(ClusterDeserializer::deserialize("Cluster", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub tags: Option<TagList>,
        ...
        params.put(&format!("{}{}", prefix, "ClusterSubnetGroupName"), &obj.cluster_subnet_group_name);
params.put(&format!("{}{}", prefix, "Description"), &obj.description);
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ClusterSubnetGroup" => {
                obj.cluster_subnet_group = Some(try!(ClusterSubnetGroupDeserializer::deserialize("ClusterSubnetGroup", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub tags: Option<TagList>,
        ...
        if let Some(ref field_value) = obj.enabled {
                params.put(&format!("{}{}", prefix, "Enabled"), &field_value.to_string());
            }
...
params.put(&format!("{}{}", prefix, "SubscriptionName"), &obj.subscription_name);
if let Some(ref field_value) = obj.tags {
                TagListSerializer::serialize(
                    params,
                    &format!("{}{}", prefix, "Tags"),
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "EventSubscription" => {
                obj.event_subscription = Some(try!(EventSubscriptionDeserializer::deserialize("EventSubscription", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub tags: Option<TagList>,
        ...
        params.put(&format!("{}{}", prefix, "HsmClientCertificateIdentifier"), &obj.hsm_client_certificate_identifier);
if let Some(ref field_value) = obj.tags {
                TagListSerializer::serialize(
                    params,
                    &format!("{}{}", prefix, "Tags"),
...
struct CreateHsmClientCertificateResultDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.hsm_client_certificate = Some(try!(HsmClientCertificateDeserializer::deserialize("HsmClientCertificate", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub tags: Option<TagList>,
        ...
        params.put(&format!("{}{}", prefix, "Description"), &obj.description);
params.put(&format!("{}{}", prefix, "HsmConfigurationIdentifier"), &obj.hsm_configuration_identifier);
params.put(&format!("{}{}", prefix, "HsmIpAddress"), &obj.hsm_ip_address);
params.put(&format!("{}{}", prefix, "HsmPartitionName"), &obj.hsm_partition_name);
params.put(&format!("{}{}", prefix, "HsmPartitionPassword"), &obj.hsm_partition_password);
params.put(&format!("{}{}", prefix, "HsmServerPublicCertificate"), &obj.hsm_server_public_certificate);
if let Some(ref field_value) = obj.tags {
                TagListSerializer::serialize(
                    params,
                    &format!("{}{}", prefix, "Tags"),
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "HsmConfiguration" => {
                obj.hsm_configuration = Some(try!(HsmConfigurationDeserializer::deserialize("HsmConfiguration", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
params.put(&format!("{}{}", prefix, "SnapshotCopyGrantName"), &obj.snapshot_copy_grant_name);
if let Some(ref field_value) = obj.tags {
                TagListSerializer::serialize(
                    params,
                    &format!("{}{}", prefix, "Tags"),
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "SnapshotCopyGrant" => {
                obj.snapshot_copy_grant = Some(try!(SnapshotCopyGrantDeserializer::deserialize("SnapshotCopyGrant", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
if let Some(ref field_value) = obj.final_cluster_snapshot_identifier {
                params.put(&format!("{}{}", prefix, "FinalClusterSnapshotIdentifier"), &field_value);
            }
if let Some(ref field_value) = obj.skip_final_cluster_snapshot {
                params.put(&format!("{}{}", prefix, "SkipFinalClusterSnapshot"), &field_value.to_string());
            }
...
pub tag_values: Option<TagValueList>,
        ...
        if let Some(ref field_value) = obj.cluster_security_group_name {
                params.put(&format!("{}{}", prefix, "ClusterSecurityGroupName"), &field_value);
            }
if let Some(ref field_value) = obj.marker {
                params.put(&format!("{}{}", prefix, "Marker"), &field_value);
            }
...
pub max_records: Option<IntegerOptional>,
        ...
        if let Some(ref field_value) = obj.cluster_parameter_group_family {
                params.put(&format!("{}{}", prefix, "ClusterParameterGroupFamily"), &field_value);
            }
if let Some(ref field_value) = obj.cluster_version {
                params.put(&format!("{}{}", prefix, "ClusterVersion"), &field_value);
            }
...
pub start_time: Option<TStamp>,
        ...
        if let Some(ref field_value) = obj.duration {
                params.put(&format!("{}{}", prefix, "Duration"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.end_time {
                params.put(&format!("{}{}", prefix, "EndTime"), &field_value);
            }
...
if let Some(ref field_value) = obj.reserved_node_offering_id {
                params.put(&format!("{}{}", prefix, "ReservedNodeOfferingId"), &field_value);
            }
...
if let Some(ref field_value) = obj.snapshot_copy_grant_name {
                params.put(&format!("{}{}", prefix, "SnapshotCopyGrantName"), &field_value);
            }
if let Some(ref field_value) = obj.tag_keys {
                TagKeyListSerializer::serialize(
                    params,
...
if let Some(ref field_value) = obj.table_restore_request_id {
                params.put(&format!("{}{}", prefix, "TableRestoreRequestId"), &field_value);
            }
...
struct EC2SecurityGroupDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.ec2_security_group_name = Some(try!(StringDeserializer::deserialize("EC2SecurityGroupName", stack)));
            }
"EC2SecurityGroupOwnerId" => {
                obj.ec2_security_group_owner_id = Some(try!(StringDeserializer::deserialize("EC2SecurityGroupOwnerId", stack)));
            }
"Status" => {
                obj.status = Some(try!(StringDeserializer::deserialize("Status", stack)));
            }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "EC2SecurityGroup" {
                        obj.push(try!(EC2SecurityGroupDeserializer::deserialize("EC2SecurityGroup", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ElasticIp" => {
                obj.elastic_ip = Some(try!(StringDeserializer::deserialize("ElasticIp", stack)));
            }
"Status" => {
                obj.status = Some(try!(StringDeserializer::deserialize("Status", stack)));
            }
...
pub snapshot_copy_grant_name: Option<String>,
        ...
        params.put(&format!("{}{}", prefix, "ClusterIdentifier"), &obj.cluster_identifier);
params.put(&format!("{}{}", prefix, "DestinationRegion"), &obj.destination_region);
if let Some(ref field_value) = obj.retention_period {
                params.put(&format!("{}{}", prefix, "RetentionPeriod"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.snapshot_copy_grant_name {
                params.put(&format!("{}{}", prefix, "SnapshotCopyGrantName"), &field_value);
            }
...
"EventCategories" => {
                obj.event_categories = Some(try!(EventCategoriesListDeserializer::deserialize("EventCategories", stack)));
            }
"EventId" => {
                obj.event_id = Some(try!(StringDeserializer::deserialize("EventId", stack)));
            }
"Message" => {
                obj.message = Some(try!(StringDeserializer::deserialize("Message", stack)));
            }
"Severity" => {
                obj.severity = Some(try!(StringDeserializer::deserialize("Severity", stack)));
            }
"SourceIdentifier" => {
                obj.source_identifier = Some(try!(StringDeserializer::deserialize("SourceIdentifier", stack)));
            }
"SourceType" => {
                obj.source_type = Some(try!(SourceTypeDeserializer::deserialize("SourceType", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Events" => {
                obj.events = Some(try!(EventInfoMapListDeserializer::deserialize("Events", stack)));
            }
"SourceType" => {
                obj.source_type = Some(try!(StringDeserializer::deserialize("SourceType", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct EventCategoriesMessageDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.event_categories_map_list = Some(try!(EventCategoriesMapListDeserializer::deserialize("EventCategoriesMapList", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"EventDescription" => {
                obj.event_description = Some(try!(StringDeserializer::deserialize("EventDescription", stack)));
            }
"EventId" => {
                obj.event_id = Some(try!(StringDeserializer::deserialize("EventId", stack)));
            }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "EventInfoMap" {
                        obj.push(try!(EventInfoMapDeserializer::deserialize("EventInfoMap", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "CustSubscriptionId" => {
                obj.cust_subscription_id = Some(try!(StringDeserializer::deserialize("CustSubscriptionId", stack)));
            }
"CustomerAwsId" => {
                obj.customer_aws_id = Some(try!(StringDeserializer::deserialize("CustomerAwsId", stack)));
            }
"Enabled" => {
                obj.enabled = Some(try!(BooleanDeserializer::deserialize("Enabled", stack)));
            }
"EventCategoriesList" => {
                obj.event_categories_list = Some(try!(EventCategoriesListDeserializer::deserialize("EventCategoriesList", stack)));
            }
"Severity" => {
                obj.severity = Some(try!(StringDeserializer::deserialize("Severity", stack)));
            }
"SnsTopicArn" => {
                obj.sns_topic_arn = Some(try!(StringDeserializer::deserialize("SnsTopicArn", stack)));
            }
"SourceIdsList" => {
                obj.source_ids_list = Some(try!(SourceIdsListDeserializer::deserialize("SourceIdsList", stack)));
            }
"SourceType" => {
                obj.source_type = Some(try!(StringDeserializer::deserialize("SourceType", stack)));
            }
...
"SubscriptionCreationTime" => {
                obj.subscription_creation_time = Some(try!(TStampDeserializer::deserialize("SubscriptionCreationTime", stack)));
            }
"Tags" => {
                obj.tags = Some(try!(TagListDeserializer::deserialize("Tags", stack)));
            }
...
struct EventSubscriptionsMessageDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.event_subscriptions_list = Some(try!(EventSubscriptionsListDeserializer::deserialize("EventSubscriptionsList", stack)));
            }
"Marker" => {
                obj.marker = Some(try!(StringDeserializer::deserialize("Marker", stack)));
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Events" => {
                obj.events = Some(try!(EventListDeserializer::deserialize("Events", stack)));
            }
"Marker" => {
                obj.marker = Some(try!(StringDeserializer::deserialize("Marker", stack)));
            }
...
struct HsmClientCertificateDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.hsm_client_certificate_identifier = Some(try!(StringDeserializer::deserialize("HsmClientCertificateIdentifier", stack)));
            }
"HsmClientCertificatePublicKey" => {
                obj.hsm_client_certificate_public_key = Some(try!(StringDeserializer::deserialize("HsmClientCertificatePublicKey", stack)));
            }
"Tags" => {
                obj.tags = Some(try!(TagListDeserializer::deserialize("Tags", stack)));
            }
...
"HsmConfigurationIdentifier" => {
                obj.hsm_configuration_identifier = Some(try!(StringDeserializer::deserialize("HsmConfigurationIdentifier", stack)));
            }
"HsmIpAddress" => {
                obj.hsm_ip_address = Some(try!(StringDeserializer::deserialize("HsmIpAddress", stack)));
            }
"HsmPartitionName" => {
                obj.hsm_partition_name = Some(try!(StringDeserializer::deserialize("HsmPartitionName", stack)));
            }
"Tags" => {
                obj.tags = Some(try!(TagListDeserializer::deserialize("Tags", stack)));
            }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "HsmConfiguration" {
                        obj.push(try!(HsmConfigurationDeserializer::deserialize("HsmConfiguration", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "HsmConfigurations" => {
                obj.hsm_configurations = Some(try!(HsmConfigurationListDeserializer::deserialize("HsmConfigurations", stack)));
            }
"Marker" => {
                obj.marker = Some(try!(StringDeserializer::deserialize("Marker", stack)));
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "BucketName" => {
                obj.bucket_name = Some(try!(StringDeserializer::deserialize("BucketName", stack)));
            }
"LastFailureMessage" => {
                obj.last_failure_message = Some(try!(StringDeserializer::deserialize("LastFailureMessage", stack)));
            }
"LastFailureTime" => {
                obj.last_failure_time = Some(try!(TStampDeserializer::deserialize("LastFailureTime", stack)));
            }
"LastSuccessfulDeliveryTime" => {
                obj.last_successful_delivery_time = Some(try!(TStampDeserializer::deserialize("LastSuccessfulDeliveryTime", stack)));
            }
"LoggingEnabled" => {
                obj.logging_enabled = Some(try!(BooleanDeserializer::deserialize("LoggingEnabled", stack)));
            }
"S3KeyPrefix" => {
                obj.s3_key_prefix = Some(try!(StringDeserializer::deserialize("S3KeyPrefix", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
if let Some(ref field_value) = obj.new_cluster_identifier {
                params.put(&format!("{}{}", prefix, "NewClusterIdentifier"), &field_value);
            }
if let Some(ref field_value) = obj.node_type {
                params.put(&format!("{}{}", prefix, "NodeType"), &field_value);
            }
...
pub retention_period: Integer,
        ...
        params.put(&format!("{}{}", prefix, "ClusterIdentifier"), &obj.cluster_identifier);
params.put(&format!("{}{}", prefix, "RetentionPeriod"), &obj.retention_period.to_string());
...
"ClusterType" => {
                obj.cluster_type = Some(try!(StringDeserializer::deserialize("ClusterType", stack)));
            }
"ClusterVersion" => {
                obj.cluster_version = Some(try!(StringDeserializer::deserialize("ClusterVersion", stack)));
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AllowedValues" => {
                obj.allowed_values = Some(try!(StringDeserializer::deserialize("AllowedValues", stack)));
            }
"ApplyType" => {
                obj.apply_type = Some(try!(ParameterApplyTypeDeserializer::deserialize("ApplyType", stack)));
            }
"DataType" => {
                obj.data_type = Some(try!(StringDeserializer::deserialize("DataType", stack)));
            }
"Description" => {
                obj.description = Some(try!(StringDeserializer::deserialize("Description", stack)));
            }
"IsModifiable" => {
                obj.is_modifiable = Some(try!(BooleanDeserializer::deserialize("IsModifiable", stack)));
            }
"MinimumEngineVersion" => {
                obj.minimum_engine_version = Some(try!(StringDeserializer::deserialize("MinimumEngineVersion", stack)));
            }
"ParameterName" => {
                obj.parameter_name = Some(try!(StringDeserializer::deserialize("ParameterName", stack)));
            }
"ParameterValue" => {
                obj.parameter_value = Some(try!(StringDeserializer::deserialize("ParameterValue", stack)));
            }
"Source" => {
...
if let Some(ref field_value) = obj.is_modifiable {
                params.put(&format!("{}{}", prefix, "IsModifiable"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.minimum_engine_version {
                params.put(&format!("{}{}", prefix, "MinimumEngineVersion"), &field_value);
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AutomatedSnapshotRetentionPeriod" => {
                obj.automated_snapshot_retention_period = Some(try!(IntegerOptionalDeserializer::deserialize("AutomatedSnapshotRetentionPeriod", stack)));
            }
"ClusterIdentifier" => {
                obj.cluster_identifier = Some(try!(StringDeserializer::deserialize("ClusterIdentifier", stack)));
            }
...
"EnhancedVpcRouting" => {
                obj.enhanced_vpc_routing = Some(try!(BooleanOptionalDeserializer::deserialize("EnhancedVpcRouting", stack)));
            }
"MasterUserPassword" => {
                obj.master_user_password = Some(try!(StringDeserializer::deserialize("MasterUserPassword", stack)));
            }
"NodeType" => {
                obj.node_type = Some(try!(StringDeserializer::deserialize("NodeType", stack)));
            }
"NumberOfNodes" => {
                obj.number_of_nodes = Some(try!(IntegerOptionalDeserializer::deserialize("NumberOfNodes", stack)));
            }
"PubliclyAccessible" => {
                obj.publicly_accessible = Some(try!(BooleanOptionalDeserializer::deserialize("PubliclyAccessible", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub reserved_node_offering_id: String,
        ...
        if let Some(ref field_value) = obj.node_count {
                params.put(&format!("{}{}", prefix, "NodeCount"), &field_value.to_string());
            }
params.put(&format!("{}{}", prefix, "ReservedNodeOfferingId"), &obj.reserved_node_offering_id);
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ReservedNode" => {
                obj.reserved_node = Some(try!(ReservedNodeDeserializer::deserialize("ReservedNode", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct RecurringChargeDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.recurring_charge_amount = Some(try!(DoubleDeserializer::deserialize("RecurringChargeAmount", stack)));
            }
"RecurringChargeFrequency" => {
                obj.recurring_charge_frequency = Some(try!(StringDeserializer::deserialize("RecurringChargeFrequency", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "RecurringCharge" {
                        obj.push(try!(RecurringChargeDeserializer::deserialize("RecurringCharge", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "CurrencyCode" => {
                obj.currency_code = Some(try!(StringDeserializer::deserialize("CurrencyCode", stack)));
            }
"Duration" => {
                obj.duration = Some(try!(IntegerDeserializer::deserialize("Duration", stack)));
            }
"FixedPrice" => {
                obj.fixed_price = Some(try!(DoubleDeserializer::deserialize("FixedPrice", stack)));
            }
"NodeCount" => {
                obj.node_count = Some(try!(IntegerDeserializer::deserialize("NodeCount", stack)));
            }
"NodeType" => {
                obj.node_type = Some(try!(StringDeserializer::deserialize("NodeType", stack)));
            }
"OfferingType" => {
                obj.offering_type = Some(try!(StringDeserializer::deserialize("OfferingType", stack)));
            }
"RecurringCharges" => {
                obj.recurring_charges = Some(try!(RecurringChargeListDeserializer::deserialize("RecurringCharges", stack)));
            }
"ReservedNodeId" => {
                obj.reserved_node_id = Some(try!(StringDeserializer::deserialize("ReservedNodeId", stack)));
            }
"ReservedNodeOfferingId" => {
                obj.reserved_node_offering_id = Some(try!(StringDeserializer::deserialize("ReservedNodeOfferingId", stack)));
            }
"StartTime" => {
                obj.start_time = Some(try!(TStampDeserializer::deserialize("StartTime", stack)));
            }
"State" => {
                obj.state = Some(try!(StringDeserializer::deserialize("State", stack)));
            }
"UsagePrice" => {
                obj.usage_price = Some(try!(DoubleDeserializer::deserialize("UsagePrice", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "ReservedNode" {
                        obj.push(try!(ReservedNodeDeserializer::deserialize("ReservedNode", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
...
"ReservedNodes" => {
                obj.reserved_nodes = Some(try!(ReservedNodeListDeserializer::deserialize("ReservedNodes", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
if let Some(ref field_value) = obj.reset_all_parameters {
                params.put(&format!("{}{}", prefix, "ResetAllParameters"), &field_value.to_string());
            }
...
struct ResizeProgressMessageDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.avg_resize_rate_in_mega_bytes_per_second = Some(try!(DoubleOptionalDeserializer::deserialize("AvgResizeRateInMegaBytesPerSecond", stack)));
            }
"ElapsedTimeInSeconds" => {
                obj.elapsed_time_in_seconds = Some(try!(LongOptionalDeserializer::deserialize("ElapsedTimeInSeconds", stack)));
            }
"EstimatedTimeToCompletionInSeconds" => {
                obj.estimated_time_to_completion_in_seconds = Some(try!(LongOptionalDeserializer::deserialize("EstimatedTimeToCompletionInSeconds", stack)));
            }
"ImportTablesCompleted" => {
                obj.import_tables_completed = Some(try!(ImportTablesCompletedDeserializer::deserialize("ImportTablesCompleted", stack)));
            }
"ImportTablesInProgress" => {
                obj.import_tables_in_progress = Some(try!(ImportTablesInProgressDeserializer::deserialize("ImportTablesInProgress", stack)));
            }
"ImportTablesNotStarted" => {
                obj.import_tables_not_started = Some(try!(ImportTablesNotStartedDeserializer::deserialize("ImportTablesNotStarted", stack)));
            }
"ProgressInMegaBytes" => {
                obj.progress_in_mega_bytes = Some(try!(LongOptionalDeserializer::deserialize("ProgressInMegaBytes", stack)));
            }
"Status" => {
                obj.status = Some(try!(StringDeserializer::deserialize("Status", stack)));
            }
"TargetClusterType" => {
                obj.target_cluster_type = Some(try!(StringDeserializer::deserialize("TargetClusterType", stack)));
            }
"TargetNodeType" => {
                obj.target_node_type = Some(try!(StringDeserializer::deserialize("TargetNodeType", stack)));
            }
"TargetNumberOfNodes" => {
                obj.target_number_of_nodes = Some(try!(IntegerOptionalDeserializer::deserialize("TargetNumberOfNodes", stack)));
            }
"TotalResizeDataInMegaBytes" => {
                obj.total_resize_data_in_mega_bytes = Some(try!(LongOptionalDeserializer::deserialize("TotalResizeDataInMegaBytes", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct RestoreStatusDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.current_restore_rate_in_mega_bytes_per_second = Some(try!(DoubleDeserializer::deserialize("CurrentRestoreRateInMegaBytesPerSecond", stack)));
            }
"ElapsedTimeInSeconds" => {
                obj.elapsed_time_in_seconds = Some(try!(LongDeserializer::deserialize("ElapsedTimeInSeconds", stack)));
            }
"EstimatedTimeToCompletionInSeconds" => {
                obj.estimated_time_to_completion_in_seconds = Some(try!(LongDeserializer::deserialize("EstimatedTimeToCompletionInSeconds", stack)));
            }
"ProgressInMegaBytes" => {
                obj.progress_in_mega_bytes = Some(try!(LongDeserializer::deserialize("ProgressInMegaBytes", stack)));
            }
"SnapshotSizeInMegaBytes" => {
                obj.snapshot_size_in_mega_bytes = Some(try!(LongDeserializer::deserialize("SnapshotSizeInMegaBytes", stack)));
            }
"Status" => {
                obj.status = Some(try!(StringDeserializer::deserialize("Status", stack)));
            }
...
pub target_schema_name: Option<String>,
        ...
        params.put(&format!("{}{}", prefix, "ClusterIdentifier"), &obj.cluster_identifier);
params.put(&format!("{}{}", prefix, "NewTableName"), &obj.new_table_name);
params.put(&format!("{}{}", prefix, "SnapshotIdentifier"), &obj.snapshot_identifier);
params.put(&format!("{}{}", prefix, "SourceDatabaseName"), &obj.source_database_name);
if let Some(ref field_value) = obj.source_schema_name {
                params.put(&format!("{}{}", prefix, "SourceSchemaName"), &field_value);
            }
params.put(&format!("{}{}", prefix, "SourceTableName"), &obj.source_table_name);
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "TableRestoreStatus" => {
                obj.table_restore_status = Some(try!(TableRestoreStatusDeserializer::deserialize("TableRestoreStatus", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"ActualIncrementalBackupSizeInMegaBytes" => {
                obj.actual_incremental_backup_size_in_mega_bytes = Some(try!(DoubleDeserializer::deserialize("ActualIncrementalBackupSizeInMegaBytes", stack)));
            }
"AvailabilityZone" => {
                obj.availability_zone = Some(try!(StringDeserializer::deserialize("AvailabilityZone", stack)));
            }
"BackupProgressInMegaBytes" => {
                obj.backup_progress_in_mega_bytes = Some(try!(DoubleDeserializer::deserialize("BackupProgressInMegaBytes", stack)));
            }
"ClusterCreateTime" => {
                obj.cluster_create_time = Some(try!(TStampDeserializer::deserialize("ClusterCreateTime", stack)));
            }
...
"CurrentBackupRateInMegaBytesPerSecond" => {
                obj.current_backup_rate_in_mega_bytes_per_second = Some(try!(DoubleDeserializer::deserialize("CurrentBackupRateInMegaBytesPerSecond", stack)));
            }
"DBName" => {
                obj.db_name = Some(try!(StringDeserializer::deserialize("DBName", stack)));
            }
...
"EncryptedWithHSM" => {
                obj.encrypted_with_hsm = Some(try!(BooleanDeserializer::deserialize("EncryptedWithHSM", stack)));
            }
"EnhancedVpcRouting" => {
                obj.enhanced_vpc_routing = Some(try!(BooleanDeserializer::deserialize("EnhancedVpcRouting", stack)));
            }
"EstimatedSecondsToCompletion" => {
                obj.estimated_seconds_to_completion = Some(try!(LongDeserializer::deserialize("EstimatedSecondsToCompletion", stack)));
            }
"KmsKeyId" => {
                obj.kms_key_id = Some(try!(StringDeserializer::deserialize("KmsKeyId", stack)));
            }
...
"OwnerAccount" => {
                obj.owner_account = Some(try!(StringDeserializer::deserialize("OwnerAccount", stack)));
            }
"Port" => {
                obj.port = Some(try!(IntegerDeserializer::deserialize("Port", stack)));
            }
"RestorableNodeTypes" => {
                obj.restorable_node_types = Some(try!(RestorableNodeTypeListDeserializer::deserialize("RestorableNodeTypes", stack)));
            }
"SnapshotCreateTime" => {
                obj.snapshot_create_time = Some(try!(TStampDeserializer::deserialize("SnapshotCreateTime", stack)));
            }
"SnapshotIdentifier" => {
                obj.snapshot_identifier = Some(try!(StringDeserializer::deserialize("SnapshotIdentifier", stack)));
            }
"SnapshotType" => {
                obj.snapshot_type = Some(try!(StringDeserializer::deserialize("SnapshotType", stack)));
            }
"SourceRegion" => {
                obj.source_region = Some(try!(StringDeserializer::deserialize("SourceRegion", stack)));
            }
"Status" => {
                obj.status = Some(try!(StringDeserializer::deserialize("Status", stack)));
            }
...
"TotalBackupSizeInMegaBytes" => {
                obj.total_backup_size_in_mega_bytes = Some(try!(DoubleDeserializer::deserialize("TotalBackupSizeInMegaBytes", stack)));
            }
"VpcId" => {
                obj.vpc_id = Some(try!(StringDeserializer::deserialize("VpcId", stack)));
            }
...
"SnapshotCopyGrants" => {
                obj.snapshot_copy_grants = Some(try!(SnapshotCopyGrantListDeserializer::deserialize("SnapshotCopyGrants", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"Snapshots" => {
                obj.snapshots = Some(try!(SnapshotListDeserializer::deserialize("Snapshots", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct SubnetDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.subnet_availability_zone = Some(try!(AvailabilityZoneDeserializer::deserialize("SubnetAvailabilityZone", stack)));
            }
"SubnetIdentifier" => {
                obj.subnet_identifier = Some(try!(StringDeserializer::deserialize("SubnetIdentifier", stack)));
            }
"SubnetStatus" => {
                obj.subnet_status = Some(try!(StringDeserializer::deserialize("SubnetStatus", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"NewTableName" => {
                obj.new_table_name = Some(try!(StringDeserializer::deserialize("NewTableName", stack)));
            }
"ProgressInMegaBytes" => {
                obj.progress_in_mega_bytes = Some(try!(LongOptionalDeserializer::deserialize("ProgressInMegaBytes", stack)));
            }
"RequestTime" => {
                obj.request_time = Some(try!(TStampDeserializer::deserialize("RequestTime", stack)));
            }
"SnapshotIdentifier" => {
                obj.snapshot_identifier = Some(try!(StringDeserializer::deserialize("SnapshotIdentifier", stack)));
            }
"SourceDatabaseName" => {
                obj.source_database_name = Some(try!(StringDeserializer::deserialize("SourceDatabaseName", stack)));
            }
"SourceSchemaName" => {
                obj.source_schema_name = Some(try!(StringDeserializer::deserialize("SourceSchemaName", stack)));
            }
"SourceTableName" => {
                obj.source_table_name = Some(try!(StringDeserializer::deserialize("SourceTableName", stack)));
            }
"Status" => {
                obj.status = Some(try!(TableRestoreStatusTypeDeserializer::deserialize("Status", stack)));
            }
"TableRestoreRequestId" => {
                obj.table_restore_request_id = Some(try!(StringDeserializer::deserialize("TableRestoreRequestId", stack)));
            }
"TargetDatabaseName" => {
                obj.target_database_name = Some(try!(StringDeserializer::deserialize("TargetDatabaseName", stack)));
            }
"TargetSchemaName" => {
                obj.target_schema_name = Some(try!(StringDeserializer::deserialize("TargetSchemaName", stack)));
            }
"TotalDataInMegaBytes" => {
                obj.total_data_in_mega_bytes = Some(try!(LongOptionalDeserializer::deserialize("TotalDataInMegaBytes", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"TableRestoreStatusDetails" => {
                obj.table_restore_status_details = Some(try!(TableRestoreStatusListDeserializer::deserialize("TableRestoreStatusDetails", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ResourceName" => {
                obj.resource_name = Some(try!(StringDeserializer::deserialize("ResourceName", stack)));
            }
"ResourceType" => {
                obj.resource_type = Some(try!(StringDeserializer::deserialize("ResourceType", stack)));
            }
"Tag" => {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "TaggedResource" {
                        obj.push(try!(TaggedResourceDeserializer::deserialize("TaggedResource", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
...
"TaggedResources" => {
                obj.tagged_resources = Some(try!(TaggedResourceListDeserializer::deserialize("TaggedResources", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"VpcSecurityGroupId" => {
                obj.vpc_security_group_id = Some(try!(StringDeserializer::deserialize("VpcSecurityGroupId", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
                ...
                impl DeleteClusterError {
                    pub fn from_body(body: &str) -> DeleteClusterError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ClusterNotFoundFault" => DeleteClusterError::ClusterNotFoundFault(String::from(parsed_error.message)),"ClusterSnapshotAlreadyExistsFault" => DeleteClusterError::ClusterSnapshotAlreadyExistsFault(String::from(parsed_error.message)),"ClusterSnapshotQuotaExceededFault" => DeleteClusterError::ClusterSnapshotQuotaExceededFault(String::from(parsed_error.message)),"InvalidClusterStateFault" => DeleteClusterError::InvalidClusterStateFault(String::from(parsed_error.message)),_ => DeleteClusterError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DeleteClusterSnapshotError {
                    pub fn from_body(body: &str) -> DeleteClusterSnapshotError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ClusterSnapshotNotFoundFault" => DeleteClusterSnapshotError::ClusterSnapshotNotFoundFault(String::from(parsed_error.message)),"InvalidClusterSnapshotStateFault" => DeleteClusterSnapshotError::InvalidClusterSnapshotStateFault(String::from(parsed_error.message)),_ => DeleteClusterSnapshotError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DeleteClusterSubnetGroupError {
                    pub fn from_body(body: &str) -> DeleteClusterSubnetGroupError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ClusterSubnetGroupNotFoundFault" => DeleteClusterSubnetGroupError::ClusterSubnetGroupNotFoundFault(String::from(parsed_error.message)),"InvalidClusterSubnetGroupStateFault" => DeleteClusterSubnetGroupError::InvalidClusterSubnetGroupStateFault(String::from(parsed_error.message)),"InvalidClusterSubnetStateFault" => DeleteClusterSubnetGroupError::InvalidClusterSubnetStateFault(String::from(parsed_error.message)),_ => DeleteClusterSubnetGroupError::Unknown(String::from(body))
                                }
                           },
...
InvalidHsmClientCertificateStateFault(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
...
InvalidHsmConfigurationStateFault(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
...
SnapshotCopyGrantNotFoundFault(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl DeleteSnapshotCopyGrantError {
                    pub fn from_body(body: &str) -> DeleteSnapshotCopyGrantError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidSnapshotCopyGrantStateFault" => DeleteSnapshotCopyGrantError::InvalidSnapshotCopyGrantStateFault(String::from(parsed_error.message)),"SnapshotCopyGrantNotFoundFault" => DeleteSnapshotCopyGrantError::SnapshotCopyGrantNotFoundFault(String::from(parsed_error.message)),_ => DeleteSnapshotCopyGrantError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DeleteTagsError {
                    pub fn from_body(body: &str) -> DeleteTagsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidTagFault" => DeleteTagsError::InvalidTagFault(String::from(parsed_error.message)),"ResourceNotFoundFault" => DeleteTagsError::ResourceNotFoundFault(String::from(parsed_error.message)),_ => DeleteTagsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeClusterParameterGroupsError {
                    pub fn from_body(body: &str) -> DescribeClusterParameterGroupsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ClusterParameterGroupNotFoundFault" => DescribeClusterParameterGroupsError::ClusterParameterGroupNotFoundFault(String::from(parsed_error.message)),"InvalidTagFault" => DescribeClusterParameterGroupsError::InvalidTagFault(String::from(parsed_error.message)),_ => DescribeClusterParameterGroupsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeClusterParametersError {
                    pub fn from_body(body: &str) -> DescribeClusterParametersError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ClusterParameterGroupNotFoundFault" => DescribeClusterParametersError::ClusterParameterGroupNotFoundFault(String::from(parsed_error.message)),_ => DescribeClusterParametersError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeClusterSubnetGroupsError {
                    pub fn from_body(body: &str) -> DescribeClusterSubnetGroupsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ClusterSubnetGroupNotFoundFault" => DescribeClusterSubnetGroupsError::ClusterSubnetGroupNotFoundFault(String::from(parsed_error.message)),"InvalidTagFault" => DescribeClusterSubnetGroupsError::InvalidTagFault(String::from(parsed_error.message)),_ => DescribeClusterSubnetGroupsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeEventSubscriptionsError {
                    pub fn from_body(body: &str) -> DescribeEventSubscriptionsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "SubscriptionNotFoundFault" => DescribeEventSubscriptionsError::SubscriptionNotFoundFault(String::from(parsed_error.message)),_ => DescribeEventSubscriptionsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeHsmClientCertificatesError {
                    pub fn from_body(body: &str) -> DescribeHsmClientCertificatesError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "HsmClientCertificateNotFoundFault" => DescribeHsmClientCertificatesError::HsmClientCertificateNotFoundFault(String::from(parsed_error.message)),"InvalidTagFault" => DescribeHsmClientCertificatesError::InvalidTagFault(String::from(parsed_error.message)),_ => DescribeHsmClientCertificatesError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeHsmConfigurationsError {
                    pub fn from_body(body: &str) -> DescribeHsmConfigurationsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "HsmConfigurationNotFoundFault" => DescribeHsmConfigurationsError::HsmConfigurationNotFoundFault(String::from(parsed_error.message)),"InvalidTagFault" => DescribeHsmConfigurationsError::InvalidTagFault(String::from(parsed_error.message)),_ => DescribeHsmConfigurationsError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeLoggingStatusError {
                    pub fn from_body(body: &str) -> DescribeLoggingStatusError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ClusterNotFoundFault" => DescribeLoggingStatusError::ClusterNotFoundFault(String::from(parsed_error.message)),_ => DescribeLoggingStatusError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeReservedNodeOfferingsError {
                    pub fn from_body(body: &str) -> DescribeReservedNodeOfferingsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ReservedNodeOfferingNotFoundFault" => DescribeReservedNodeOfferingsError::ReservedNodeOfferingNotFoundFault(String::from(parsed_error.message)),"UnsupportedOperationFault" => DescribeReservedNodeOfferingsError::UnsupportedOperationFault(String::from(parsed_error.message)),_ => DescribeReservedNodeOfferingsError::Unknown(String::from(body))
                                }
                           },
...
ReservedNodeNotFoundFault(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl DescribeReservedNodesError {
                    pub fn from_body(body: &str) -> DescribeReservedNodesError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ReservedNodeNotFoundFault" => DescribeReservedNodesError::ReservedNodeNotFoundFault(String::from(parsed_error.message)),_ => DescribeReservedNodesError::Unknown(String::from(body))
                                }
                           },
...
ResizeNotFoundFault(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl DescribeResizeError {
                    pub fn from_body(body: &str) -> DescribeResizeError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ClusterNotFoundFault" => DescribeResizeError::ClusterNotFoundFault(String::from(parsed_error.message)),"ResizeNotFoundFault" => DescribeResizeError::ResizeNotFoundFault(String::from(parsed_error.message)),_ => DescribeResizeError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeSnapshotCopyGrantsError {
                    pub fn from_body(body: &str) -> DescribeSnapshotCopyGrantsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidTagFault" => DescribeSnapshotCopyGrantsError::InvalidTagFault(String::from(parsed_error.message)),"SnapshotCopyGrantNotFoundFault" => DescribeSnapshotCopyGrantsError::SnapshotCopyGrantNotFoundFault(String::from(parsed_error.message)),_ => DescribeSnapshotCopyGrantsError::Unknown(String::from(body))
                                }
                           },
...
TableRestoreNotFoundFault(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl DescribeTableRestoreStatusError {
                    pub fn from_body(body: &str) -> DescribeTableRestoreStatusError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ClusterNotFoundFault" => DescribeTableRestoreStatusError::ClusterNotFoundFault(String::from(parsed_error.message)),"TableRestoreNotFoundFault" => DescribeTableRestoreStatusError::TableRestoreNotFoundFault(String::from(parsed_error.message)),_ => DescribeTableRestoreStatusError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DisableLoggingError {
                    pub fn from_body(body: &str) -> DisableLoggingError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ClusterNotFoundFault" => DisableLoggingError::ClusterNotFoundFault(String::from(parsed_error.message)),_ => DisableLoggingError::Unknown(String::from(body))
                                }
                           },
                ...
                impl RevokeClusterSecurityGroupIngressError {
                    pub fn from_body(body: &str) -> RevokeClusterSecurityGroupIngressError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "AuthorizationNotFoundFault" => RevokeClusterSecurityGroupIngressError::AuthorizationNotFoundFault(String::from(parsed_error.message)),"ClusterSecurityGroupNotFoundFault" => RevokeClusterSecurityGroupIngressError::ClusterSecurityGroupNotFoundFault(String::from(parsed_error.message)),"InvalidClusterSecurityGroupStateFault" => RevokeClusterSecurityGroupIngressError::InvalidClusterSecurityGroupStateFault(String::from(parsed_error.message)),_ => RevokeClusterSecurityGroupIngressError::Unknown(String::from(body))
                                }
                           },
...
/// A client for the Amazon Redshift API.
        pub struct RedshiftClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            credentials_provider: P,
            region: region::Region,
            dispatcher: D,
        }

        impl<P, D> RedshiftClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
        ...
        impl<P, D> Redshift for RedshiftClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
        ...
        fn test_parse_valid_redshift_create_cluster_subnet_group() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/valid", "redshift-create-cluster-subnet-group.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = RedshiftClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_valid_redshift_describe_cluster_parameter_groups() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/valid", "redshift-describe-cluster-parameter-groups.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = RedshiftClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_valid_redshift_describe_cluster_versions() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/valid", "redshift-describe-cluster-versions.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = RedshiftClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_valid_redshift_reboot_cluster() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/valid", "redshift-reboot-cluster.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = RedshiftClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_valid_redshift_restore_from_cluster_snapshot() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/valid", "redshift-restore-from-cluster-snapshot.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = RedshiftClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
