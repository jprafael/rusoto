        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "HeaderName" => {
                obj.header_name = try!(HeaderNameDeserializer::deserialize("HeaderName", stack));
            }
"HeaderValue" => {
                obj.header_value = try!(HeaderValueDeserializer::deserialize("HeaderValue", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct AddressListDeserializer;
        ...
        Ok(obj)
            ...
            impl AddressListSerializer {
                fn serialize(params: &mut Params, name: &str, obj: &AddressList) {
...
struct AmazonResourceNameDeserializer;
            impl AmazonResourceNameDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<AmazonResourceName, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
pub type ArrivalDate = String;
pub type BehaviorOnMXFailure = String;
...
pub topic_arn: Option<AmazonResourceName>,
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Message" => {
                obj.message = try!(BounceMessageDeserializer::deserialize("Message", stack));
            }
"Sender" => {
                obj.sender = try!(AddressDeserializer::deserialize("Sender", stack));
            }
"SmtpReplyCode" => {
                obj.smtp_reply_code = try!(BounceSmtpReplyCodeDeserializer::deserialize("SmtpReplyCode", stack));
            }
"StatusCode" => {
                obj.status_code = Some(try!(BounceStatusCodeDeserializer::deserialize("StatusCode", stack)));
            }
"TopicArn" => {
                obj.topic_arn = Some(try!(AmazonResourceNameDeserializer::deserialize("TopicArn", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
params.put(&format!("{}{}", prefix, "SmtpReplyCode"), &obj.smtp_reply_code);
...
pub type BounceMessage = String;
struct BounceMessageDeserializer;
            impl BounceMessageDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<BounceMessage, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
pub type BounceSmtpReplyCode = String;
struct BounceSmtpReplyCodeDeserializer;
            impl BounceSmtpReplyCodeDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<BounceSmtpReplyCode, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
pub type BounceStatusCode = String;
struct BounceStatusCodeDeserializer;
            impl BounceStatusCodeDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<BounceStatusCode, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
pub recipient_arn: Option<AmazonResourceName>,
...
pub type BouncedRecipientInfoList = Vec<BouncedRecipientInfo>;
            ...
            impl BouncedRecipientInfoListSerializer {
                fn serialize(params: &mut Params, name: &str, obj: &BouncedRecipientInfoList) {
                    for (index, obj) in obj.iter().enumerate() {
                    let key = format!("{}.member.{}", name, index+1);
...
pub original_rule_set_name: ReceiptRuleSetName,
...
pub rule_set_name: ReceiptRuleSetName,
        ...
        params.put(&format!("{}{}", prefix, "OriginalRuleSetName"), &obj.original_rule_set_name);
...
pub default_dimension_value: DefaultDimensionValue,
...
struct CloudWatchDimensionConfigurationDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.default_dimension_value = try!(DefaultDimensionValueDeserializer::deserialize("DefaultDimensionValue", stack));
            }
"DimensionName" => {
                obj.dimension_name = try!(DimensionNameDeserializer::deserialize("DimensionName", stack));
            }
"DimensionValueSource" => {
                obj.dimension_value_source = try!(DimensionValueSourceDeserializer::deserialize("DimensionValueSource", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        params.put(&format!("{}{}", prefix, "DefaultDimensionValue"), &obj.default_dimension_value);
params.put(&format!("{}{}", prefix, "DimensionName"), &obj.dimension_name);
params.put(&format!("{}{}", prefix, "DimensionValueSource"), &obj.dimension_value_source);
        
                }
            }
            
pub type CloudWatchDimensionConfigurations = Vec<CloudWatchDimensionConfiguration>;
struct CloudWatchDimensionConfigurationsDeserializer;
            impl CloudWatchDimensionConfigurationsDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<CloudWatchDimensionConfigurations, XmlParseError> {
        ...
        Ok(obj)
            ...
            impl CloudWatchDimensionConfigurationsSerializer {
                fn serialize(params: &mut Params, name: &str, obj: &CloudWatchDimensionConfigurations) {
                    for (index, obj) in obj.iter().enumerate() {
                    let key = format!("{}.member.{}", name, index+1);
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Name" => {
                obj.name = try!(ConfigurationSetNameDeserializer::deserialize("Name", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub type ConfigurationSetAttribute = String;
pub type ConfigurationSetAttributeList = Vec<ConfigurationSetAttribute>;
            ...
            impl ConfigurationSetAttributeListSerializer {
                fn serialize(params: &mut Params, name: &str, obj: &ConfigurationSetAttributeList) {
                    for (index, obj) in obj.iter().enumerate() {
                    let key = format!("{}.member.{}", name, index+1);
params.put(&key, &obj);
}
...
pub type ConfigurationSetName = String;
struct ConfigurationSetNameDeserializer;
            impl ConfigurationSetNameDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<ConfigurationSetName, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
pub type ConfigurationSets = Vec<ConfigurationSet>;
struct ConfigurationSetsDeserializer;
            impl ConfigurationSetsDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<ConfigurationSets, XmlParseError> {
...
pub event_destination: EventDestination,
            ...
            impl CreateConfigurationSetEventDestinationRequestSerializer {
                fn serialize(params: &mut Params, name: &str, obj: &CreateConfigurationSetEventDestinationRequest) {
                    let mut prefix = name.to_string();
        if prefix != "" {
            prefix.push_str(".");
        }

        params.put(&format!("{}{}", prefix, "ConfigurationSetName"), &obj.configuration_set_name);
...
pub filter: ReceiptFilter,
        ...
        ReceiptFilterSerializer::serialize(
                params,
...
pub after: Option<ReceiptRuleName>,
...
ReceiptRuleSerializer::serialize(
                params,
                &format!("{}{}", prefix, "Rule"),
                &obj.rule,
            );
...
pub type CustomMailFromStatus = String;
...
pub type DefaultDimensionValue = String;
struct DefaultDimensionValueDeserializer;
            impl DefaultDimensionValueDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<DefaultDimensionValue, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
pub event_destination_name: EventDestinationName,
            }
            ...
            impl DeleteConfigurationSetEventDestinationRequestSerializer {
                fn serialize(params: &mut Params, name: &str, obj: &DeleteConfigurationSetEventDestinationRequest) {
                    let mut prefix = name.to_string();
        if prefix != "" {
            prefix.push_str(".");
        }
        ...
        params.put(&format!("{}{}", prefix, "ConfigurationSetName"), &obj.configuration_set_name);
params.put(&format!("{}{}", prefix, "EventDestinationName"), &obj.event_destination_name);
...
pub filter_name: ReceiptFilterName,
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Metadata" => {
                obj.metadata = Some(try!(ReceiptRuleSetMetadataDeserializer::deserialize("Metadata", stack)));
            }
"Rules" => {
                obj.rules = Some(try!(ReceiptRulesListDeserializer::deserialize("Rules", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ConfigurationSet" => {
                obj.configuration_set = Some(try!(ConfigurationSetDeserializer::deserialize("ConfigurationSet", stack)));
            }
"EventDestinations" => {
                obj.event_destinations = Some(try!(EventDestinationsDeserializer::deserialize("EventDestinations", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub type DimensionValueSource = String;
...
pub type DkimAttributes = ::std::collections::HashMap<Identity, IdentityDkimAttributes>;
struct DkimAttributesDeserializer;
            impl DkimAttributesDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<DkimAttributes, XmlParseError> {
                    try!(start_element(tag_name, stack));
...
pub type DsnAction = String;
pub type DsnStatus = String;
pub type Enabled = bool;
struct EnabledDeserializer;
            impl EnabledDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<Enabled, XmlParseError> {
                    try!(start_element(tag_name, stack));
...
struct EventDestinationDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.cloud_watch_destination = Some(try!(CloudWatchDestinationDeserializer::deserialize("CloudWatchDestination", stack)));
            }
"Enabled" => {
                obj.enabled = Some(try!(EnabledDeserializer::deserialize("Enabled", stack)));
            }
...
"MatchingEventTypes" => {
                obj.matching_event_types = try!(EventTypesDeserializer::deserialize("MatchingEventTypes", stack));
            }
"Name" => {
                obj.name = try!(EventDestinationNameDeserializer::deserialize("Name", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub type EventDestinationName = String;
struct EventDestinationNameDeserializer;
            impl EventDestinationNameDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<EventDestinationName, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
pub type EventDestinations = Vec<EventDestination>;
struct EventDestinationsDeserializer;
            impl EventDestinationsDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<EventDestinations, XmlParseError> {
...
pub type EventTypes = Vec<EventType>;
struct EventTypesDeserializer;
            impl EventTypesDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<EventTypes, XmlParseError> {
        ...
        Ok(obj)
            ...
            impl EventTypesSerializer {
                fn serialize(params: &mut Params, name: &str, obj: &EventTypes) {
                    for (index, obj) in obj.iter().enumerate() {
                    let key = format!("{}.member.{}", name, index+1);
params.put(&key, &obj);
}
...
pub type ExtensionFieldList = Vec<ExtensionField>;
            ...
            impl ExtensionFieldListSerializer {
                fn serialize(params: &mut Params, name: &str, obj: &ExtensionFieldList) {
                    for (index, obj) in obj.iter().enumerate() {
                    let key = format!("{}.member.{}", name, index+1);
...
pub type ExtensionFieldName = String;
pub type ExtensionFieldValue = String;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "DkimAttributes" => {
                obj.dkim_attributes = try!(DkimAttributesDeserializer::deserialize("DkimAttributes", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub identities: IdentityList,
            ...
            impl GetIdentityMailFromDomainAttributesRequestSerializer {
                fn serialize(params: &mut Params, name: &str, obj: &GetIdentityMailFromDomainAttributesRequest) {
                    let mut prefix = name.to_string();
        if prefix != "" {
            prefix.push_str(".");
        }
...
pub mail_from_domain_attributes: MailFromDomainAttributes,
            }
...
struct GetIdentityMailFromDomainAttributesResponseDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.mail_from_domain_attributes = try!(MailFromDomainAttributesDeserializer::deserialize("MailFromDomainAttributes", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct GetIdentityNotificationAttributesResponseDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.notification_attributes = try!(NotificationAttributesDeserializer::deserialize("NotificationAttributes", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub verification_attributes: VerificationAttributes,
            }
...
struct GetIdentityVerificationAttributesResponseDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.verification_attributes = try!(VerificationAttributesDeserializer::deserialize("VerificationAttributes", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Max24HourSend" => {
                obj.max_24_hour_send = Some(try!(Max24HourSendDeserializer::deserialize("Max24HourSend", stack)));
            }
"MaxSendRate" => {
                obj.max_send_rate = Some(try!(MaxSendRateDeserializer::deserialize("MaxSendRate", stack)));
            }
"SentLast24Hours" => {
                obj.sent_last_24_hours = Some(try!(SentLast24HoursDeserializer::deserialize("SentLast24Hours", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "SendDataPoints" => {
                obj.send_data_points = Some(try!(SendDataPointListDeserializer::deserialize("SendDataPoints", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct HeaderNameDeserializer;
            impl HeaderNameDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<HeaderName, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
struct HeaderValueDeserializer;
            impl HeaderValueDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<HeaderValue, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "DkimEnabled" => {
                obj.dkim_enabled = try!(EnabledDeserializer::deserialize("DkimEnabled", stack));
            }
"DkimTokens" => {
                obj.dkim_tokens = Some(try!(VerificationTokenListDeserializer::deserialize("DkimTokens", stack)));
            }
"DkimVerificationStatus" => {
                obj.dkim_verification_status = try!(VerificationStatusDeserializer::deserialize("DkimVerificationStatus", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct IdentityListDeserializer;
            impl IdentityListDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<IdentityList, XmlParseError> {
        ...
        Ok(obj)
            ...
            impl IdentityListSerializer {
                fn serialize(params: &mut Params, name: &str, obj: &IdentityList) {
                    for (index, obj) in obj.iter().enumerate() {
                    let key = format!("{}.member.{}", name, index+1);
params.put(&key, &obj);
}
...
pub mail_from_domain: MailFromDomainName,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "BehaviorOnMXFailure" => {
                obj.behavior_on_mx_failure = try!(BehaviorOnMXFailureDeserializer::deserialize("BehaviorOnMXFailure", stack));
            }
"MailFromDomain" => {
                obj.mail_from_domain = try!(MailFromDomainNameDeserializer::deserialize("MailFromDomain", stack));
            }
"MailFromDomainStatus" => {
                obj.mail_from_domain_status = try!(CustomMailFromStatusDeserializer::deserialize("MailFromDomainStatus", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub forwarding_enabled: Enabled,
...
pub headers_in_bounce_notifications_enabled: Option<Enabled>,
...
pub headers_in_complaint_notifications_enabled: Option<Enabled>,
...
pub headers_in_delivery_notifications_enabled: Option<Enabled>,
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "BounceTopic" => {
                obj.bounce_topic = try!(NotificationTopicDeserializer::deserialize("BounceTopic", stack));
            }
"ComplaintTopic" => {
                obj.complaint_topic = try!(NotificationTopicDeserializer::deserialize("ComplaintTopic", stack));
            }
"DeliveryTopic" => {
                obj.delivery_topic = try!(NotificationTopicDeserializer::deserialize("DeliveryTopic", stack));
            }
"ForwardingEnabled" => {
                obj.forwarding_enabled = try!(EnabledDeserializer::deserialize("ForwardingEnabled", stack));
            }
"HeadersInBounceNotificationsEnabled" => {
                obj.headers_in_bounce_notifications_enabled = Some(try!(EnabledDeserializer::deserialize("HeadersInBounceNotificationsEnabled", stack)));
            }
"HeadersInComplaintNotificationsEnabled" => {
                obj.headers_in_complaint_notifications_enabled = Some(try!(EnabledDeserializer::deserialize("HeadersInComplaintNotificationsEnabled", stack)));
            }
"HeadersInDeliveryNotificationsEnabled" => {
                obj.headers_in_delivery_notifications_enabled = Some(try!(EnabledDeserializer::deserialize("HeadersInDeliveryNotificationsEnabled", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "VerificationStatus" => {
                obj.verification_status = try!(VerificationStatusDeserializer::deserialize("VerificationStatus", stack));
            }
"VerificationToken" => {
                obj.verification_token = Some(try!(VerificationTokenDeserializer::deserialize("VerificationToken", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub delivery_stream_arn: AmazonResourceName,
...
pub iam_role_arn: AmazonResourceName,
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "DeliveryStreamARN" => {
                obj.delivery_stream_arn = try!(AmazonResourceNameDeserializer::deserialize("DeliveryStreamARN", stack));
            }
"IAMRoleARN" => {
                obj.iam_role_arn = try!(AmazonResourceNameDeserializer::deserialize("IAMRoleARN", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        params.put(&format!("{}{}", prefix, "DeliveryStreamARN"), &obj.delivery_stream_arn);
...
pub function_arn: AmazonResourceName,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "FunctionArn" => {
                obj.function_arn = try!(AmazonResourceNameDeserializer::deserialize("FunctionArn", stack));
            }
"InvocationType" => {
                obj.invocation_type = Some(try!(InvocationTypeDeserializer::deserialize("InvocationType", stack)));
            }
"TopicArn" => {
                obj.topic_arn = Some(try!(AmazonResourceNameDeserializer::deserialize("TopicArn", stack)));
            }
...
pub type LastAttemptDate = String;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ConfigurationSets" => {
                obj.configuration_sets = Some(try!(ConfigurationSetsDeserializer::deserialize("ConfigurationSets", stack)));
            }
"NextToken" => {
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Identities" => {
                obj.identities = try!(IdentityListDeserializer::deserialize("Identities", stack));
            }
"NextToken" => {
                obj.next_token = Some(try!(NextTokenDeserializer::deserialize("NextToken", stack)));
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "PolicyNames" => {
                obj.policy_names = try!(PolicyNameListDeserializer::deserialize("PolicyNames", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Filters" => {
                obj.filters = Some(try!(ReceiptFilterListDeserializer::deserialize("Filters", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"RuleSets" => {
                obj.rule_sets = Some(try!(ReceiptRuleSetsListsDeserializer::deserialize("RuleSets", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct ListVerifiedEmailAddressesResponseDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.verified_email_addresses = Some(try!(AddressListDeserializer::deserialize("VerifiedEmailAddresses", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub type MailFromDomainAttributes = ::std::collections::HashMap<Identity, IdentityMailFromDomainAttributes>;
struct MailFromDomainAttributesDeserializer;
            impl MailFromDomainAttributesDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<MailFromDomainAttributes, XmlParseError> {
                    try!(start_element(tag_name, stack));
        ...
        while try!(peek_at_name(stack)) == "entry" {
            try!(start_element("entry", stack));
            let key = try!(IdentityDeserializer::deserialize("key", stack));
            let value = try!(IdentityMailFromDomainAttributesDeserializer::deserialize("value", stack));
            obj.insert(key, value);
            try!(end_element("entry", stack));
        }
...
pub type MailFromDomainName = String;
struct MailFromDomainNameDeserializer;
            impl MailFromDomainNameDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<MailFromDomainName, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
pub arrival_date: Option<ArrivalDate>,
...
pub reporting_mta: ReportingMta,
            }
...
pub type MessageTagName = String;
pub type MessageTagValue = String;
...
pub type NotificationAttributes = ::std::collections::HashMap<Identity, IdentityNotificationAttributes>;
struct NotificationAttributesDeserializer;
            impl NotificationAttributesDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<NotificationAttributes, XmlParseError> {
                    try!(start_element(tag_name, stack));
        ...
        while try!(peek_at_name(stack)) == "entry" {
            try!(start_element("entry", stack));
            let key = try!(IdentityDeserializer::deserialize("key", stack));
            let value = try!(IdentityNotificationAttributesDeserializer::deserialize("value", stack));
            obj.insert(key, value);
            try!(end_element("entry", stack));
        }
...
pub type NotificationTopic = String;
struct NotificationTopicDeserializer;
            impl NotificationTopicDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<NotificationTopic, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
pub type PolicyMap = ::std::collections::HashMap<PolicyName, Policy>;
struct PolicyMapDeserializer;
            impl PolicyMapDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<PolicyMap, XmlParseError> {
                    try!(start_element(tag_name, stack));
...
pub type PolicyNameList = Vec<PolicyName>;
struct PolicyNameListDeserializer;
            impl PolicyNameListDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<PolicyNameList, XmlParseError> {
        ...
        Ok(obj)
            ...
            impl PolicyNameListSerializer {
                fn serialize(params: &mut Params, name: &str, obj: &PolicyNameList) {
                    for (index, obj) in obj.iter().enumerate() {
                    let key = format!("{}.member.{}", name, index+1);
params.put(&key, &obj);
}
...
pub data: RawMessageData,
        ...
        params.put(&format!("{}{}", prefix, "Data"), ::std::str::from_utf8(&obj.data).unwrap());
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AddHeaderAction" => {
                obj.add_header_action = Some(try!(AddHeaderActionDeserializer::deserialize("AddHeaderAction", stack)));
            }
"BounceAction" => {
                obj.bounce_action = Some(try!(BounceActionDeserializer::deserialize("BounceAction", stack)));
            }
"LambdaAction" => {
                obj.lambda_action = Some(try!(LambdaActionDeserializer::deserialize("LambdaAction", stack)));
            }
"S3Action" => {
                obj.s3_action = Some(try!(S3ActionDeserializer::deserialize("S3Action", stack)));
            }
"SNSAction" => {
                obj.sns_action = Some(try!(SNSActionDeserializer::deserialize("SNSAction", stack)));
            }
"StopAction" => {
                obj.stop_action = Some(try!(StopActionDeserializer::deserialize("StopAction", stack)));
            }
"WorkmailAction" => {
                obj.workmail_action = Some(try!(WorkmailActionDeserializer::deserialize("WorkmailAction", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub type ReceiptActionsList = Vec<ReceiptAction>;
struct ReceiptActionsListDeserializer;
            impl ReceiptActionsListDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<ReceiptActionsList, XmlParseError> {
        ...
        Ok(obj)
            ...
            impl ReceiptActionsListSerializer {
                fn serialize(params: &mut Params, name: &str, obj: &ReceiptActionsList) {
                    for (index, obj) in obj.iter().enumerate() {
                    let key = format!("{}.member.{}", name, index+1);
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "IpFilter" => {
                obj.ip_filter = try!(ReceiptIpFilterDeserializer::deserialize("IpFilter", stack));
            }
"Name" => {
...
pub type ReceiptFilterList = Vec<ReceiptFilter>;
struct ReceiptFilterListDeserializer;
            impl ReceiptFilterListDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<ReceiptFilterList, XmlParseError> {
...
pub type ReceiptFilterName = String;
struct ReceiptFilterNameDeserializer;
            impl ReceiptFilterNameDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<ReceiptFilterName, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
pub type ReceiptFilterPolicy = String;
...
"Policy" => {
                obj.policy = try!(ReceiptFilterPolicyDeserializer::deserialize("Policy", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub scan_enabled: Option<Enabled>,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Actions" => {
                obj.actions = Some(try!(ReceiptActionsListDeserializer::deserialize("Actions", stack)));
            }
"Enabled" => {
                obj.enabled = Some(try!(EnabledDeserializer::deserialize("Enabled", stack)));
            }
...
"Recipients" => {
                obj.recipients = Some(try!(RecipientsListDeserializer::deserialize("Recipients", stack)));
            }
"ScanEnabled" => {
                obj.scan_enabled = Some(try!(EnabledDeserializer::deserialize("ScanEnabled", stack)));
            }
"TlsPolicy" => {
                obj.tls_policy = Some(try!(TlsPolicyDeserializer::deserialize("TlsPolicy", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
if let Some(ref field_value) = obj.scan_enabled {
                params.put(&format!("{}{}", prefix, "ScanEnabled"), &field_value.to_string());
            }
...
pub type ReceiptRuleName = String;
struct ReceiptRuleNameDeserializer;
            impl ReceiptRuleNameDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<ReceiptRuleName, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
pub type ReceiptRuleNamesList = Vec<ReceiptRuleName>;
            ...
            impl ReceiptRuleNamesListSerializer {
                fn serialize(params: &mut Params, name: &str, obj: &ReceiptRuleNamesList) {
                    for (index, obj) in obj.iter().enumerate() {
                    let key = format!("{}.member.{}", name, index+1);
params.put(&key, &obj);
}
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "CreatedTimestamp" => {
                obj.created_timestamp = Some(try!(TimestampDeserializer::deserialize("CreatedTimestamp", stack)));
            }
"Name" => {
                obj.name = Some(try!(ReceiptRuleSetNameDeserializer::deserialize("Name", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub type ReceiptRuleSetName = String;
struct ReceiptRuleSetNameDeserializer;
            impl ReceiptRuleSetNameDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<ReceiptRuleSetName, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
pub type ReceiptRuleSetsLists = Vec<ReceiptRuleSetMetadata>;
struct ReceiptRuleSetsListsDeserializer;
            impl ReceiptRuleSetsListsDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<ReceiptRuleSetsLists, XmlParseError> {
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(ReceiptRuleSetMetadataDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
...
pub type ReceiptRulesList = Vec<ReceiptRule>;
struct ReceiptRulesListDeserializer;
            impl ReceiptRulesListDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<ReceiptRulesList, XmlParseError> {
...
struct RecipientDeserializer;
            impl RecipientDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<Recipient, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
pub final_recipient: Option<Address>,
...
pub last_attempt_date: Option<LastAttemptDate>,
...
pub type RecipientsList = Vec<Recipient>;
struct RecipientsListDeserializer;
            impl RecipientsListDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<RecipientsList, XmlParseError> {
        ...
        Ok(obj)
            ...
            impl RecipientsListSerializer {
                fn serialize(params: &mut Params, name: &str, obj: &RecipientsList) {
                    for (index, obj) in obj.iter().enumerate() {
                    let key = format!("{}.member.{}", name, index+1);
params.put(&key, &obj);
}
...
pub type ReportingMta = String;
pub type RuleOrRuleSetName = String;
...
pub kms_key_arn: Option<AmazonResourceName>,
...
pub object_key_prefix: Option<S3KeyPrefix>,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "BucketName" => {
                obj.bucket_name = try!(S3BucketNameDeserializer::deserialize("BucketName", stack));
            }
"KmsKeyArn" => {
                obj.kms_key_arn = Some(try!(AmazonResourceNameDeserializer::deserialize("KmsKeyArn", stack)));
            }
"ObjectKeyPrefix" => {
                obj.object_key_prefix = Some(try!(S3KeyPrefixDeserializer::deserialize("ObjectKeyPrefix", stack)));
            }
"TopicArn" => {
                obj.topic_arn = Some(try!(AmazonResourceNameDeserializer::deserialize("TopicArn", stack)));
            }
...
struct S3KeyPrefixDeserializer;
            impl S3KeyPrefixDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<S3KeyPrefix, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
pub topic_arn: AmazonResourceName,
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Encoding" => {
                obj.encoding = Some(try!(SNSActionEncodingDeserializer::deserialize("Encoding", stack)));
            }
"TopicArn" => {
                obj.topic_arn = try!(AmazonResourceNameDeserializer::deserialize("TopicArn", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub type SNSActionEncoding = String;
...
pub bounce_sender_arn: Option<AmazonResourceName>,
...
params.put(&format!("{}{}", prefix, "OriginalMessageId"), &obj.original_message_id);
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "Bounces" => {
                obj.bounces = Some(try!(CounterDeserializer::deserialize("Bounces", stack)));
            }
"Complaints" => {
                obj.complaints = Some(try!(CounterDeserializer::deserialize("Complaints", stack)));
            }
"DeliveryAttempts" => {
                obj.delivery_attempts = Some(try!(CounterDeserializer::deserialize("DeliveryAttempts", stack)));
            }
"Rejects" => {
                obj.rejects = Some(try!(CounterDeserializer::deserialize("Rejects", stack)));
            }
"Timestamp" => {
                obj.timestamp = Some(try!(TimestampDeserializer::deserialize("Timestamp", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub type SendDataPointList = Vec<SendDataPoint>;
struct SendDataPointListDeserializer;
            impl SendDataPointListDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<SendDataPointList, XmlParseError> {
...
pub configuration_set_name: Option<ConfigurationSetName>,
...
pub return_path_arn: Option<AmazonResourceName>,
...
pub source_arn: Option<AmazonResourceName>,
...
pub tags: Option<MessageTagList>,
        ...
        if let Some(ref field_value) = obj.configuration_set_name {
                params.put(&format!("{}{}", prefix, "ConfigurationSetName"), &field_value);
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "MessageId" => {
                obj.message_id = try!(MessageIdDeserializer::deserialize("MessageId", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub from_arn: Option<AmazonResourceName>,
...
pub rule_set_name: Option<ReceiptRuleSetName>,
            }
...
pub identity: Identity,
        ...
        params.put(&format!("{}{}", prefix, "DkimEnabled"), &obj.dkim_enabled.to_string());
params.put(&format!("{}{}", prefix, "Identity"), &obj.identity);
...
pub identity: Identity,
            ...
            impl SetIdentityFeedbackForwardingEnabledRequestSerializer {
                fn serialize(params: &mut Params, name: &str, obj: &SetIdentityFeedbackForwardingEnabledRequest) {
                    let mut prefix = name.to_string();
        if prefix != "" {
            prefix.push_str(".");
        }

        params.put(&format!("{}{}", prefix, "ForwardingEnabled"), &obj.forwarding_enabled.to_string());
params.put(&format!("{}{}", prefix, "Identity"), &obj.identity);
...
pub notification_type: NotificationType,
            ...
            impl SetIdentityHeadersInNotificationsEnabledRequestSerializer {
                fn serialize(params: &mut Params, name: &str, obj: &SetIdentityHeadersInNotificationsEnabledRequest) {
                    let mut prefix = name.to_string();
        if prefix != "" {
            prefix.push_str(".");
        }
...
params.put(&format!("{}{}", prefix, "Identity"), &obj.identity);
params.put(&format!("{}{}", prefix, "NotificationType"), &obj.notification_type);
...
pub mail_from_domain: Option<MailFromDomainName>,
            }
        ...
        if let Some(ref field_value) = obj.behavior_on_mx_failure {
                params.put(&format!("{}{}", prefix, "BehaviorOnMXFailure"), &field_value);
            }
params.put(&format!("{}{}", prefix, "Identity"), &obj.identity);
...
pub sns_topic: Option<NotificationTopic>,
            }
...
pub event_destination: EventDestination,
            ...
            impl UpdateConfigurationSetEventDestinationRequestSerializer {
                fn serialize(params: &mut Params, name: &str, obj: &UpdateConfigurationSetEventDestinationRequest) {
                    let mut prefix = name.to_string();
        if prefix != "" {
            prefix.push_str(".");
        }
...
pub type VerificationAttributes = ::std::collections::HashMap<Identity, IdentityVerificationAttributes>;
struct VerificationAttributesDeserializer;
            impl VerificationAttributesDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<VerificationAttributes, XmlParseError> {
                    try!(start_element(tag_name, stack));
        ...
        while try!(peek_at_name(stack)) == "entry" {
            try!(start_element("entry", stack));
            let key = try!(IdentityDeserializer::deserialize("key", stack));
            let value = try!(IdentityVerificationAttributesDeserializer::deserialize("value", stack));
            obj.insert(key, value);
            try!(end_element("entry", stack));
        }
...
pub type VerificationStatus = String;
...
pub type VerificationToken = String;
struct VerificationTokenDeserializer;
            impl VerificationTokenDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<VerificationToken, XmlParseError> {
                    try!(start_element(tag_name, stack));
        let obj = try!(characters(stack));
        try!(end_element(tag_name, stack));
...
pub type VerificationTokenList = Vec<VerificationToken>;
struct VerificationTokenListDeserializer;
            impl VerificationTokenListDeserializer {
                #[allow(unused_variables)]
                fn deserialize<'a, T: Peek + Next>(tag_name: &str, stack: &mut T)
                -> Result<VerificationTokenList, XmlParseError> {
...
pub dkim_tokens: VerificationTokenList,
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "DkimTokens" => {
                obj.dkim_tokens = try!(VerificationTokenListDeserializer::deserialize("DkimTokens", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "VerificationToken" => {
                obj.verification_token = try!(VerificationTokenDeserializer::deserialize("VerificationToken", stack));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub organization_arn: AmazonResourceName,
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "OrganizationArn" => {
                obj.organization_arn = try!(AmazonResourceNameDeserializer::deserialize("OrganizationArn", stack));
            }
"TopicArn" => {
                obj.topic_arn = Some(try!(AmazonResourceNameDeserializer::deserialize("TopicArn", stack)));
            }
        ...
        params.put(&format!("{}{}", prefix, "OrganizationArn"), &obj.organization_arn);
if let Some(ref field_value) = obj.topic_arn {
                params.put(&format!("{}{}", prefix, "TopicArn"), &field_value);
            }
                ...
                impl CreateConfigurationSetError {
                    pub fn from_body(body: &str) -> CreateConfigurationSetError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ConfigurationSetAlreadyExistsException" => CreateConfigurationSetError::ConfigurationSetAlreadyExists(String::from(parsed_error.message)),"InvalidConfigurationSetException" => CreateConfigurationSetError::InvalidConfigurationSet(String::from(parsed_error.message)),"LimitExceededException" => CreateConfigurationSetError::LimitExceeded(String::from(parsed_error.message)),_ => CreateConfigurationSetError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DeleteConfigurationSetError {
                    pub fn from_body(body: &str) -> DeleteConfigurationSetError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ConfigurationSetDoesNotExistException" => DeleteConfigurationSetError::ConfigurationSetDoesNotExist(String::from(parsed_error.message)),_ => DeleteConfigurationSetError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DeleteConfigurationSetEventDestinationError {
                    pub fn from_body(body: &str) -> DeleteConfigurationSetEventDestinationError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ConfigurationSetDoesNotExistException" => DeleteConfigurationSetEventDestinationError::ConfigurationSetDoesNotExist(String::from(parsed_error.message)),"EventDestinationDoesNotExistException" => DeleteConfigurationSetEventDestinationError::EventDestinationDoesNotExist(String::from(parsed_error.message)),_ => DeleteConfigurationSetEventDestinationError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DeleteReceiptRuleError {
                    pub fn from_body(body: &str) -> DeleteReceiptRuleError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "RuleSetDoesNotExistException" => DeleteReceiptRuleError::RuleSetDoesNotExist(String::from(parsed_error.message)),_ => DeleteReceiptRuleError::Unknown(String::from(body))
                                }
                           },
...
CannotDelete(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl DeleteReceiptRuleSetError {
                    pub fn from_body(body: &str) -> DeleteReceiptRuleSetError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "CannotDeleteException" => DeleteReceiptRuleSetError::CannotDelete(String::from(parsed_error.message)),_ => DeleteReceiptRuleSetError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeConfigurationSetError {
                    pub fn from_body(body: &str) -> DescribeConfigurationSetError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "ConfigurationSetDoesNotExistException" => DescribeConfigurationSetError::ConfigurationSetDoesNotExist(String::from(parsed_error.message)),_ => DescribeConfigurationSetError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeReceiptRuleError {
                    pub fn from_body(body: &str) -> DescribeReceiptRuleError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "RuleDoesNotExistException" => DescribeReceiptRuleError::RuleDoesNotExist(String::from(parsed_error.message)),"RuleSetDoesNotExistException" => DescribeReceiptRuleError::RuleSetDoesNotExist(String::from(parsed_error.message)),_ => DescribeReceiptRuleError::Unknown(String::from(body))
                                }
                           },
                ...
                impl DescribeReceiptRuleSetError {
                    pub fn from_body(body: &str) -> DescribeReceiptRuleSetError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "RuleSetDoesNotExistException" => DescribeReceiptRuleSetError::RuleSetDoesNotExist(String::from(parsed_error.message)),_ => DescribeReceiptRuleSetError::Unknown(String::from(body))
                                }
                           },
...
InvalidPolicy(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl PutIdentityPolicyError {
                    pub fn from_body(body: &str) -> PutIdentityPolicyError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "InvalidPolicyException" => PutIdentityPolicyError::InvalidPolicy(String::from(parsed_error.message)),_ => PutIdentityPolicyError::Unknown(String::from(body))
                                }
                           },
                ...
                impl SendBounceError {
                    pub fn from_body(body: &str) -> SendBounceError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "MessageRejected" => SendBounceError::MessageRejected(String::from(parsed_error.message)),_ => SendBounceError::Unknown(String::from(body))
                                }
                           },
                ...
                impl SetActiveReceiptRuleSetError {
                    pub fn from_body(body: &str) -> SetActiveReceiptRuleSetError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "RuleSetDoesNotExistException" => SetActiveReceiptRuleSetError::RuleSetDoesNotExist(String::from(parsed_error.message)),_ => SetActiveReceiptRuleSetError::Unknown(String::from(body))
                                }
                           },
...
/// A client for the Amazon SES API.
        pub struct SesClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            credentials_provider: P,
            region: region::Region,
            dispatcher: D,
        }

        impl<P, D> SesClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
        ...
        impl<P, D> Ses for SesClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
        ...
        fn test_parse_error_ses_delete_identity() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/error", "ses-delete-identity.xml");
        ...
        fn test_parse_valid_ses_get_send_quota() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/valid", "ses-get-send-quota.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = SesClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_valid_ses_set_identity_dkim_enabled() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/valid", "ses-set-identity-dkim-enabled.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = SesClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
        ...
        fn test_parse_valid_ses_verify_domain_identity() {
            let mock_response =  MockResponseReader::read_response("test_resources/generated/valid", "ses-verify-domain-identity.xml");
            let mock = MockRequestDispatcher::with_status(200).with_body(&mock_response);
            let client = SesClient::new(mock, MockCredentialsProvider, rusoto_region::UsEast1);
