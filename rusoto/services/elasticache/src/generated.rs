...
struct AllowedNodeTypeModificationsMessageDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.scale_up_modifications = Some(try!(NodeTypeListDeserializer::deserialize("ScaleUpModifications", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub ec2_security_group_owner_id: String,
        ...
        params.put(&format!("{}{}", prefix, "CacheSecurityGroupName"), &obj.cache_security_group_name);
params.put(&format!("{}{}", prefix, "EC2SecurityGroupName"), &obj.ec2_security_group_name);
params.put(&format!("{}{}", prefix, "EC2SecurityGroupOwnerId"), &obj.ec2_security_group_owner_id);
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "CacheSecurityGroup" => {
                obj.cache_security_group = Some(try!(CacheSecurityGroupDeserializer::deserialize("CacheSecurityGroup", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct CacheClusterDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.auto_minor_version_upgrade = Some(try!(BooleanDeserializer::deserialize("AutoMinorVersionUpgrade", stack)));
            }
"CacheClusterCreateTime" => {
                obj.cache_cluster_create_time = Some(try!(TStampDeserializer::deserialize("CacheClusterCreateTime", stack)));
            }
"CacheClusterId" => {
                obj.cache_cluster_id = Some(try!(StringDeserializer::deserialize("CacheClusterId", stack)));
            }
"CacheClusterStatus" => {
                obj.cache_cluster_status = Some(try!(StringDeserializer::deserialize("CacheClusterStatus", stack)));
            }
"CacheNodeType" => {
                obj.cache_node_type = Some(try!(StringDeserializer::deserialize("CacheNodeType", stack)));
            }
"CacheNodes" => {
                obj.cache_nodes = Some(try!(CacheNodeListDeserializer::deserialize("CacheNodes", stack)));
            }
"CacheParameterGroup" => {
...
"CacheSubnetGroupName" => {
                obj.cache_subnet_group_name = Some(try!(StringDeserializer::deserialize("CacheSubnetGroupName", stack)));
            }
"ClientDownloadLandingPage" => {
                obj.client_download_landing_page = Some(try!(StringDeserializer::deserialize("ClientDownloadLandingPage", stack)));
            }
"ConfigurationEndpoint" => {
                obj.configuration_endpoint = Some(try!(EndpointDeserializer::deserialize("ConfigurationEndpoint", stack)));
            }
"Engine" => {
                obj.engine = Some(try!(StringDeserializer::deserialize("Engine", stack)));
            }
"EngineVersion" => {
                obj.engine_version = Some(try!(StringDeserializer::deserialize("EngineVersion", stack)));
            }
...
"NumCacheNodes" => {
                obj.num_cache_nodes = Some(try!(IntegerOptionalDeserializer::deserialize("NumCacheNodes", stack)));
            }
"PendingModifiedValues" => {
                obj.pending_modified_values = Some(try!(PendingModifiedValuesDeserializer::deserialize("PendingModifiedValues", stack)));
            }
"PreferredAvailabilityZone" => {
                obj.preferred_availability_zone = Some(try!(StringDeserializer::deserialize("PreferredAvailabilityZone", stack)));
            }
"PreferredMaintenanceWindow" => {
                obj.preferred_maintenance_window = Some(try!(StringDeserializer::deserialize("PreferredMaintenanceWindow", stack)));
            }
"ReplicationGroupId" => {
                obj.replication_group_id = Some(try!(StringDeserializer::deserialize("ReplicationGroupId", stack)));
            }
"SecurityGroups" => {
                obj.security_groups = Some(try!(SecurityGroupMembershipListDeserializer::deserialize("SecurityGroups", stack)));
            }
"SnapshotRetentionLimit" => {
                obj.snapshot_retention_limit = Some(try!(IntegerOptionalDeserializer::deserialize("SnapshotRetentionLimit", stack)));
            }
"SnapshotWindow" => {
                obj.snapshot_window = Some(try!(StringDeserializer::deserialize("SnapshotWindow", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "CacheCluster" {
                        obj.push(try!(CacheClusterDeserializer::deserialize("CacheCluster", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "CacheClusters" => {
                obj.cache_clusters = Some(try!(CacheClusterListDeserializer::deserialize("CacheClusters", stack)));
            }
"Marker" => {
...
struct CacheEngineVersionDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.cache_engine_description = Some(try!(StringDeserializer::deserialize("CacheEngineDescription", stack)));
            }
"CacheEngineVersionDescription" => {
                obj.cache_engine_version_description = Some(try!(StringDeserializer::deserialize("CacheEngineVersionDescription", stack)));
            }
"CacheParameterGroupFamily" => {
                obj.cache_parameter_group_family = Some(try!(StringDeserializer::deserialize("CacheParameterGroupFamily", stack)));
            }
"Engine" => {
                obj.engine = Some(try!(StringDeserializer::deserialize("Engine", stack)));
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "CacheEngineVersions" => {
                obj.cache_engine_versions = Some(try!(CacheEngineVersionListDeserializer::deserialize("CacheEngineVersions", stack)));
            }
"Marker" => {
                obj.marker = Some(try!(StringDeserializer::deserialize("Marker", stack)));
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "CacheNodeCreateTime" => {
                obj.cache_node_create_time = Some(try!(TStampDeserializer::deserialize("CacheNodeCreateTime", stack)));
            }
"CacheNodeId" => {
                obj.cache_node_id = Some(try!(StringDeserializer::deserialize("CacheNodeId", stack)));
            }
"CacheNodeStatus" => {
                obj.cache_node_status = Some(try!(StringDeserializer::deserialize("CacheNodeStatus", stack)));
            }
"CustomerAvailabilityZone" => {
                obj.customer_availability_zone = Some(try!(StringDeserializer::deserialize("CustomerAvailabilityZone", stack)));
            }
"Endpoint" => {
...
"SourceCacheNodeId" => {
                obj.source_cache_node_id = Some(try!(StringDeserializer::deserialize("SourceCacheNodeId", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"ChangeType" => {
                obj.change_type = Some(try!(ChangeTypeDeserializer::deserialize("ChangeType", stack)));
            }
"DataType" => {
...
"CacheParameterGroupName" => {
                obj.cache_parameter_group_name = Some(try!(StringDeserializer::deserialize("CacheParameterGroupName", stack)));
            }
"Description" => {
                obj.description = Some(try!(StringDeserializer::deserialize("Description", stack)));
            }
...
struct CacheParameterGroupStatusDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.cache_node_ids_to_reboot = Some(try!(CacheNodeIdsListDeserializer::deserialize("CacheNodeIdsToReboot", stack)));
            }
"CacheParameterGroupName" => {
                obj.cache_parameter_group_name = Some(try!(StringDeserializer::deserialize("CacheParameterGroupName", stack)));
            }
...
struct CacheParameterGroupsMessageDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.cache_parameter_groups = Some(try!(CacheParameterGroupListDeserializer::deserialize("CacheParameterGroups", stack)));
            }
"Marker" => {
                obj.marker = Some(try!(StringDeserializer::deserialize("Marker", stack)));
            }
...
struct CacheSecurityGroupDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.cache_security_group_name = Some(try!(StringDeserializer::deserialize("CacheSecurityGroupName", stack)));
            }
"Description" => {
                obj.description = Some(try!(StringDeserializer::deserialize("Description", stack)));
            }
...
"OwnerId" => {
                obj.owner_id = Some(try!(StringDeserializer::deserialize("OwnerId", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "CacheSecurityGroups" => {
                obj.cache_security_groups = Some(try!(CacheSecurityGroupsDeserializer::deserialize("CacheSecurityGroups", stack)));
            }
"Marker" => {
                obj.marker = Some(try!(StringDeserializer::deserialize("Marker", stack)));
            }
...
struct CacheSubnetGroupDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.cache_subnet_group_description = Some(try!(StringDeserializer::deserialize("CacheSubnetGroupDescription", stack)));
            }
"CacheSubnetGroupName" => {
                obj.cache_subnet_group_name = Some(try!(StringDeserializer::deserialize("CacheSubnetGroupName", stack)));
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "CacheSubnetGroups" => {
                obj.cache_subnet_groups = Some(try!(CacheSubnetGroupsDeserializer::deserialize("CacheSubnetGroups", stack)));
            }
"Marker" => {
                obj.marker = Some(try!(StringDeserializer::deserialize("Marker", stack)));
            }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "CacheSubnetGroup" {
                        obj.push(try!(CacheSubnetGroupDeserializer::deserialize("CacheSubnetGroup", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
...
pub target_snapshot_name: String,
        ...
        params.put(&format!("{}{}", prefix, "SourceSnapshotName"), &obj.source_snapshot_name);
if let Some(ref field_value) = obj.target_bucket {
                params.put(&format!("{}{}", prefix, "TargetBucket"), &field_value);
            }
params.put(&format!("{}{}", prefix, "TargetSnapshotName"), &obj.target_snapshot_name);
...
if let Some(ref field_value) = obj.auto_minor_version_upgrade {
                params.put(&format!("{}{}", prefix, "AutoMinorVersionUpgrade"), &field_value.to_string());
            }
params.put(&format!("{}{}", prefix, "CacheClusterId"), &obj.cache_cluster_id);
...
if let Some(ref field_value) = obj.cache_parameter_group_name {
                params.put(&format!("{}{}", prefix, "CacheParameterGroupName"), &field_value);
            }
...
if let Some(ref field_value) = obj.cache_subnet_group_name {
                params.put(&format!("{}{}", prefix, "CacheSubnetGroupName"), &field_value);
            }
...
if let Some(ref field_value) = obj.notification_topic_arn {
                params.put(&format!("{}{}", prefix, "NotificationTopicArn"), &field_value);
            }
if let Some(ref field_value) = obj.num_cache_nodes {
                params.put(&format!("{}{}", prefix, "NumCacheNodes"), &field_value.to_string());
            }
...
if let Some(ref field_value) = obj.preferred_availability_zone {
                params.put(&format!("{}{}", prefix, "PreferredAvailabilityZone"), &field_value);
            }
...
if let Some(ref field_value) = obj.snapshot_retention_limit {
                params.put(&format!("{}{}", prefix, "SnapshotRetentionLimit"), &field_value.to_string());
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "CacheCluster" => {
                obj.cache_cluster = Some(try!(CacheClusterDeserializer::deserialize("CacheCluster", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub description: String,
        ...
        params.put(&format!("{}{}", prefix, "CacheParameterGroupFamily"), &obj.cache_parameter_group_family);
params.put(&format!("{}{}", prefix, "CacheParameterGroupName"), &obj.cache_parameter_group_name);
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "CacheParameterGroup" => {
                obj.cache_parameter_group = Some(try!(CacheParameterGroupDeserializer::deserialize("CacheParameterGroup", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
pub subnet_ids: SubnetIdentifierList,
        ...
        params.put(&format!("{}{}", prefix, "CacheSubnetGroupDescription"), &obj.cache_subnet_group_description);
params.put(&format!("{}{}", prefix, "CacheSubnetGroupName"), &obj.cache_subnet_group_name);
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "CacheSubnetGroup" => {
                obj.cache_subnet_group = Some(try!(CacheSubnetGroupDeserializer::deserialize("CacheSubnetGroup", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
if let Some(ref field_value) = obj.automatic_failover_enabled {
                params.put(&format!("{}{}", prefix, "AutomaticFailoverEnabled"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.cache_node_type {
                params.put(&format!("{}{}", prefix, "CacheNodeType"), &field_value);
            }
...
if let Some(ref field_value) = obj.num_cache_clusters {
                params.put(&format!("{}{}", prefix, "NumCacheClusters"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.num_node_groups {
                params.put(&format!("{}{}", prefix, "NumNodeGroups"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.port {
                params.put(&format!("{}{}", prefix, "Port"), &field_value.to_string());
            }
...
if let Some(ref field_value) = obj.replicas_per_node_group {
                params.put(&format!("{}{}", prefix, "ReplicasPerNodeGroup"), &field_value.to_string());
            }
params.put(&format!("{}{}", prefix, "ReplicationGroupDescription"), &obj.replication_group_description);
params.put(&format!("{}{}", prefix, "ReplicationGroupId"), &obj.replication_group_id);
if let Some(ref field_value) = obj.security_group_ids {
                SecurityGroupIdsListSerializer::serialize(
                    params,
                    &format!("{}{}", prefix, "SecurityGroupIds"),
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ReplicationGroup" => {
                obj.replication_group = Some(try!(ReplicationGroupDeserializer::deserialize("ReplicationGroup", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
if let Some(ref field_value) = obj.final_snapshot_identifier {
                params.put(&format!("{}{}", prefix, "FinalSnapshotIdentifier"), &field_value);
            }
...
if let Some(ref field_value) = obj.retain_primary_cluster {
                params.put(&format!("{}{}", prefix, "RetainPrimaryCluster"), &field_value.to_string());
            }
...
if let Some(ref field_value) = obj.show_cache_node_info {
                params.put(&format!("{}{}", prefix, "ShowCacheNodeInfo"), &field_value.to_string());
            }
...
pub max_records: Option<IntegerOptional>,
        ...
        if let Some(ref field_value) = obj.cache_parameter_group_family {
                params.put(&format!("{}{}", prefix, "CacheParameterGroupFamily"), &field_value);
            }
if let Some(ref field_value) = obj.default_only {
                params.put(&format!("{}{}", prefix, "DefaultOnly"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.engine {
                params.put(&format!("{}{}", prefix, "Engine"), &field_value);
            }
...
pub max_records: Option<IntegerOptional>,
        ...
        if let Some(ref field_value) = obj.cache_security_group_name {
                params.put(&format!("{}{}", prefix, "CacheSecurityGroupName"), &field_value);
            }
if let Some(ref field_value) = obj.marker {
                params.put(&format!("{}{}", prefix, "Marker"), &field_value);
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "EngineDefaults" => {
                obj.engine_defaults = Some(try!(EngineDefaultsDeserializer::deserialize("EngineDefaults", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
if let Some(ref field_value) = obj.reserved_cache_node_id {
                params.put(&format!("{}{}", prefix, "ReservedCacheNodeId"), &field_value);
            }
if let Some(ref field_value) = obj.reserved_cache_nodes_offering_id {
                params.put(&format!("{}{}", prefix, "ReservedCacheNodesOfferingId"), &field_value);
            }
...
pub reserved_cache_nodes_offering_id: Option<String>,
            ...
            impl DescribeReservedCacheNodesOfferingsMessageSerializer {
                fn serialize(params: &mut Params, name: &str, obj: &DescribeReservedCacheNodesOfferingsMessage) {
                    let mut prefix = name.to_string();
        if prefix != "" {
            prefix.push_str(".");
        }
...
if let Some(ref field_value) = obj.show_node_group_config {
                params.put(&format!("{}{}", prefix, "ShowNodeGroupConfig"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.snapshot_name {
                params.put(&format!("{}{}", prefix, "SnapshotName"), &field_value);
            }
...
if let Some(ref field_value) = obj.apply_immediately {
                params.put(&format!("{}{}", prefix, "ApplyImmediately"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.auto_minor_version_upgrade {
                params.put(&format!("{}{}", prefix, "AutoMinorVersionUpgrade"), &field_value.to_string());
            }
...
if let Some(ref field_value) = obj.notification_topic_status {
                params.put(&format!("{}{}", prefix, "NotificationTopicStatus"), &field_value);
            }
if let Some(ref field_value) = obj.num_cache_nodes {
                params.put(&format!("{}{}", prefix, "NumCacheNodes"), &field_value.to_string());
            }
...
pub subnet_ids: Option<SubnetIdentifierList>,
        ...
        if let Some(ref field_value) = obj.cache_subnet_group_description {
                params.put(&format!("{}{}", prefix, "CacheSubnetGroupDescription"), &field_value);
            }
params.put(&format!("{}{}", prefix, "CacheSubnetGroupName"), &obj.cache_subnet_group_name);
...
if let Some(ref field_value) = obj.replication_group_description {
                params.put(&format!("{}{}", prefix, "ReplicationGroupDescription"), &field_value);
            }
params.put(&format!("{}{}", prefix, "ReplicationGroupId"), &obj.replication_group_id);
if let Some(ref field_value) = obj.security_group_ids {
                SecurityGroupIdsListSerializer::serialize(
...
if let Some(ref field_value) = obj.snapshotting_cluster_id {
                params.put(&format!("{}{}", prefix, "SnapshottingClusterId"), &field_value);
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "NodeGroupId" => {
                obj.node_group_id = Some(try!(StringDeserializer::deserialize("NodeGroupId", stack)));
            }
"NodeGroupMembers" => {
                obj.node_group_members = Some(try!(NodeGroupMemberListDeserializer::deserialize("NodeGroupMembers", stack)));
            }
"PrimaryEndpoint" => {
                obj.primary_endpoint = Some(try!(EndpointDeserializer::deserialize("PrimaryEndpoint", stack)));
            }
"Slots" => {
...
struct NodeGroupConfigurationDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.primary_availability_zone = Some(try!(StringDeserializer::deserialize("PrimaryAvailabilityZone", stack)));
            }
"ReplicaAvailabilityZones" => {
                obj.replica_availability_zones = Some(try!(AvailabilityZonesListDeserializer::deserialize("ReplicaAvailabilityZones", stack)));
            }
"ReplicaCount" => {
                obj.replica_count = Some(try!(IntegerOptionalDeserializer::deserialize("ReplicaCount", stack)));
            }
"Slots" => {
                obj.slots = Some(try!(StringDeserializer::deserialize("Slots", stack)));
            }
        ...
        if let Some(ref field_value) = obj.primary_availability_zone {
                params.put(&format!("{}{}", prefix, "PrimaryAvailabilityZone"), &field_value);
            }
...
if let Some(ref field_value) = obj.replica_count {
                params.put(&format!("{}{}", prefix, "ReplicaCount"), &field_value.to_string());
            }
...
"CurrentRole" => {
                obj.current_role = Some(try!(StringDeserializer::deserialize("CurrentRole", stack)));
            }
"PreferredAvailabilityZone" => {
                obj.preferred_availability_zone = Some(try!(StringDeserializer::deserialize("PreferredAvailabilityZone", stack)));
            }
"ReadEndpoint" => {
                obj.read_endpoint = Some(try!(EndpointDeserializer::deserialize("ReadEndpoint", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "NodeGroupMember" {
                        obj.push(try!(NodeGroupMemberDeserializer::deserialize("NodeGroupMember", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
...
"CacheSize" => {
                obj.cache_size = Some(try!(StringDeserializer::deserialize("CacheSize", stack)));
            }
"NodeGroupConfiguration" => {
                obj.node_group_configuration = Some(try!(NodeGroupConfigurationDeserializer::deserialize("NodeGroupConfiguration", stack)));
            }
"NodeGroupId" => {
                obj.node_group_id = Some(try!(StringDeserializer::deserialize("NodeGroupId", stack)));
            }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "NodeSnapshot" {
                        obj.push(try!(NodeSnapshotDeserializer::deserialize("NodeSnapshot", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "TopicArn" => {
                obj.topic_arn = Some(try!(StringDeserializer::deserialize("TopicArn", stack)));
            }
"TopicStatus" => {
                obj.topic_status = Some(try!(StringDeserializer::deserialize("TopicStatus", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
struct PendingModifiedValuesDeserializer;
        ...
        loop {
            ...
            match next_event {
                ...
                obj.cache_node_ids_to_remove = Some(try!(CacheNodeIdsListDeserializer::deserialize("CacheNodeIdsToRemove", stack)));
            }
"CacheNodeType" => {
                obj.cache_node_type = Some(try!(StringDeserializer::deserialize("CacheNodeType", stack)));
            }
...
pub reserved_cache_nodes_offering_id: String,
        ...
        if let Some(ref field_value) = obj.cache_node_count {
                params.put(&format!("{}{}", prefix, "CacheNodeCount"), &field_value.to_string());
            }
if let Some(ref field_value) = obj.reserved_cache_node_id {
                params.put(&format!("{}{}", prefix, "ReservedCacheNodeId"), &field_value);
            }
params.put(&format!("{}{}", prefix, "ReservedCacheNodesOfferingId"), &obj.reserved_cache_nodes_offering_id);
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "ReservedCacheNode" => {
                obj.reserved_cache_node = Some(try!(ReservedCacheNodeDeserializer::deserialize("ReservedCacheNode", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "AutomaticFailover" => {
                obj.automatic_failover = Some(try!(AutomaticFailoverStatusDeserializer::deserialize("AutomaticFailover", stack)));
            }
"ConfigurationEndpoint" => {
                obj.configuration_endpoint = Some(try!(EndpointDeserializer::deserialize("ConfigurationEndpoint", stack)));
            }
...
"MemberClusters" => {
                obj.member_clusters = Some(try!(ClusterIdListDeserializer::deserialize("MemberClusters", stack)));
            }
"NodeGroups" => {
                obj.node_groups = Some(try!(NodeGroupListDeserializer::deserialize("NodeGroups", stack)));
            }
"PendingModifiedValues" => {
...
"SnapshottingClusterId" => {
                obj.snapshotting_cluster_id = Some(try!(StringDeserializer::deserialize("SnapshottingClusterId", stack)));
            }
"Status" => {
                obj.status = Some(try!(StringDeserializer::deserialize("Status", stack)));
            }
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "ReplicationGroup" {
                        obj.push(try!(ReplicationGroupDeserializer::deserialize("ReplicationGroup", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
...
"ReplicationGroups" => {
                obj.replication_groups = Some(try!(ReplicationGroupListDeserializer::deserialize("ReplicationGroups", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
"PrimaryClusterId" => {
                obj.primary_cluster_id = Some(try!(StringDeserializer::deserialize("PrimaryClusterId", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "CacheNodeCount" => {
                obj.cache_node_count = Some(try!(IntegerDeserializer::deserialize("CacheNodeCount", stack)));
            }
"CacheNodeType" => {
                obj.cache_node_type = Some(try!(StringDeserializer::deserialize("CacheNodeType", stack)));
            }
...
"ProductDescription" => {
                obj.product_description = Some(try!(StringDeserializer::deserialize("ProductDescription", stack)));
            }
"RecurringCharges" => {
                obj.recurring_charges = Some(try!(RecurringChargeListDeserializer::deserialize("RecurringCharges", stack)));
            }
"ReservedCacheNodeId" => {
                obj.reserved_cache_node_id = Some(try!(StringDeserializer::deserialize("ReservedCacheNodeId", stack)));
            }
"ReservedCacheNodesOfferingId" => {
                obj.reserved_cache_nodes_offering_id = Some(try!(StringDeserializer::deserialize("ReservedCacheNodesOfferingId", stack)));
            }
"StartTime" => {
...
"ReservedCacheNodes" => {
                obj.reserved_cache_nodes = Some(try!(ReservedCacheNodeListDeserializer::deserialize("ReservedCacheNodes", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "SecurityGroupId" => {
                obj.security_group_id = Some(try!(StringDeserializer::deserialize("SecurityGroupId", stack)));
            }
"Status" => {
                obj.status = Some(try!(StringDeserializer::deserialize("Status", stack)));
            }
...
struct SecurityGroupMembershipListDeserializer;
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    if name == "member" {
                        obj.push(try!(SecurityGroupMembershipDeserializer::deserialize("member", stack)));
                    } else {
                        skip_tree(stack);
                    }
                },
...
"NodeSnapshots" => {
                obj.node_snapshots = Some(try!(NodeSnapshotListDeserializer::deserialize("NodeSnapshots", stack)));
            }
"NumCacheNodes" => {
                obj.num_cache_nodes = Some(try!(IntegerOptionalDeserializer::deserialize("NumCacheNodes", stack)));
            }
"NumNodeGroups" => {
                obj.num_node_groups = Some(try!(IntegerOptionalDeserializer::deserialize("NumNodeGroups", stack)));
            }
"Port" => {
                obj.port = Some(try!(IntegerOptionalDeserializer::deserialize("Port", stack)));
            }
"PreferredAvailabilityZone" => {
                obj.preferred_availability_zone = Some(try!(StringDeserializer::deserialize("PreferredAvailabilityZone", stack)));
            }
...
"ReplicationGroupDescription" => {
                obj.replication_group_description = Some(try!(StringDeserializer::deserialize("ReplicationGroupDescription", stack)));
            }
"ReplicationGroupId" => {
                obj.replication_group_id = Some(try!(StringDeserializer::deserialize("ReplicationGroupId", stack)));
            }
"SnapshotName" => {
                obj.snapshot_name = Some(try!(StringDeserializer::deserialize("SnapshotName", stack)));
            }
"SnapshotRetentionLimit" => {
                obj.snapshot_retention_limit = Some(try!(IntegerOptionalDeserializer::deserialize("SnapshotRetentionLimit", stack)));
            }
"SnapshotSource" => {
                obj.snapshot_source = Some(try!(StringDeserializer::deserialize("SnapshotSource", stack)));
            }
"SnapshotStatus" => {
                obj.snapshot_status = Some(try!(StringDeserializer::deserialize("SnapshotStatus", stack)));
            }
"SnapshotWindow" => {
                obj.snapshot_window = Some(try!(StringDeserializer::deserialize("SnapshotWindow", stack)));
            }
        ...
        loop {
            ...
            match next_event {
                DeserializerNext::Element(name) => {
                    match &name[..] {
                        "TagList" => {
                obj.tag_list = Some(try!(TagListDeserializer::deserialize("TagList", stack)));
            }
                        _ => skip_tree(stack),
                    }
                },
...
Unknown(String)
                ...
                impl Error for AuthorizeCacheSecurityGroupIngressError {
                    fn description(&self) -> &str {
                        match *self {
                            AuthorizeCacheSecurityGroupIngressError::AuthorizationAlreadyExistsFault(ref cause) => cause,
AuthorizeCacheSecurityGroupIngressError::CacheSecurityGroupNotFoundFault(ref cause) => cause,
AuthorizeCacheSecurityGroupIngressError::InvalidCacheSecurityGroupStateFault(ref cause) => cause,
AuthorizeCacheSecurityGroupIngressError::InvalidParameterCombination(ref cause) => cause,
...
AuthorizeCacheSecurityGroupIngressError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
CreateCacheClusterError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
Unknown(String)
                ...
                impl Error for CreateCacheParameterGroupError {
                    fn description(&self) -> &str {
                        match *self {
                            CreateCacheParameterGroupError::CacheParameterGroupAlreadyExistsFault(ref cause) => cause,
CreateCacheParameterGroupError::CacheParameterGroupQuotaExceededFault(ref cause) => cause,
CreateCacheParameterGroupError::InvalidCacheParameterGroupStateFault(ref cause) => cause,
...
CreateCacheParameterGroupError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
CreateCacheSecurityGroupError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                ...
                impl CreateCacheSubnetGroupError {
                    pub fn from_body(body: &str) -> CreateCacheSubnetGroupError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "CacheSubnetGroupAlreadyExistsFault" => CreateCacheSubnetGroupError::CacheSubnetGroupAlreadyExistsFault(String::from(parsed_error.message)),"CacheSubnetGroupQuotaExceededFault" => CreateCacheSubnetGroupError::CacheSubnetGroupQuotaExceededFault(String::from(parsed_error.message)),"CacheSubnetQuotaExceededFault" => CreateCacheSubnetGroupError::CacheSubnetQuotaExceededFault(String::from(parsed_error.message)),"InvalidSubnet" => CreateCacheSubnetGroupError::InvalidSubnet(String::from(parsed_error.message)),_ => CreateCacheSubnetGroupError::Unknown(String::from(body))
                                }
                           },
...
CreateCacheSubnetGroupError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
CreateReplicationGroupError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
DeleteCacheClusterError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
DeleteCacheParameterGroupError::InvalidCacheParameterGroupStateFault(ref cause) => cause,
...
DeleteCacheParameterGroupError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
DeleteCacheSecurityGroupError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
///<p>The requested cache subnet group name does not refer to an existing cache subnet group.</p>
CacheSubnetGroupNotFoundFault(String),/// An error occurred dispatching the HTTP request
HttpDispatch(HttpDispatchError),/// An error was encountered with AWS credentials.
Credentials(CredentialsError),/// A validation error occurred.  Details from AWS are provided.
Validation(String),/// An unknown error occurred.  The raw HTTP response is provided.
Unknown(String)
                ...
                impl DeleteCacheSubnetGroupError {
                    pub fn from_body(body: &str) -> DeleteCacheSubnetGroupError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "CacheSubnetGroupInUse" => DeleteCacheSubnetGroupError::CacheSubnetGroupInUse(String::from(parsed_error.message)),"CacheSubnetGroupNotFoundFault" => DeleteCacheSubnetGroupError::CacheSubnetGroupNotFoundFault(String::from(parsed_error.message)),_ => DeleteCacheSubnetGroupError::Unknown(String::from(body))
                                }
                           },
...
DeleteCacheSubnetGroupError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
DeleteReplicationGroupError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
DescribeCacheClustersError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
DescribeCacheEngineVersionsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
DescribeCacheParameterGroupsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
DescribeCacheParametersError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
DescribeCacheSecurityGroupsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
                ...
                impl DescribeCacheSubnetGroupsError {
                    pub fn from_body(body: &str) -> DescribeCacheSubnetGroupsError {
                        ...
                        match XmlErrorDeserializer::deserialize("Error", &mut stack) {
                            Ok(parsed_error) => {
                                match &parsed_error.code[..] {
                                    "CacheSubnetGroupNotFoundFault" => DescribeCacheSubnetGroupsError::CacheSubnetGroupNotFoundFault(String::from(parsed_error.message)),_ => DescribeCacheSubnetGroupsError::Unknown(String::from(body))
                                }
                           },
...
DescribeCacheSubnetGroupsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
DescribeReplicationGroupsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
DescribeReservedCacheNodesError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
Unknown(String)
                ...
                impl Error for DescribeReservedCacheNodesOfferingsError {
                    fn description(&self) -> &str {
                        match *self {
                            DescribeReservedCacheNodesOfferingsError::InvalidParameterCombination(ref cause) => cause,
...
DescribeReservedCacheNodesOfferingsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
ListAllowedNodeTypeModificationsError::ReplicationGroupNotFoundFault(ref cause) => cause,
...
ListAllowedNodeTypeModificationsError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
ModifyCacheClusterError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
ModifyCacheParameterGroupError::InvalidCacheParameterGroupStateFault(ref cause) => cause,
...
ModifyCacheParameterGroupError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
ModifyCacheSubnetGroupError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
ModifyReplicationGroupError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
Unknown(String)
                ...
                impl Error for PurchaseReservedCacheNodesOfferingError {
                    fn description(&self) -> &str {
                        match *self {
                            PurchaseReservedCacheNodesOfferingError::InvalidParameterCombination(ref cause) => cause,
...
PurchaseReservedCacheNodesOfferingError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
RebootCacheClusterError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
ResetCacheParameterGroupError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
RevokeCacheSecurityGroupIngressError::CacheSecurityGroupNotFoundFault(ref cause) => cause,
...
RevokeCacheSecurityGroupIngressError::HttpDispatch(ref dispatch_error) => dispatch_error.description(),
...
/// A client for the Amazon ElastiCache API.
        pub struct ElastiCacheClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
            credentials_provider: P,
            region: region::Region,
            dispatcher: D,
        }

        impl<P, D> ElastiCacheClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
        ...
        impl<P, D> ElastiCache for ElastiCacheClient<P, D> where P: ProvideAwsCredentials, D: DispatchSignedRequest {
